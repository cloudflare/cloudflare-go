...
func TestDeviceIPProfileNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.ZeroTrust.Devices.IPProfiles.New(context.TODO(), zero_trust.DeviceIPProfileNewParams{
		...
		Description: cloudflare.F("example comment"),
...
func TestDeviceIPProfileUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := client.ZeroTrust.Devices.IPProfiles.Update(
		context.TODO(),
		"profile_id",
...
func TestDeviceIPProfileDelete(t *testing.T) {
	...
	_, err := client.ZeroTrust.Devices.IPProfiles.Delete(
		context.TODO(),
		"profile_id",
...
func TestDeviceIPProfileGet(t *testing.T) {
	...
	_, err := client.ZeroTrust.Devices.IPProfiles.Get(
		context.TODO(),
		"profile_id",
