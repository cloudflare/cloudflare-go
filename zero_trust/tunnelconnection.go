...
func (r *TunnelConnectionService) Get(ctx context.Context, tunnelID string, query TunnelConnectionGetParams, opts ...option.RequestOption) (res *[]TunnelConnectionGetResponse, err error) {
	opts = append(r.Options[:], opts...)
...
// center.
type TunnelConnectionGetResponse struct {
	...
	Conns []TunnelConnectionGetResponseConn `json:"conns"`
	...
	JSON    tunnelConnectionGetResponseJSON `json:"-"`
}

// tunnelConnectionGetResponseJSON contains the JSON metadata for the struct
// [TunnelConnectionGetResponse]
type tunnelConnectionGetResponseJSON struct {
	ID            apijson.Field
	Arch          apijson.Field
...
func (r *TunnelConnectionGetResponse) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r tunnelConnectionGetResponseJSON) RawJSON() string {
	return r.raw
}

type TunnelConnectionGetResponseConn struct {
	// UUID of the Cloudflare Tunnel connection.
	ID string `json:"id"`
	...
	JSON tunnelConnectionGetResponseConnJSON `json:"-"`
}

// tunnelConnectionGetResponseConnJSON contains the JSON metadata for the struct
// [TunnelConnectionGetResponseConn]
type tunnelConnectionGetResponseConnJSON struct {
	ID                 apijson.Field
...
func (r *TunnelConnectionGetResponseConn) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r tunnelConnectionGetResponseConnJSON) RawJSON() string {
	return r.raw
}
...
type TunnelConnectionGetResponseEnvelope struct {
	...
	Result   []TunnelConnectionGetResponse                 `json:"result,required,nullable"`
	// Whether the API call was successful
