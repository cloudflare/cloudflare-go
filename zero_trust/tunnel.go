...
// The type of tunnel.
TunType shared.TunnelListResponseTunType `json:"tun_type"`
...
// The type of tunnel.
type shared.TunnelListResponseTunType string

const (
  shared.TunnelListResponseTunTypeCfdTunnel shared.TunnelListResponseTunType = "cfd_tunnel"
...
Status string `json:"status"`
// The type of tunnel.
TunType shared.TunnelEditResponseTunType `json:"tun_type"`
...
// The type of tunnel.
type shared.TunnelEditResponseTunType string

const (
  shared.TunnelEditResponseTunTypeCfdTunnel shared.TunnelEditResponseTunType = "cfd_tunnel"
