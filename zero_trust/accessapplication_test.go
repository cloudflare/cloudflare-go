...
func TestAccessApplicationNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.ZeroTrust.Access.Applications.New(context.TODO(), zero_trust.AccessApplicationNewParamsSelfHostedApplication{
		...
		AllowedIDPs:              cloudflare.F([]zero_trust.AllowedIDPsItemParam{"699d98642c564d2e855e9661899b7252", "699d98642c564d2e855e9661899b7252", "699d98642c564d2e855e9661899b7252"}),
		...
		CorsHeaders: cloudflare.F(zero_trust.CorsHeadersParam{
			...
			AllowedHeaders:   cloudflare.F([]zero_trust.AllowedHeadersItemParam{"string", "string", "string"}),
			AllowedMethods:   cloudflare.F([]zero_trust.AllowedMethodsItem{zero_trust.AllowedMethodsItemGet}),
			AllowedOrigins:   cloudflare.F([]zero_trust.AllowedOriginsItemParam{"https://example.com"}),
		...
		CustomPages:              cloudflare.F([]zero_trust.CustomPagesItemParam{"699d98642c564d2e855e9661899b7252", "699d98642c564d2e855e9661899b7252", "699d98642c564d2e855e9661899b7252"}),
		...
		SelfHostedDomains:        cloudflare.F([]zero_trust.SelfHostedDomainsItemParam{"test.example.com/admin", "test.anotherexample.com/staff"}),
