...
func TestDLPEntryCustomNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.ZeroTrust.DLP.Entries.Custom.New(context.TODO(), zero_trust.DLPEntryCustomNewParams{
...
func TestDLPEntryCustomUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := client.ZeroTrust.DLP.Entries.Custom.Update(
		context.TODO(),
...
func TestDLPEntryCustomDelete(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
