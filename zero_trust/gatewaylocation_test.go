  ...
  _, err := client.ZeroTrust.Gateway.Locations.New(context.TODO(), zero_trust.GatewayLocationNewParams{
    ...
    Endpoints: cloudflare.F(zero_trust.EndpointParam{
      DOH: cloudflare.F(zero_trust.DOHEndpointParam{
        ...
        Networks: cloudflare.F([]zero_trust.IPNetworkParam{zero_trust.IPNetworkParam{
      ...
      IPV6: cloudflare.F(zero_trust.IPV6EndpointParam{
        Enabled: cloudflare.F(true),
        Networks: cloudflare.F([]zero_trust.IPV6NetworkParam{zero_trust.IPV6NetworkParam{
          Network: cloudflare.F("2001:85a3::/64"),
    ...
    Networks: cloudflare.F([]zero_trust.GatewayLocationNewParamsNetwork{zero_trust.GatewayLocationNewParamsNetwork{
      Network: cloudflare.F("192.0.2.1/32"),
    }, zero_trust.GatewayLocationNewParamsNetwork{
      Network: cloudflare.F("192.0.2.1/32"),
    }, zero_trust.GatewayLocationNewParamsNetwork{
      Network: cloudflare.F("192.0.2.1/32"),
    }}),
...
func TestGatewayLocationUpdateWithOptionalParams(t *testing.T) {
  ...
  _, err := client.ZeroTrust.Gateway.Locations.Update(
    ...
    zero_trust.GatewayLocationUpdateParams{
      ...
      Networks: cloudflare.F([]zero_trust.GatewayLocationUpdateParamsNetwork{zero_trust.GatewayLocationUpdateParamsNetwork{
        Network: cloudflare.F("192.0.2.1/32"),
      }, zero_trust.GatewayLocationUpdateParamsNetwork{
        Network: cloudflare.F("192.0.2.1/32"),
      }, zero_trust.GatewayLocationUpdateParamsNetwork{
        Network: cloudflare.F("192.0.2.1/32"),
      }}),
