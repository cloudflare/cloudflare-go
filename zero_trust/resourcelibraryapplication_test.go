...
func TestResourceLibraryApplicationNewWithOptionalParams(t *testing.T) {
...
func TestResourceLibraryApplicationUpdateWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.ZeroTrust.ResourceLibrary.Applications.Update(
		context.TODO(),
		int64(498),
...
func TestResourceLibraryApplicationDelete(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.ZeroTrust.ResourceLibrary.Applications.Delete(
		context.TODO(),
		int64(498),
