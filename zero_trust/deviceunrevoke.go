...
func (r *DeviceUnrevokeService) New(ctx context.Context, params DeviceUnrevokeNewParams, opts ...option.RequestOption) (res *shared.UnnamedSchemaRef173Union, err error) {
