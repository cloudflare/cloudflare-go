...
func (r *AddressAddressMapAccountService) Update(ctx context.Context, accountIdentifier1 string, addressMapIdentifier string, accountIdentifier string, opts ...option.RequestOption) (res *AddressAddressMapAccountUpdateResponse, err error) {
...
func (r *AddressAddressMapAccountService) Delete(ctx context.Context, accountIdentifier1 string, addressMapIdentifier string, accountIdentifier string, opts ...option.RequestOption) (res *AddressAddressMapAccountDeleteResponse, err error) {
	opts = append(r.Options[:], opts...)
