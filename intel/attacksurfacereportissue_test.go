...
func TestAttackSurfaceReportIssueListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Intel.AttackSurfaceReport.Issues.List(context.TODO(), intel.AttackSurfaceReportIssueListParams{
		...
		IssueClass:    cloudflare.F([]intel.IssueClassItemParam{"a_record_dangling", "always_use_https_not_enabled"}),
		IssueClassNeq: cloudflare.F([]intel.IssueClassItemParam{"a_record_dangling", "always_use_https_not_enabled"}),
		...
		Product:       cloudflare.F([]intel.ProductItemParam{"access", "dns"}),
		ProductNeq:    cloudflare.F([]intel.ProductItemParam{"access", "dns"}),
		Severity:      cloudflare.F([]intel.SeverityQueryParamItem{intel.SeverityQueryParamItemLow, intel.SeverityQueryParamItemModerate}),
		SeverityNeq:   cloudflare.F([]intel.SeverityQueryParamItem{intel.SeverityQueryParamItemLow, intel.SeverityQueryParamItemModerate}),
		Subject:       cloudflare.F([]intel.SubjectsItemParam{"example.com", "example.com", "example.com"}),
		SubjectNeq:    cloudflare.F([]intel.SubjectsItemParam{"example.com", "example.com", "example.com"}),
	})
	if err != nil {
