...
func TestManagedHeaderEdit(t *testing.T) {
  ...
  _, err := client.ManagedHeaders.Edit(context.TODO(), managed_headers.ManagedHeaderEditParams{
    ZoneID: cloudflare.F("023e105f4ecef8ad9ca31a8372d0c353"),
    ManagedRequestHeaders: cloudflare.F([]managed_headers.RequestModelParam{managed_headers.RequestModelParam{
    ...
    ManagedResponseHeaders: cloudflare.F([]managed_headers.RequestModelParam{managed_headers.RequestModelParam{
      ID: cloudflare.F("add_cf-bot-score_header"),
      Enabled: cloudflare.F(true),
    }, managed_headers.RequestModelParam{
      ID: cloudflare.F("add_cf-bot-score_header"),
