...
type RouteBulkUpdateResponseEnvelope struct {
	Errors   []RouteBulkUpdateResponseEnvelopeErrors   `json:"errors,required"`
	Messages []RouteBulkUpdateResponseEnvelopeMessages `json:"messages,required"`
...
type RouteBulkUpdateResponseEnvelopeErrors struct {
	Code    int64                                     `json:"code,required"`
	Message string                                    `json:"message,required"`
	JSON    routeBulkUpdateResponseEnvelopeErrorsJSON `json:"-"`
}

// routeBulkUpdateResponseEnvelopeErrorsJSON contains the JSON metadata for the
// struct [RouteBulkUpdateResponseEnvelopeErrors]
type routeBulkUpdateResponseEnvelopeErrorsJSON struct {
	Code        apijson.Field
	Message     apijson.Field
	raw         string
	ExtraFields map[string]apijson.Field
...
func (r *RouteBulkUpdateResponseEnvelopeErrors) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r routeBulkUpdateResponseEnvelopeErrorsJSON) RawJSON() string {
	return r.raw
}

type RouteBulkUpdateResponseEnvelopeMessages struct {
	Code    int64                                       `json:"code,required"`
	Message string                                      `json:"message,required"`
	JSON    routeBulkUpdateResponseEnvelopeMessagesJSON `json:"-"`
}

// routeBulkUpdateResponseEnvelopeMessagesJSON contains the JSON metadata for the
// struct [RouteBulkUpdateResponseEnvelopeMessages]
type routeBulkUpdateResponseEnvelopeMessagesJSON struct {
	Code        apijson.Field
	Message     apijson.Field
	raw         string
	ExtraFields map[string]apijson.Field
...
func (r *RouteBulkUpdateResponseEnvelopeMessages) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r routeBulkUpdateResponseEnvelopeMessagesJSON) RawJSON() string {
	return r.raw
}
