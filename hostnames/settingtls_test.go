...
func TestSettingTLSUpdate(t *testing.T) {
	...
	_, err := client.Hostnames.Settings.TLS.Update(
		...
		hostnames.SettingTLSUpdateParams{
			...
			Value:  cloudflare.F[hostnames.SettingTLSUpdateParamsValueUnion](hostnames.SettingTLSUpdateParamsValueArray([]string{"ECDHE-RSA-AES128-GCM-SHA256", "AES128-GCM-SHA256"})),
		},
	)
	if err != nil {
