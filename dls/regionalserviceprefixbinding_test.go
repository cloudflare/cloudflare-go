...
func TestRegionalServicePrefixBindingNew(t *testing.T) {
...
func TestRegionalServicePrefixBindingListWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
...
func TestRegionalServicePrefixBindingDelete(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.DLS.RegionalServices.PrefixBindings.Delete(
		context.TODO(),
...
func TestRegionalServicePrefixBindingEdit(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.DLS.RegionalServices.PrefixBindings.Edit(
		context.TODO(),
		"a1b2c3d4-e5f6-7890-abcd-ef1234567890",
...
func TestRegionalServicePrefixBindingGet(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.DLS.RegionalServices.PrefixBindings.Get(
		context.TODO(),
		"a1b2c3d4-e5f6-7890-abcd-ef1234567890",
