...
type LogpushJob struct {
	...
	Dataset LogpushJobDataset `json:"dataset" api:"nullable"`
	...
	Frequency LogpushJobFrequency `json:"frequency" api:"nullable"`
	...
	LastComplete time.Time `json:"last_complete" api:"nullable" format:"date-time"`
	...
	LastError time.Time `json:"last_error" api:"nullable" format:"date-time"`
	...
	//
	// Deprecated: deprecated
	LogpullOptions string `json:"logpull_options" api:"nullable" format:"uri-reference"`
	...
	// size.
	MaxUploadBytes LogpushJobMaxUploadBytes `json:"max_upload_bytes" api:"nullable"`
	...
	MaxUploadIntervalSeconds LogpushJobMaxUploadIntervalSeconds `json:"max_upload_interval_seconds" api:"nullable"`
	...
	// lines than this.
	MaxUploadRecords LogpushJobMaxUploadRecords `json:"max_upload_records" api:"nullable"`
	...
	OutputOptions OutputOptions  `json:"output_options" api:"nullable"`
...
const (
	...
	LogpushJobDatasetEmailSecurityPostDeliveryEvents LogpushJobDataset = "email_security_post_delivery_events"
	...
	LogpushJobDatasetTurnstileEvents                 LogpushJobDataset = "turnstile_events"
	...
	LogpushJobDatasetWebsocketAnalytics              LogpushJobDataset = "websocket_analytics"
...
type OutputOptions struct {
	...
	BatchPrefix string `json:"batch_prefix" api:"nullable"`
	// String to be appended after each batch.
	BatchSuffix string `json:"batch_suffix" api:"nullable"`
	// If set to true, will cause all occurrences of `${` in the generated files to be
	// replaced with `x{`.
	Cve2021_44228 bool `json:"CVE-2021-44228" api:"nullable"`
	// String to join fields. This field be ignored when `record_template` is set.
	FieldDelimiter string `json:"field_delimiter" api:"nullable"`
	...
	RecordDelimiter string `json:"record_delimiter" api:"nullable"`
	// String to be prepended before each record.
	RecordPrefix string `json:"record_prefix" api:"nullable"`
	// String to be appended after each record.
	RecordSuffix string `json:"record_suffix" api:"nullable"`
...
const (
	...
	JobNewParamsDatasetEmailSecurityPostDeliveryEvents JobNewParamsDataset = "email_security_post_delivery_events"
	...
	JobNewParamsDatasetTurnstileEvents                 JobNewParamsDataset = "turnstile_events"
	...
	JobNewParamsDatasetWebsocketAnalytics              JobNewParamsDataset = "websocket_analytics"
...
type JobNewResponseEnvelope struct {
	Errors   []JobNewResponseEnvelopeErrors   `json:"errors" api:"required"`
	Messages []JobNewResponseEnvelopeMessages `json:"messages" api:"required"`
	// Whether the API call was successful.
	Success JobNewResponseEnvelopeSuccess `json:"success" api:"required"`
	Result  LogpushJob                    `json:"result" api:"nullable"`
...
type JobUpdateResponseEnvelope struct {
	Errors   []JobUpdateResponseEnvelopeErrors   `json:"errors" api:"required"`
	Messages []JobUpdateResponseEnvelopeMessages `json:"messages" api:"required"`
	// Whether the API call was successful.
	Success JobUpdateResponseEnvelopeSuccess `json:"success" api:"required"`
	Result  LogpushJob                       `json:"result" api:"nullable"`
...
type JobDeleteResponseEnvelope struct {
	Errors   []JobDeleteResponseEnvelopeErrors   `json:"errors" api:"required"`
	Messages []JobDeleteResponseEnvelopeMessages `json:"messages" api:"required"`
	// Whether the API call was successful.
	Success JobDeleteResponseEnvelopeSuccess `json:"success" api:"required"`
...
type JobGetResponseEnvelope struct {
	Errors   []JobGetResponseEnvelopeErrors   `json:"errors" api:"required"`
	Messages []JobGetResponseEnvelopeMessages `json:"messages" api:"required"`
	// Whether the API call was successful.
	Success JobGetResponseEnvelopeSuccess `json:"success" api:"required"`
	Result  LogpushJob                    `json:"result" api:"nullable"`
