...
func (r *AddressAddressMapService) New(ctx context.Context, accountIdentifier string, body AddressAddressMapNewParams, opts ...option.RequestOption) (res *AddressAddressMapNewResponse, err error) {
...
func (r *AddressAddressMapService) Update(ctx context.Context, accountIdentifier string, addressMapIdentifier string, body AddressAddressMapUpdateParams, opts ...option.RequestOption) (res *AddressAddressMapUpdateResponse, err error) {
	opts = append(r.Options[:], opts...)
	var env AddressAddressMapUpdateResponseEnvelope
...
func (r *AddressAddressMapService) List(ctx context.Context, accountIdentifier string, opts ...option.RequestOption) (res *[]AddressAddressMapListResponse, err error) {
	opts = append(r.Options[:], opts...)
...
func (r *AddressAddressMapService) Delete(ctx context.Context, accountIdentifier string, addressMapIdentifier string, opts ...option.RequestOption) (res *AddressAddressMapDeleteResponse, err error) {
	opts = append(r.Options[:], opts...)
...
func (r *AddressAddressMapService) Get(ctx context.Context, accountIdentifier string, addressMapIdentifier string, opts ...option.RequestOption) (res *AddressAddressMapGetResponse, err error) {
	opts = append(r.Options[:], opts...)
...
type AddressAddressMapUpdateResponse struct {
	// Identifier
	ID string `json:"id"`
	// If set to false, then the Address Map cannot be deleted via API. This is true
	// for Cloudflare-managed maps.
	...
	Enabled    bool                                `json:"enabled,nullable"`
	ModifiedAt time.Time                           `json:"modified_at" format:"date-time"`
	JSON       addressAddressMapUpdateResponseJSON `json:"-"`
}

// addressAddressMapUpdateResponseJSON contains the JSON metadata for the struct
// [AddressAddressMapUpdateResponse]
type addressAddressMapUpdateResponseJSON struct {
	ID           apijson.Field
	CanDelete    apijson.Field
	CanModifyIPs apijson.Field
	CreatedAt    apijson.Field
...
func (r *AddressAddressMapUpdateResponse) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}
...
type AddressAddressMapUpdateParams struct {
	// If you have legacy TLS clients which do not send the TLS server name indicator,
	// then you can specify one default SNI on the map. If Cloudflare receives a TLS
	// handshake from a client without an SNI, it will respond with the default SNI on
	// those IPs. The default SNI can be any valid zone or subdomain owned by the
...
func (r AddressAddressMapUpdateParams) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}

type AddressAddressMapUpdateResponseEnvelope struct {
	Errors   []AddressAddressMapUpdateResponseEnvelopeErrors   `json:"errors,required"`
	Messages []AddressAddressMapUpdateResponseEnvelopeMessages `json:"messages,required"`
	Result   AddressAddressMapUpdateResponse                   `json:"result,required"`
	// Whether the API call was successful
	Success AddressAddressMapUpdateResponseEnvelopeSuccess `json:"success,required"`
	JSON    addressAddressMapUpdateResponseEnvelopeJSON    `json:"-"`
}

// addressAddressMapUpdateResponseEnvelopeJSON contains the JSON metadata for the
// struct [AddressAddressMapUpdateResponseEnvelope]
type addressAddressMapUpdateResponseEnvelopeJSON struct {
	Errors      apijson.Field
	Messages    apijson.Field
	Result      apijson.Field
	Success     apijson.Field
...
func (r *AddressAddressMapUpdateResponseEnvelope) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

type AddressAddressMapUpdateResponseEnvelopeErrors struct {
	Code    int64                                             `json:"code,required"`
	Message string                                            `json:"message,required"`
	JSON    addressAddressMapUpdateResponseEnvelopeErrorsJSON `json:"-"`
}

// addressAddressMapUpdateResponseEnvelopeErrorsJSON contains the JSON metadata for
// the struct [AddressAddressMapUpdateResponseEnvelopeErrors]
type addressAddressMapUpdateResponseEnvelopeErrorsJSON struct {
	Code        apijson.Field
	Message     apijson.Field
	raw         string
	ExtraFields map[string]apijson.Field
...
func (r *AddressAddressMapUpdateResponseEnvelopeErrors) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

type AddressAddressMapUpdateResponseEnvelopeMessages struct {
	Code    int64                                               `json:"code,required"`
	Message string                                              `json:"message,required"`
	JSON    addressAddressMapUpdateResponseEnvelopeMessagesJSON `json:"-"`
}

// addressAddressMapUpdateResponseEnvelopeMessagesJSON contains the JSON metadata
// for the struct [AddressAddressMapUpdateResponseEnvelopeMessages]
type addressAddressMapUpdateResponseEnvelopeMessagesJSON struct {
	Code        apijson.Field
	Message     apijson.Field
	raw         string
	ExtraFields map[string]apijson.Field
...
func (r *AddressAddressMapUpdateResponseEnvelopeMessages) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

// Whether the API call was successful
type AddressAddressMapUpdateResponseEnvelopeSuccess bool

const (
	AddressAddressMapUpdateResponseEnvelopeSuccessTrue AddressAddressMapUpdateResponseEnvelopeSuccess = true
)
