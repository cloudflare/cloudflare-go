...
func TestZeroTrustAccessKeyUpdate(t *testing.T) {
	...
	_, err := client.ZeroTrust.Access.Keys.Update(
		...
		cloudflare.ZeroTrustAccessKeyUpdateParams{
...
func TestZeroTrustAccessKeyList(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
...
func TestZeroTrustAccessKeyRotate(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
