...
func TestSecondaryDNSPeerSecondaryDNSPeerNewPeer(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.SecondaryDNS.Peers.SecondaryDNSPeerNewPeer(
		context.TODO(),
		"01a7362d577a6c3019a474fd6f485823",
		cloudflare.SecondaryDNSPeerSecondaryDNSPeerNewPeerParams{
...
func TestSecondaryDNSPeerSecondaryDNSPeerListPeers(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.SecondaryDNS.Peers.SecondaryDNSPeerListPeers(context.TODO(), "01a7362d577a6c3019a474fd6f485823")
	if err != nil {
		var apierr *cloudflare.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
