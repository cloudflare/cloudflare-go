...
func TestWeb3HostnameIpfsUniversalPathContentListEntryReplaceWithOptionalParams(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Web3.Hostnames.IpfsUniversalPaths.ContentLists.Entries.Replace(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		"023e105f4ecef8ad9ca31a8372d0c353",
		"023e105f4ecef8ad9ca31a8372d0c353",
		cloudflare.Web3HostnameIpfsUniversalPathContentListEntryReplaceParams{
			Content:     cloudflare.F("QmPZ9gcCEpqKTo6aq61g2nXGUhM4iCL3ewB6LDXZCtioEB"),
			Type:        cloudflare.F(cloudflare.Web3HostnameIpfsUniversalPathContentListEntryReplaceParamsTypeCid),
			Description: cloudflare.F("this is my content list entry"),
		},
	)
	if err != nil {
