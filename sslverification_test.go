...
func TestSSLVerificationUpdate(t *testing.T) {
	...
	_, err := client.SSLs.Verifications.Update(
		...
		cloudflare.SSLVerificationUpdateParams{
			ValidationMethod: cloudflare.F(cloudflare.SSLVerificationUpdateParamsValidationMethodTxt),
		},
	)
	if err != nil {
