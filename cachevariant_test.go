...
func TestCacheVariantUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := client.Cache.Variants.Update(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		cloudflare.CacheVariantUpdateParams{
			Value: cloudflare.F(cloudflare.CacheVariantUpdateParamsValue{
...
func TestCacheVariantList(t *testing.T) {
	...
	_, err := client.Cache.Variants.List(context.TODO(), "023e105f4ecef8ad9ca31a8372d0c353")
	if err != nil {
		var apierr *cloudflare.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestCacheVariantDelete(t *testing.T) {
	...
	_, err := client.Cache.Variants.Delete(context.TODO(), "023e105f4ecef8ad9ca31a8372d0c353")
	if err != nil {
		var apierr *cloudflare.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
