...
func TestAlertingV3PolicyUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := client.Alerting.V3s.Policies.Update(
		context.TODO(),
...
func TestAlertingV3PolicyDelete(t *testing.T) {
	...
	_, err := client.Alerting.V3s.Policies.Delete(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		"0da2b59e-f118-439d-8097-bdfb215203c9",
	)
...
func TestAlertingV3PolicyGet(t *testing.T) {
	...
	_, err := client.Alerting.V3s.Policies.Get(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		"0da2b59e-f118-439d-8097-bdfb215203c9",
	)
...
func TestAlertingV3PolicyNotificationPoliciesNewANotificationPolicyWithOptionalParams(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Alerting.V3s.Policies.NotificationPoliciesNewANotificationPolicy(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		cloudflare.AlertingV3PolicyNotificationPoliciesNewANotificationPolicyParams{
			...
			Name:        cloudflare.F("SSL Notification Event Policy"),
			Description: cloudflare.F("Something describing the policy."),
			Filters: cloudflare.F(cloudflare.AlertingV3PolicyNotificationPoliciesNewANotificationPolicyParamsFilters{
				Actions:                      cloudflare.F([]string{"string", "string", "string"}),
				AffectedAsns:                 cloudflare.F([]string{"string", "string", "string"}),
				AffectedComponents:           cloudflare.F([]string{"string", "string", "string"}),
				AffectedLocations:            cloudflare.F([]string{"string", "string", "string"}),
				...
				TargetIP:                     cloudflare.F([]string{"string", "string", "string"}),
				TargetZoneName:               cloudflare.F([]string{"string", "string", "string"}),
				TrafficExclusions:            cloudflare.F([]cloudflare.AlertingV3PolicyNotificationPoliciesNewANotificationPolicyParamsFiltersTrafficExclusion{cloudflare.AlertingV3PolicyNotificationPoliciesNewANotificationPolicyParamsFiltersTrafficExclusionSecurityEvents}),
				TunnelID:                     cloudflare.F([]string{"string", "string", "string"}),
				TunnelName:                   cloudflare.F([]string{"string", "string", "string"}),
				Where:                        cloudflare.F([]string{"string", "string", "string"}),
				Zones:                        cloudflare.F([]string{"string", "string", "string"}),
...
func TestAlertingV3PolicyNotificationPoliciesListNotificationPolicies(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Alerting.V3s.Policies.NotificationPoliciesListNotificationPolicies(context.TODO(), "023e105f4ecef8ad9ca31a8372d0c353")
	if err != nil {
		var apierr *cloudflare.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
