...
func TestAlertingV3PolicyReplaceWithOptionalParams(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Alerting.V3.Policies.Replace(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		"0da2b59e-f118-439d-8097-bdfb215203c9",
		cloudflare.AlertingV3PolicyReplaceParams{
			AlertType:   cloudflare.F(cloudflare.AlertingV3PolicyReplaceParamsAlertTypeUniversalSSLEventType),
			Description: cloudflare.F("Something describing the policy."),
			Enabled:     cloudflare.F(true),
			Filters: cloudflare.F(cloudflare.AlertingV3PolicyReplaceParamsFilters{
				Actions:                      cloudflare.F([]string{"string", "string", "string"}),
				AffectedAsns:                 cloudflare.F([]string{"string", "string", "string"}),
				AffectedComponents:           cloudflare.F([]string{"string", "string", "string"}),
				AffectedLocations:            cloudflare.F([]string{"string", "string", "string"}),
				...
				GroupBy:                      cloudflare.F([]string{"string", "string", "string"}),
				HealthCheckID:                cloudflare.F([]string{"string", "string", "string"}),
				IncidentImpact:               cloudflare.F([]cloudflare.AlertingV3PolicyReplaceParamsFiltersIncidentImpact{cloudflare.AlertingV3PolicyReplaceParamsFiltersIncidentImpactIncidentImpactNone, cloudflare.AlertingV3PolicyReplaceParamsFiltersIncidentImpactIncidentImpactMinor, cloudflare.AlertingV3PolicyReplaceParamsFiltersIncidentImpactIncidentImpactMajor}),
				InputID:                      cloudflare.F([]string{"string", "string", "string"}),
				Limit:                        cloudflare.F([]string{"string", "string", "string"}),
				LogoTag:                      cloudflare.F([]string{"string", "string", "string"}),
				MegabitsPerSecond:            cloudflare.F([]string{"string", "string", "string"}),
				...
				TargetIP:                     cloudflare.F([]string{"string", "string", "string"}),
				TargetZoneName:               cloudflare.F([]string{"string", "string", "string"}),
				TrafficExclusions:            cloudflare.F([]cloudflare.AlertingV3PolicyReplaceParamsFiltersTrafficExclusion{cloudflare.AlertingV3PolicyReplaceParamsFiltersTrafficExclusionSecurityEvents}),
				TunnelID:                     cloudflare.F([]string{"string", "string", "string"}),
				TunnelName:                   cloudflare.F([]string{"string", "string", "string"}),
				Where:                        cloudflare.F([]string{"string", "string", "string"}),
				Zones:                        cloudflare.F([]string{"string", "string", "string"}),
			}),
			Mechanisms: cloudflare.F(map[string][]cloudflare.AlertingV3PolicyReplaceParamsMechanisms{
				"email": {{
					ID: cloudflare.F[cloudflare.AlertingV3PolicyReplaceParamsMechanismsID](shared.UnionString("test@example.com")),
				}},
				"pagerduty": {{
					ID: cloudflare.F[cloudflare.AlertingV3PolicyReplaceParamsMechanismsID](shared.UnionString("e8133a15-00a4-4d69-aec1-32f70c51f6e5")),
				}},
				"webhooks": {{
					ID: cloudflare.F[cloudflare.AlertingV3PolicyReplaceParamsMechanismsID](shared.UnionString("14cc1190-5d2b-4b98-a696-c424cb2ad05f")),
				}},
			}),
			Name: cloudflare.F("SSL Notification Event Policy"),
		},
