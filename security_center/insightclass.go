...
type InsightClassGetParams struct {
	...
	Source        param.Field[[]InsightClassGetParamsSource] `query:"source"`
...
type InsightClassGetParamsSource string

const (
	InsightClassGetParamsSourceCloudflare InsightClassGetParamsSource = "cloudflare"
	InsightClassGetParamsSourceRiskrecon  InsightClassGetParamsSource = "riskrecon"
)

func (r InsightClassGetParamsSource) IsKnown() bool {
	switch r {
	case InsightClassGetParamsSourceCloudflare, InsightClassGetParamsSourceRiskrecon:
		return true
	}
	return false
}
