...
func TestInsightSeverityGetWithOptionalParams(t *testing.T) {
	...
	_, err := client.SecurityCenter.Insights.Severity.Get(context.TODO(), security_center.InsightSeverityGetParams{
		...
		Source:        cloudflare.F([]security_center.InsightSeverityGetParamsSource{security_center.InsightSeverityGetParamsSourceCloudflare}),
