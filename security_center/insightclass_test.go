...
func TestInsightClassGetWithOptionalParams(t *testing.T) {
	...
	_, err := client.SecurityCenter.Insights.Class.Get(context.TODO(), security_center.InsightClassGetParams{
		...
		Source:        cloudflare.F([]security_center.InsightClassGetParamsSource{security_center.InsightClassGetParamsSourceCloudflare}),
