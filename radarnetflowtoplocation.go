...
func (r *RadarNetflowTopLocationService) List(ctx context.Context, query RadarNetflowTopLocationListParams, opts ...option.RequestOption) (res *RadarNetflowTopLocationListResponse, err error) {
	...
	var env RadarNetflowTopLocationListResponseEnvelope
...
type RadarNetflowTopLocationListResponse struct {
	Top0 []RadarNetflowTopLocationListResponseTop0 `json:"top_0,required"`
...
type RadarNetflowTopLocationListResponseTop0 struct {
	ClientCountryAlpha2 string                                      `json:"clientCountryAlpha2,required"`
	ClientCountryName   string                                      `json:"clientCountryName,required"`
	Value               string                                      `json:"value,required"`
	JSON                radarNetflowTopLocationListResponseTop0JSON `json:"-"`
}

// radarNetflowTopLocationListResponseTop0JSON contains the JSON metadata for the
// struct [RadarNetflowTopLocationListResponseTop0]
type radarNetflowTopLocationListResponseTop0JSON struct {
...
func (r *RadarNetflowTopLocationListResponseTop0) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}
...
type RadarNetflowTopLocationListResponseEnvelope struct {
	Result  RadarNetflowTopLocationListResponse             `json:"result,required"`
	Success bool                                            `json:"success,required"`
	JSON    radarNetflowTopLocationListResponseEnvelopeJSON `json:"-"`
}

// radarNetflowTopLocationListResponseEnvelopeJSON contains the JSON metadata for
// the struct [RadarNetflowTopLocationListResponseEnvelope]
type radarNetflowTopLocationListResponseEnvelopeJSON struct {
...
func (r *RadarNetflowTopLocationListResponseEnvelope) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}
