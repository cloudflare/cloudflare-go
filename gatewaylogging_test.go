...
func TestGatewayLoggingUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := client.Gateways.Loggings.Update(context.TODO(), cloudflare.GatewayLoggingUpdateParams{
...
func TestGatewayLoggingGet(t *testing.T) {
	...
	_, err := client.Gateways.Loggings.Get(context.TODO(), cloudflare.GatewayLoggingGetParams{
		AccountID: cloudflare.F[any]("699d98642c564d2e855e9661899b7252"),
	})
	if err != nil {
		var apierr *cloudflare.Error
