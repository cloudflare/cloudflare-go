...
func TestMtlsCertificateUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := client.MtlsCertificates.Update(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		cloudflare.MtlsCertificateUpdateParams{
...
func TestMtlsCertificateList(t *testing.T) {
	...
	_, err := client.MtlsCertificates.List(context.TODO(), "023e105f4ecef8ad9ca31a8372d0c353")
	if err != nil {
		var apierr *cloudflare.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
