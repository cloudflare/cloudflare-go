...
func TestUserLoadBalancerMonitorNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Users.LoadBalancers.Monitors.New(context.TODO(), cloudflare.UserLoadBalancerMonitorNewParams{
...
func TestUserLoadBalancerMonitorList(t *testing.T) {
	...
	_, err := client.Users.LoadBalancers.Monitors.List(context.TODO())
	if err != nil {
		var apierr *cloudflare.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
