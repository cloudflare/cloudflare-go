...
func TestUserLoadBalancerMonitorUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := client.Users.LoadBalancers.Monitors.Update(
		context.TODO(),
...
func TestUserLoadBalancerMonitorDelete(t *testing.T) {
	...
	_, err := client.Users.LoadBalancers.Monitors.Delete(context.TODO(), "f1aba936b94213e5b8dca0c0dbf1f9cc")
	if err != nil {
		var apierr *cloudflare.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestUserLoadBalancerMonitorGet(t *testing.T) {
	...
	_, err := client.Users.LoadBalancers.Monitors.Get(context.TODO(), "f1aba936b94213e5b8dca0c0dbf1f9cc")
	if err != nil {
		var apierr *cloudflare.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestUserLoadBalancerMonitorLoadBalancerMonitorsNewMonitorWithOptionalParams(t *testing.T) {
	...
	_, err := client.Users.LoadBalancers.Monitors.LoadBalancerMonitorsNewMonitor(context.TODO(), cloudflare.UserLoadBalancerMonitorLoadBalancerMonitorsNewMonitorParams{
		ExpectedCodes:   cloudflare.F("2xx"),
		AllowInsecure:   cloudflare.F(true),
		ConsecutiveDown: cloudflare.F(int64(0)),
		ConsecutiveUp:   cloudflare.F(int64(0)),
...
func TestUserLoadBalancerMonitorLoadBalancerMonitorsListMonitors(t *testing.T) {
	...
	_, err := client.Users.LoadBalancers.Monitors.LoadBalancerMonitorsListMonitors(context.TODO())
	if err != nil {
		var apierr *cloudflare.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
