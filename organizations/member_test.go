	...
	_, err := client.Organizations.Members.New(
		...
		organizations.MemberNewParams{
			Member: cloudflare.F(organizations.MemberNewParamsMember{
				...
				Status: cloudflare.F(organizations.MemberNewParamsMemberStatusActive),
			}),
		},
	)
	if err != nil {
...
func TestMemberListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Organizations.Members.List(
		...
		organizations.MemberListParams{
			...
			Status:    cloudflare.F([]organizations.MemberListParamsStatus{organizations.MemberListParamsStatusActive}),
			User: cloudflare.F(organizations.MemberListParamsUser{
				Email: cloudflare.F("email"),
			}),
		},
	)
