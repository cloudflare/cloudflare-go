...
func TestZeroTrustDLPDatasetNewWithOptionalParams(t *testing.T) {
...
func TestZeroTrustDLPDatasetUpdateWithOptionalParams(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.ZeroTrust.DLP.Datasets.Update(
		...
		cloudflare.ZeroTrustDLPDatasetUpdateParams{
			AccountID:   cloudflare.F("string"),
			Description: cloudflare.F("string"),
			Name:        cloudflare.F("string"),
		},
...
func TestZeroTrustDLPDatasetList(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
...
func TestZeroTrustDLPDatasetDelete(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	err := client.ZeroTrust.DLP.Datasets.Delete(
		context.TODO(),
		"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
		cloudflare.ZeroTrustDLPDatasetDeleteParams{
			AccountID: cloudflare.F("string"),
		},
	)
	if err != nil {
...
func TestZeroTrustDLPDatasetGet(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.ZeroTrust.DLP.Datasets.Get(
		context.TODO(),
		"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
		cloudflare.ZeroTrustDLPDatasetGetParams{
			AccountID: cloudflare.F("string"),
		},
	)
	if err != nil {
