...
func (r *WorkerDeploymentByScriptDetailService) Get(ctx context.Context, accountID string, scriptID string, deploymentID string, opts ...option.RequestOption) (res *WorkerDeploymentByScriptDetailGetResponse, err error) {
