...
func TestHyperdriveConfigNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Hyperdrive.Configs.New(
		...
		cloudflare.HyperdriveConfigNewParams{
			...
			Origin: cloudflare.F(cloudflare.HyperdriveConfigNewParamsOrigin{
				...
				Scheme:   cloudflare.F(cloudflare.HyperdriveConfigNewParamsOriginSchemePostgres),
				User:     cloudflare.F("postgres"),
			}),
			Caching: cloudflare.F(cloudflare.HyperdriveConfigNewParamsCaching{
