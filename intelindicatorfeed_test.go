...
func TestIntelIndicatorFeedPermissionsAddWithOptionalParams(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Intel.IndicatorFeeds.PermissionsAdd(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		cloudflare.IntelIndicatorFeedPermissionsAddParams{
...
func TestIntelIndicatorFeedPermissionsRemoveWithOptionalParams(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Intel.IndicatorFeeds.PermissionsRemove(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		cloudflare.IntelIndicatorFeedPermissionsRemoveParams{
			AccountTag: cloudflare.F("823f45f16fd2f7e21e1e054aga4d2859"),
			FeedID:     cloudflare.F(int64(1)),
		},
	)
...
func TestIntelIndicatorFeedPermissionsView(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Intel.IndicatorFeeds.PermissionsView(context.TODO(), "023e105f4ecef8ad9ca31a8372d0c353")
	if err != nil {
		var apierr *cloudflare.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
