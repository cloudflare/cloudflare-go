...
// instead.
func (r *DevicePolicyFallbackDomainService) List(ctx context.Context, accountID interface{}, policyID string, opts ...option.RequestOption) (res *[]DevicePolicyFallbackDomainListResponse, err error) {
	opts = append(r.Options[:], opts...)
