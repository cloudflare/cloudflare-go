...
func TestCustomCertificateNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.CustomCertificates.New(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		cloudflare.CustomCertificateNewParams{
...
func TestCustomCertificateUpdateWithOptionalParams(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.CustomCertificates.Update(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		"023e105f4ecef8ad9ca31a8372d0c353",
		cloudflare.CustomCertificateUpdateParams{
			BundleMethod: cloudflare.F(cloudflare.CustomCertificateUpdateParamsBundleMethodUbiquitous),
			Certificate:  cloudflare.F("-----BEGIN CERTIFICATE-----\\n-----END CERTIFICATE-----\n"),
			GeoRestrictions: cloudflare.F(cloudflare.CustomCertificateUpdateParamsGeoRestrictions{
				Label: cloudflare.F(cloudflare.CustomCertificateUpdateParamsGeoRestrictionsLabelUs),
			}),
			Policy:     cloudflare.F("(country: US) or (region: EU)"),
			PrivateKey: cloudflare.F("-----BEGIN RSA PRIVATE KEY-----\\nlv6XTQaMyf6n1yjzL+fzDrH3qXMxHMO/b13EePXpDMpY7HQpoLDi\n-----END RSA PRIVATE KEY-----\n"),
		},
...
func TestCustomCertificateListWithOptionalParams(t *testing.T) {
	...
	_, err := client.CustomCertificates.List(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		cloudflare.CustomCertificateListParams{
