...
func TestDeviceDEXTestDeviceDEXTestNewDeviceDEXTestWithOptionalParams(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Devices.DEXTests.DeviceDEXTestNewDeviceDEXTest(
		context.TODO(),
		"699d98642c564d2e855e9661899b7252",
		cloudflare.DeviceDEXTestDeviceDEXTestNewDeviceDEXTestParams{
			Data: cloudflare.F(cloudflare.DeviceDEXTestDeviceDEXTestNewDeviceDEXTestParamsData{
				Host:   cloudflare.F("https://dash.cloudflare.com"),
				Kind:   cloudflare.F("http"),
				Method: cloudflare.F("GET"),
			}),
...
func TestDeviceDEXTestDeviceDEXTestDetails(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Devices.DEXTests.DeviceDEXTestDetails(context.TODO(), "699d98642c564d2e855e9661899b7252")
	if err != nil {
		var apierr *cloudflare.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
