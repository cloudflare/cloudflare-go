...
func TestSettingH2PrioritizationEditWithOptionalParams(t *testing.T) {
	...
	_, err := client.Settings.H2Prioritization.Edit(context.TODO(), cloudflare.SettingH2PrioritizationEditParams{
...
func TestSettingH2PrioritizationGet(t *testing.T) {
	...
	_, err := client.Settings.H2Prioritization.Get(context.TODO(), cloudflare.SettingH2PrioritizationGetParams{
		ZoneID: cloudflare.F("023e105f4ecef8ad9ca31a8372d0c353"),
	})
	if err != nil {
		var apierr *cloudflare.Error
