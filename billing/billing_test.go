...
func TestBillingAddressValidationWithOptionalParams(t *testing.T) {
	...
	_, err := client.Billing.AddressValidation(context.TODO(), billing.BillingAddressValidationParams{
