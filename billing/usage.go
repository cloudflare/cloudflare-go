...
type UsagePaygoResponse struct {
	...
	BillingCurrency string `json:"BillingCurrency,required"`
	// Indicates the start of the billing period.
	BillingPeriodStart time.Time `json:"BillingPeriodStart,required" format:"date-time"`
	// Indicates the end of the charge period.
	ChargePeriodEnd time.Time `json:"ChargePeriodEnd,required" format:"date-time"`
	// Indicates the start of the charge period.
	ChargePeriodStart time.Time `json:"ChargePeriodStart,required" format:"date-time"`
	// Specifies the quantity consumed during this charge period.
	ConsumedQuantity float64 `json:"ConsumedQuantity,required"`
	// Specifies the unit of measurement for consumed quantity.
	ConsumedUnit string `json:"ConsumedUnit,required"`
	// Specifies the cost for this charge period in the billing currency.
	ContractedCost float64 `json:"ContractedCost,required"`
	// Specifies the cumulated cost for the billing period in the billing currency.
	CumulatedContractedCost float64 `json:"CumulatedContractedCost,required"`
	// Specifies the cumulated pricing quantity for the billing period.
	CumulatedPricingQuantity int64 `json:"CumulatedPricingQuantity,required"`
	// Specifies the pricing quantity for this charge period.
	PricingQuantity int64 `json:"PricingQuantity,required"`
...
type UsagePaygoResponseEnvelope struct {
	...
	Errors []UsagePaygoResponseEnvelopeErrors `json:"errors,required,nullable"`
	// Contains informational notices about the response.
	Messages []UsagePaygoResponseEnvelopeMessages `json:"messages,required,nullable"`
	// Contains the array of billable usage records.
	Result []UsagePaygoResponse `json:"result,required"`
	// Indicates whether the API call was successful.
	Success UsagePaygoResponseEnvelopeSuccess `json:"success,required"`
