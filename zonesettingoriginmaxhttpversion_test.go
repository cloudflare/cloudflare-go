...
func TestZoneSettingOriginMaxHTTPVersionUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := client.Zones.Settings.OriginMaxHTTPVersions.Update(
		...
		cloudflare.ZoneSettingOriginMaxHTTPVersionUpdateParams{
			Value: cloudflare.F(cloudflare.ZoneSettingOriginMaxHTTPVersionUpdateParamsValue{
				ID: cloudflare.F(cloudflare.ZoneSettingOriginMaxHTTPVersionUpdateParamsValueIDOriginMaxHTTPVersion),
			}),
		},
	)
	if err != nil {
