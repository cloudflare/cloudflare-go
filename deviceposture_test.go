...
func TestDevicePostureReplaceWithOptionalParams(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Devices.Postures.Replace(
		...
		"699d98642c564d2e855e9661899b7252",
		"f174e90a-fafe-4643-bbbc-4a0ed4fc8415",
		cloudflare.DevicePostureReplaceParams{
			Name:        cloudflare.F("Admin Serial Numbers"),
			Type:        cloudflare.F(cloudflare.DevicePostureReplaceParamsTypeFile),
			Description: cloudflare.F("The rule for admin serial numbers"),
			Expiration:  cloudflare.F("1h"),
			Input: cloudflare.F[cloudflare.DevicePostureReplaceParamsInput](cloudflare.DevicePostureReplaceParamsInputTeamsDevicesFileInputRequest(cloudflare.DevicePostureReplaceParamsInputTeamsDevicesFileInputRequest{
				Exists:          cloudflare.F(true),
				OperatingSystem: cloudflare.F(cloudflare.DevicePostureReplaceParamsInputTeamsDevicesFileInputRequestOperatingSystemLinux),
				Path:            cloudflare.F("/bin/cat"),
				Sha256:          cloudflare.F("https://api.us-2.crowdstrike.com"),
				Thumbprint:      cloudflare.F("0aabab210bdb998e9cf45da2c9ce352977ab531c681b74cf1e487be1bbe9fe6e"),
			})),
			Match: cloudflare.F([]cloudflare.DevicePostureReplaceParamsMatch{{
				Platform: cloudflare.F(cloudflare.DevicePostureReplaceParamsMatchPlatformWindows),
			}, {
				Platform: cloudflare.F(cloudflare.DevicePostureReplaceParamsMatchPlatformWindows),
			}, {
				Platform: cloudflare.F(cloudflare.DevicePostureReplaceParamsMatchPlatformWindows),
