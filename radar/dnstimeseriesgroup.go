...
func (r DNSTimeseriesGroupDNSSECResponseMetaConfidenceInfoAnnotationsEventType) IsKnown() bool {
	switch r {
	case DNSTimeseriesGroupDNSSECResponseMetaConfidenceInfoAnnotationsEventTypeGeneral, DNSTimeseriesGroupDNSSECResponseMetaConfidenceInfoAnnotationsEventTypeOutage, DNSTimeseriesGroupDNSSECResponseMetaConfidenceInfoAnnotationsEventTypePartialProjection, DNSTimeseriesGroupDNSSECResponseMetaConfidenceInfoAnnotationsEventTypePipeline, DNSTimeseriesGroupDNSSECResponseMetaConfidenceInfoAnnotationsEventTypeTrafficAnomaly:
		return true
	}
	return false
}
