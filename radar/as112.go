...
type AS112SummaryV2Response struct {
	...
	Meta     AS112SummaryV2ResponseMeta `json:"meta" api:"required"`
...
type AS112SummaryV2ResponseMeta struct {
	ConfidenceInfo AS112SummaryV2ResponseMetaConfidenceInfo `json:"confidenceInfo" api:"required"`
	DateRange      []AS112SummaryV2ResponseMetaDateRange    `json:"dateRange" api:"required"`
	// Timestamp of the last dataset update.
	LastUpdated time.Time `json:"lastUpdated" api:"required" format:"date-time"`
	// Normalization method applied to the results. Refer to
	// [Normalization methods](https://developers.cloudflare.com/radar/concepts/normalization/).
	Normalization AS112SummaryV2ResponseMetaNormalization `json:"normalization" api:"required"`
	// Measurement units for the results.
	Units []AS112SummaryV2ResponseMetaUnit `json:"units" api:"required"`
...
type AS112SummaryV2ResponseMetaConfidenceInfo struct {
	Annotations []AS112SummaryV2ResponseMetaConfidenceInfoAnnotation `json:"annotations" api:"required"`
...
type AS112SummaryV2ResponseMetaConfidenceInfoAnnotation struct {
	...
	DataSource  AS112SummaryV2ResponseMetaConfidenceInfoAnnotationsDataSource `json:"dataSource" api:"required"`
	Description string                                                        `json:"description" api:"required"`
	EndDate     time.Time                                                     `json:"endDate" api:"required" format:"date-time"`
	// Event type for annotations.
	EventType AS112SummaryV2ResponseMetaConfidenceInfoAnnotationsEventType `json:"eventType" api:"required"`
...
type AS112TimeseriesResponse struct {
	// Metadata for the results.
	Meta        AS112TimeseriesResponseMeta        `json:"meta" api:"required"`
	ExtraFields map[string]AS112TimeseriesResponse `json:"-" api:"extrafields"`
...
type AS112TimeseriesResponseMeta struct {
	...
	AggInterval    AS112TimeseriesResponseMetaAggInterval    `json:"aggInterval" api:"required"`
	ConfidenceInfo AS112TimeseriesResponseMetaConfidenceInfo `json:"confidenceInfo" api:"required"`
	DateRange      []AS112TimeseriesResponseMetaDateRange    `json:"dateRange" api:"required"`
	// Timestamp of the last dataset update.
	LastUpdated time.Time `json:"lastUpdated" api:"required" format:"date-time"`
	// Normalization method applied to the results. Refer to
	// [Normalization methods](https://developers.cloudflare.com/radar/concepts/normalization/).
	Normalization AS112TimeseriesResponseMetaNormalization `json:"normalization" api:"required"`
	// Measurement units for the results.
	Units []AS112TimeseriesResponseMetaUnit `json:"units" api:"required"`
...
type AS112TimeseriesResponseMetaConfidenceInfo struct {
	Annotations []AS112TimeseriesResponseMetaConfidenceInfoAnnotation `json:"annotations" api:"required"`
	// Provides an indication of how much confidence Cloudflare has in the data.
	Level int64                                         `json:"level" api:"required"`
...
type AS112TimeseriesResponseMetaConfidenceInfoAnnotation struct {
	// Data source for annotations.
	DataSource  AS112TimeseriesResponseMetaConfidenceInfoAnnotationsDataSource `json:"dataSource" api:"required"`
	Description string                                                         `json:"description" api:"required"`
	EndDate     time.Time                                                      `json:"endDate" api:"required" format:"date-time"`
	// Event type for annotations.
	EventType AS112TimeseriesResponseMetaConfidenceInfoAnnotationsEventType `json:"eventType" api:"required"`
	// Whether event is a single point in time or a time range.
	IsInstantaneous bool                                                    `json:"isInstantaneous" api:"required"`
	LinkedURL       string                                                  `json:"linkedUrl" api:"required" format:"uri"`
	StartDate       time.Time                                               `json:"startDate" api:"required" format:"date-time"`
...
type AS112TimeseriesGroupsV2Response struct {
	// Metadata for the results.
	Meta   AS112TimeseriesGroupsV2ResponseMeta   `json:"meta" api:"required"`
	Serie0 AS112TimeseriesGroupsV2ResponseSerie0 `json:"serie_0" api:"required"`
...
type AS112TimeseriesGroupsV2ResponseMeta struct {
	...
	// Refer to
	// [Aggregation intervals](https://developers.cloudflare.com/radar/concepts/aggregation-intervals/).
	AggInterval    AS112TimeseriesGroupsV2ResponseMetaAggInterval    `json:"aggInterval" api:"required"`
	ConfidenceInfo AS112TimeseriesGroupsV2ResponseMetaConfidenceInfo `json:"confidenceInfo" api:"required"`
	DateRange      []AS112TimeseriesGroupsV2ResponseMetaDateRange    `json:"dateRange" api:"required"`
	// Timestamp of the last dataset update.
	LastUpdated time.Time `json:"lastUpdated" api:"required" format:"date-time"`
	// Normalization method applied to the results. Refer to
	// [Normalization methods](https://developers.cloudflare.com/radar/concepts/normalization/).
	Normalization AS112TimeseriesGroupsV2ResponseMetaNormalization `json:"normalization" api:"required"`
	// Measurement units for the results.
	Units []AS112TimeseriesGroupsV2ResponseMetaUnit `json:"units" api:"required"`
...
type AS112TimeseriesGroupsV2ResponseMetaConfidenceInfo struct {
	Annotations []AS112TimeseriesGroupsV2ResponseMetaConfidenceInfoAnnotation `json:"annotations" api:"required"`
	// Provides an indication of how much confidence Cloudflare has in the data.
	Level int64                                                 `json:"level" api:"required"`
...
type AS112TimeseriesGroupsV2ResponseMetaConfidenceInfoAnnotation struct {
	// Data source for annotations.
	DataSource  AS112TimeseriesGroupsV2ResponseMetaConfidenceInfoAnnotationsDataSource `json:"dataSource" api:"required"`
	Description string                                                                 `json:"description" api:"required"`
	EndDate     time.Time                                                              `json:"endDate" api:"required" format:"date-time"`
	// Event type for annotations.
	EventType AS112TimeseriesGroupsV2ResponseMetaConfidenceInfoAnnotationsEventType `json:"eventType" api:"required"`
	// Whether event is a single point in time or a time range.
	IsInstantaneous bool                                                            `json:"isInstantaneous" api:"required"`
	LinkedURL       string                                                          `json:"linkedUrl" api:"required" format:"uri"`
	StartDate       time.Time                                                       `json:"startDate" api:"required" format:"date-time"`
...
func (r AS112TimeseriesGroupsV2ResponseMetaConfidenceInfoAnnotationsEventType) IsKnown() bool {
	switch r {
	case AS112TimeseriesGroupsV2ResponseMetaConfidenceInfoAnnotationsEventTypeGeneral, AS112TimeseriesGroupsV2ResponseMetaConfidenceInfoAnnotationsEventTypeOutage, AS112TimeseriesGroupsV2ResponseMetaConfidenceInfoAnnotationsEventTypePartialProjection, AS112TimeseriesGroupsV2ResponseMetaConfidenceInfoAnnotationsEventTypePipeline, AS112TimeseriesGroupsV2ResponseMetaConfidenceInfoAnnotationsEventTypeTrafficAnomaly:
		return true
	}
	return false
}
...
type AS112SummaryV2ResponseEnvelope struct {
	Result  AS112SummaryV2Response             `json:"result" api:"required"`
...
type AS112TimeseriesResponseEnvelope struct {
	Result  AS112TimeseriesResponse             `json:"result" api:"required"`
	Success bool                                `json:"success" api:"required"`
...
type AS112TimeseriesGroupsV2ResponseEnvelope struct {
	Result  AS112TimeseriesGroupsV2Response             `json:"result" api:"required"`
	Success bool                                        `json:"success" api:"required"`
