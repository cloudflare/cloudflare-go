...
type HTTPSummaryBotClassResponse struct {
	...
	Meta     HTTPSummaryBotClassResponseMeta     `json:"meta" api:"required"`
	Summary0 HTTPSummaryBotClassResponseSummary0 `json:"summary_0" api:"required"`
...
type HTTPSummaryBotClassResponseMeta struct {
	ConfidenceInfo HTTPSummaryBotClassResponseMetaConfidenceInfo `json:"confidenceInfo" api:"required"`
	DateRange      []HTTPSummaryBotClassResponseMetaDateRange    `json:"dateRange" api:"required"`
	// Timestamp of the last dataset update.
	LastUpdated time.Time `json:"lastUpdated" api:"required" format:"date-time"`
	// Normalization method applied to the results. Refer to
	// [Normalization methods](https://developers.cloudflare.com/radar/concepts/normalization/).
	Normalization HTTPSummaryBotClassResponseMetaNormalization `json:"normalization" api:"required"`
	// Measurement units for the results.
	Units []HTTPSummaryBotClassResponseMetaUnit `json:"units" api:"required"`
...
type HTTPSummaryBotClassResponseMetaConfidenceInfo struct {
	Annotations []HTTPSummaryBotClassResponseMetaConfidenceInfoAnnotation `json:"annotations" api:"required"`
...
type HTTPSummaryBotClassResponseMetaConfidenceInfoAnnotation struct {
	...
	DataSource  HTTPSummaryBotClassResponseMetaConfidenceInfoAnnotationsDataSource `json:"dataSource" api:"required"`
	Description string                                                             `json:"description" api:"required"`
	EndDate     time.Time                                                          `json:"endDate" api:"required" format:"date-time"`
	// Event type for annotations.
	EventType HTTPSummaryBotClassResponseMetaConfidenceInfoAnnotationsEventType `json:"eventType" api:"required"`
...
func (r HTTPSummaryBotClassResponseMetaConfidenceInfoAnnotationsEventType) IsKnown() bool {
	switch r {
	case HTTPSummaryBotClassResponseMetaConfidenceInfoAnnotationsEventTypeGeneral, HTTPSummaryBotClassResponseMetaConfidenceInfoAnnotationsEventTypeOutage, HTTPSummaryBotClassResponseMetaConfidenceInfoAnnotationsEventTypePartialProjection, HTTPSummaryBotClassResponseMetaConfidenceInfoAnnotationsEventTypePipeline, HTTPSummaryBotClassResponseMetaConfidenceInfoAnnotationsEventTypeTrafficAnomaly:
		return true
	}
	return false
}
...
type HTTPSummaryDeviceTypeResponse struct {
	// Metadata for the results.
	Meta     HTTPSummaryDeviceTypeResponseMeta     `json:"meta" api:"required"`
	Summary0 HTTPSummaryDeviceTypeResponseSummary0 `json:"summary_0" api:"required"`
...
type HTTPSummaryDeviceTypeResponseMeta struct {
	ConfidenceInfo HTTPSummaryDeviceTypeResponseMetaConfidenceInfo `json:"confidenceInfo" api:"required"`
	DateRange      []HTTPSummaryDeviceTypeResponseMetaDateRange    `json:"dateRange" api:"required"`
	// Timestamp of the last dataset update.
	LastUpdated time.Time `json:"lastUpdated" api:"required" format:"date-time"`
	// Normalization method applied to the results. Refer to
	// [Normalization methods](https://developers.cloudflare.com/radar/concepts/normalization/).
	Normalization HTTPSummaryDeviceTypeResponseMetaNormalization `json:"normalization" api:"required"`
	// Measurement units for the results.
	Units []HTTPSummaryDeviceTypeResponseMetaUnit `json:"units" api:"required"`
...
type HTTPSummaryDeviceTypeResponseMetaConfidenceInfo struct {
	Annotations []HTTPSummaryDeviceTypeResponseMetaConfidenceInfoAnnotation `json:"annotations" api:"required"`
	// Provides an indication of how much confidence Cloudflare has in the data.
	Level int64                                               `json:"level" api:"required"`
...
type HTTPSummaryDeviceTypeResponseMetaConfidenceInfoAnnotation struct {
	// Data source for annotations.
	DataSource  HTTPSummaryDeviceTypeResponseMetaConfidenceInfoAnnotationsDataSource `json:"dataSource" api:"required"`
	Description string                                                               `json:"description" api:"required"`
	EndDate     time.Time                                                            `json:"endDate" api:"required" format:"date-time"`
	// Event type for annotations.
	EventType HTTPSummaryDeviceTypeResponseMetaConfidenceInfoAnnotationsEventType `json:"eventType" api:"required"`
	// Whether event is a single point in time or a time range.
	IsInstantaneous bool                                                          `json:"isInstantaneous" api:"required"`
	LinkedURL       string                                                        `json:"linkedUrl" api:"required" format:"uri"`
	StartDate       time.Time                                                     `json:"startDate" api:"required" format:"date-time"`
...
func (r HTTPSummaryDeviceTypeResponseMetaConfidenceInfoAnnotationsEventType) IsKnown() bool {
	switch r {
	case HTTPSummaryDeviceTypeResponseMetaConfidenceInfoAnnotationsEventTypeGeneral, HTTPSummaryDeviceTypeResponseMetaConfidenceInfoAnnotationsEventTypeOutage, HTTPSummaryDeviceTypeResponseMetaConfidenceInfoAnnotationsEventTypePartialProjection, HTTPSummaryDeviceTypeResponseMetaConfidenceInfoAnnotationsEventTypePipeline, HTTPSummaryDeviceTypeResponseMetaConfidenceInfoAnnotationsEventTypeTrafficAnomaly:
		return true
	}
	return false
}
...
type HTTPSummaryHTTPProtocolResponse struct {
	// Metadata for the results.
	Meta     HTTPSummaryHTTPProtocolResponseMeta     `json:"meta" api:"required"`
	Summary0 HTTPSummaryHTTPProtocolResponseSummary0 `json:"summary_0" api:"required"`
...
type HTTPSummaryHTTPProtocolResponseMeta struct {
	ConfidenceInfo HTTPSummaryHTTPProtocolResponseMetaConfidenceInfo `json:"confidenceInfo" api:"required"`
	DateRange      []HTTPSummaryHTTPProtocolResponseMetaDateRange    `json:"dateRange" api:"required"`
	// Timestamp of the last dataset update.
	LastUpdated time.Time `json:"lastUpdated" api:"required" format:"date-time"`
	// Normalization method applied to the results. Refer to
	// [Normalization methods](https://developers.cloudflare.com/radar/concepts/normalization/).
	Normalization HTTPSummaryHTTPProtocolResponseMetaNormalization `json:"normalization" api:"required"`
	// Measurement units for the results.
	Units []HTTPSummaryHTTPProtocolResponseMetaUnit `json:"units" api:"required"`
...
type HTTPSummaryHTTPProtocolResponseMetaConfidenceInfo struct {
	Annotations []HTTPSummaryHTTPProtocolResponseMetaConfidenceInfoAnnotation `json:"annotations" api:"required"`
	// Provides an indication of how much confidence Cloudflare has in the data.
	Level int64                                                 `json:"level" api:"required"`
...
type HTTPSummaryHTTPProtocolResponseMetaConfidenceInfoAnnotation struct {
	// Data source for annotations.
	DataSource  HTTPSummaryHTTPProtocolResponseMetaConfidenceInfoAnnotationsDataSource `json:"dataSource" api:"required"`
	Description string                                                                 `json:"description" api:"required"`
	EndDate     time.Time                                                              `json:"endDate" api:"required" format:"date-time"`
	// Event type for annotations.
	EventType HTTPSummaryHTTPProtocolResponseMetaConfidenceInfoAnnotationsEventType `json:"eventType" api:"required"`
	// Whether event is a single point in time or a time range.
	IsInstantaneous bool                                                            `json:"isInstantaneous" api:"required"`
	LinkedURL       string                                                          `json:"linkedUrl" api:"required" format:"uri"`
	StartDate       time.Time                                                       `json:"startDate" api:"required" format:"date-time"`
...
type HTTPSummaryHTTPVersionResponse struct {
	// Metadata for the results.
	Meta     HTTPSummaryHTTPVersionResponseMeta     `json:"meta" api:"required"`
	Summary0 HTTPSummaryHTTPVersionResponseSummary0 `json:"summary_0" api:"required"`
...
type HTTPSummaryHTTPVersionResponseMeta struct {
	ConfidenceInfo HTTPSummaryHTTPVersionResponseMetaConfidenceInfo `json:"confidenceInfo" api:"required"`
	DateRange      []HTTPSummaryHTTPVersionResponseMetaDateRange    `json:"dateRange" api:"required"`
	// Timestamp of the last dataset update.
	LastUpdated time.Time `json:"lastUpdated" api:"required" format:"date-time"`
	// Normalization method applied to the results. Refer to
	// [Normalization methods](https://developers.cloudflare.com/radar/concepts/normalization/).
	Normalization HTTPSummaryHTTPVersionResponseMetaNormalization `json:"normalization" api:"required"`
	// Measurement units for the results.
	Units []HTTPSummaryHTTPVersionResponseMetaUnit `json:"units" api:"required"`
...
type HTTPSummaryHTTPVersionResponseMetaConfidenceInfo struct {
	Annotations []HTTPSummaryHTTPVersionResponseMetaConfidenceInfoAnnotation `json:"annotations" api:"required"`
	// Provides an indication of how much confidence Cloudflare has in the data.
	Level int64                                                `json:"level" api:"required"`
...
type HTTPSummaryHTTPVersionResponseMetaConfidenceInfoAnnotation struct {
	// Data source for annotations.
	DataSource  HTTPSummaryHTTPVersionResponseMetaConfidenceInfoAnnotationsDataSource `json:"dataSource" api:"required"`
	Description string                                                                `json:"description" api:"required"`
	EndDate     time.Time                                                             `json:"endDate" api:"required" format:"date-time"`
	// Event type for annotations.
	EventType HTTPSummaryHTTPVersionResponseMetaConfidenceInfoAnnotationsEventType `json:"eventType" api:"required"`
	// Whether event is a single point in time or a time range.
	IsInstantaneous bool                                                           `json:"isInstantaneous" api:"required"`
	LinkedURL       string                                                         `json:"linkedUrl" api:"required" format:"uri"`
	StartDate       time.Time                                                      `json:"startDate" api:"required" format:"date-time"`
...
type HTTPSummaryIPVersionResponse struct {
	// Metadata for the results.
	Meta     HTTPSummaryIPVersionResponseMeta     `json:"meta" api:"required"`
	Summary0 HTTPSummaryIPVersionResponseSummary0 `json:"summary_0" api:"required"`
...
type HTTPSummaryIPVersionResponseMeta struct {
	ConfidenceInfo HTTPSummaryIPVersionResponseMetaConfidenceInfo `json:"confidenceInfo" api:"required"`
	DateRange      []HTTPSummaryIPVersionResponseMetaDateRange    `json:"dateRange" api:"required"`
	// Timestamp of the last dataset update.
	LastUpdated time.Time `json:"lastUpdated" api:"required" format:"date-time"`
	// Normalization method applied to the results. Refer to
	// [Normalization methods](https://developers.cloudflare.com/radar/concepts/normalization/).
	Normalization HTTPSummaryIPVersionResponseMetaNormalization `json:"normalization" api:"required"`
	// Measurement units for the results.
	Units []HTTPSummaryIPVersionResponseMetaUnit `json:"units" api:"required"`
...
type HTTPSummaryIPVersionResponseMetaConfidenceInfo struct {
	Annotations []HTTPSummaryIPVersionResponseMetaConfidenceInfoAnnotation `json:"annotations" api:"required"`
	// Provides an indication of how much confidence Cloudflare has in the data.
	Level int64                                              `json:"level" api:"required"`
...
type HTTPSummaryIPVersionResponseMetaConfidenceInfoAnnotation struct {
	// Data source for annotations.
	DataSource  HTTPSummaryIPVersionResponseMetaConfidenceInfoAnnotationsDataSource `json:"dataSource" api:"required"`
	Description string                                                              `json:"description" api:"required"`
	EndDate     time.Time                                                           `json:"endDate" api:"required" format:"date-time"`
	// Event type for annotations.
	EventType HTTPSummaryIPVersionResponseMetaConfidenceInfoAnnotationsEventType `json:"eventType" api:"required"`
	// Whether event is a single point in time or a time range.
	IsInstantaneous bool                                                         `json:"isInstantaneous" api:"required"`
	LinkedURL       string                                                       `json:"linkedUrl" api:"required" format:"uri"`
	StartDate       time.Time                                                    `json:"startDate" api:"required" format:"date-time"`
...
type HTTPSummaryOSResponse struct {
	// Metadata for the results.
	Meta     HTTPSummaryOSResponseMeta     `json:"meta" api:"required"`
	Summary0 HTTPSummaryOSResponseSummary0 `json:"summary_0" api:"required"`
...
type HTTPSummaryOSResponseMeta struct {
	ConfidenceInfo HTTPSummaryOSResponseMetaConfidenceInfo `json:"confidenceInfo" api:"required"`
	DateRange      []HTTPSummaryOSResponseMetaDateRange    `json:"dateRange" api:"required"`
	// Timestamp of the last dataset update.
	LastUpdated time.Time `json:"lastUpdated" api:"required" format:"date-time"`
	// Normalization method applied to the results. Refer to
	// [Normalization methods](https://developers.cloudflare.com/radar/concepts/normalization/).
	Normalization HTTPSummaryOSResponseMetaNormalization `json:"normalization" api:"required"`
	// Measurement units for the results.
	Units []HTTPSummaryOSResponseMetaUnit `json:"units" api:"required"`
...
type HTTPSummaryOSResponseMetaConfidenceInfo struct {
	Annotations []HTTPSummaryOSResponseMetaConfidenceInfoAnnotation `json:"annotations" api:"required"`
	// Provides an indication of how much confidence Cloudflare has in the data.
	Level int64                                       `json:"level" api:"required"`
...
type HTTPSummaryOSResponseMetaConfidenceInfoAnnotation struct {
	// Data source for annotations.
	DataSource  HTTPSummaryOSResponseMetaConfidenceInfoAnnotationsDataSource `json:"dataSource" api:"required"`
	Description string                                                       `json:"description" api:"required"`
	EndDate     time.Time                                                    `json:"endDate" api:"required" format:"date-time"`
	// Event type for annotations.
	EventType HTTPSummaryOSResponseMetaConfidenceInfoAnnotationsEventType `json:"eventType" api:"required"`
	// Whether event is a single point in time or a time range.
	IsInstantaneous bool                                                  `json:"isInstantaneous" api:"required"`
	LinkedURL       string                                                `json:"linkedUrl" api:"required" format:"uri"`
	StartDate       time.Time                                             `json:"startDate" api:"required" format:"date-time"`
...
func (r HTTPSummaryOSResponseMetaConfidenceInfoAnnotationsEventType) IsKnown() bool {
	switch r {
	case HTTPSummaryOSResponseMetaConfidenceInfoAnnotationsEventTypeGeneral, HTTPSummaryOSResponseMetaConfidenceInfoAnnotationsEventTypeOutage, HTTPSummaryOSResponseMetaConfidenceInfoAnnotationsEventTypePartialProjection, HTTPSummaryOSResponseMetaConfidenceInfoAnnotationsEventTypePipeline, HTTPSummaryOSResponseMetaConfidenceInfoAnnotationsEventTypeTrafficAnomaly:
		return true
	}
	return false
}
...
type HTTPSummaryPostQuantumResponse struct {
	// Metadata for the results.
	Meta     HTTPSummaryPostQuantumResponseMeta     `json:"meta" api:"required"`
	Summary0 HTTPSummaryPostQuantumResponseSummary0 `json:"summary_0" api:"required"`
...
type HTTPSummaryPostQuantumResponseMeta struct {
	ConfidenceInfo HTTPSummaryPostQuantumResponseMetaConfidenceInfo `json:"confidenceInfo" api:"required"`
	DateRange      []HTTPSummaryPostQuantumResponseMetaDateRange    `json:"dateRange" api:"required"`
	// Timestamp of the last dataset update.
	LastUpdated time.Time `json:"lastUpdated" api:"required" format:"date-time"`
	// Normalization method applied to the results. Refer to
	// [Normalization methods](https://developers.cloudflare.com/radar/concepts/normalization/).
	Normalization HTTPSummaryPostQuantumResponseMetaNormalization `json:"normalization" api:"required"`
	// Measurement units for the results.
	Units []HTTPSummaryPostQuantumResponseMetaUnit `json:"units" api:"required"`
...
type HTTPSummaryPostQuantumResponseMetaConfidenceInfo struct {
	Annotations []HTTPSummaryPostQuantumResponseMetaConfidenceInfoAnnotation `json:"annotations" api:"required"`
	// Provides an indication of how much confidence Cloudflare has in the data.
	Level int64                                                `json:"level" api:"required"`
...
type HTTPSummaryPostQuantumResponseMetaConfidenceInfoAnnotation struct {
	// Data source for annotations.
	DataSource  HTTPSummaryPostQuantumResponseMetaConfidenceInfoAnnotationsDataSource `json:"dataSource" api:"required"`
	Description string                                                                `json:"description" api:"required"`
	EndDate     time.Time                                                             `json:"endDate" api:"required" format:"date-time"`
	// Event type for annotations.
	EventType HTTPSummaryPostQuantumResponseMetaConfidenceInfoAnnotationsEventType `json:"eventType" api:"required"`
	// Whether event is a single point in time or a time range.
	IsInstantaneous bool                                                           `json:"isInstantaneous" api:"required"`
	LinkedURL       string                                                         `json:"linkedUrl" api:"required" format:"uri"`
	StartDate       time.Time                                                      `json:"startDate" api:"required" format:"date-time"`
...
type HTTPSummaryTLSVersionResponse struct {
	// Metadata for the results.
	Meta     HTTPSummaryTLSVersionResponseMeta     `json:"meta" api:"required"`
	Summary0 HTTPSummaryTLSVersionResponseSummary0 `json:"summary_0" api:"required"`
...
type HTTPSummaryTLSVersionResponseMeta struct {
	ConfidenceInfo HTTPSummaryTLSVersionResponseMetaConfidenceInfo `json:"confidenceInfo" api:"required"`
	DateRange      []HTTPSummaryTLSVersionResponseMetaDateRange    `json:"dateRange" api:"required"`
	// Timestamp of the last dataset update.
	LastUpdated time.Time `json:"lastUpdated" api:"required" format:"date-time"`
	// Normalization method applied to the results. Refer to
	// [Normalization methods](https://developers.cloudflare.com/radar/concepts/normalization/).
	Normalization HTTPSummaryTLSVersionResponseMetaNormalization `json:"normalization" api:"required"`
	// Measurement units for the results.
	Units []HTTPSummaryTLSVersionResponseMetaUnit `json:"units" api:"required"`
...
type HTTPSummaryTLSVersionResponseMetaConfidenceInfo struct {
	Annotations []HTTPSummaryTLSVersionResponseMetaConfidenceInfoAnnotation `json:"annotations" api:"required"`
	// Provides an indication of how much confidence Cloudflare has in the data.
	Level int64                                               `json:"level" api:"required"`
...
type HTTPSummaryTLSVersionResponseMetaConfidenceInfoAnnotation struct {
	// Data source for annotations.
	DataSource  HTTPSummaryTLSVersionResponseMetaConfidenceInfoAnnotationsDataSource `json:"dataSource" api:"required"`
	Description string                                                               `json:"description" api:"required"`
	EndDate     time.Time                                                            `json:"endDate" api:"required" format:"date-time"`
	// Event type for annotations.
	EventType HTTPSummaryTLSVersionResponseMetaConfidenceInfoAnnotationsEventType `json:"eventType" api:"required"`
	// Whether event is a single point in time or a time range.
	IsInstantaneous bool                                                          `json:"isInstantaneous" api:"required"`
	LinkedURL       string                                                        `json:"linkedUrl" api:"required" format:"uri"`
	StartDate       time.Time                                                     `json:"startDate" api:"required" format:"date-time"`
...
func (r HTTPSummaryTLSVersionResponseMetaConfidenceInfoAnnotationsEventType) IsKnown() bool {
	switch r {
	case HTTPSummaryTLSVersionResponseMetaConfidenceInfoAnnotationsEventTypeGeneral, HTTPSummaryTLSVersionResponseMetaConfidenceInfoAnnotationsEventTypeOutage, HTTPSummaryTLSVersionResponseMetaConfidenceInfoAnnotationsEventTypePartialProjection, HTTPSummaryTLSVersionResponseMetaConfidenceInfoAnnotationsEventTypePipeline, HTTPSummaryTLSVersionResponseMetaConfidenceInfoAnnotationsEventTypeTrafficAnomaly:
		return true
	}
	return false
}
...
type HTTPSummaryBotClassResponseEnvelope struct {
	Result  HTTPSummaryBotClassResponse             `json:"result" api:"required"`
...
type HTTPSummaryDeviceTypeResponseEnvelope struct {
	Result  HTTPSummaryDeviceTypeResponse             `json:"result" api:"required"`
	Success bool                                      `json:"success" api:"required"`
...
type HTTPSummaryHTTPProtocolResponseEnvelope struct {
	Result  HTTPSummaryHTTPProtocolResponse             `json:"result" api:"required"`
	Success bool                                        `json:"success" api:"required"`
...
type HTTPSummaryHTTPVersionResponseEnvelope struct {
	Result  HTTPSummaryHTTPVersionResponse             `json:"result" api:"required"`
	Success bool                                       `json:"success" api:"required"`
...
type HTTPSummaryIPVersionResponseEnvelope struct {
	Result  HTTPSummaryIPVersionResponse             `json:"result" api:"required"`
	Success bool                                     `json:"success" api:"required"`
...
type HTTPSummaryOSResponseEnvelope struct {
	Result  HTTPSummaryOSResponse             `json:"result" api:"required"`
	Success bool                              `json:"success" api:"required"`
...
type HTTPSummaryPostQuantumResponseEnvelope struct {
	Result  HTTPSummaryPostQuantumResponse             `json:"result" api:"required"`
	Success bool                                       `json:"success" api:"required"`
...
type HTTPSummaryTLSVersionResponseEnvelope struct {
	Result  HTTPSummaryTLSVersionResponse             `json:"result" api:"required"`
	Success bool                                      `json:"success" api:"required"`
