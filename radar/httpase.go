...
type HTTPAseGetResponse struct {
	...
	Meta HTTPAseGetResponseMeta   `json:"meta" api:"required"`
	Top0 []HTTPAseGetResponseTop0 `json:"top_0" api:"required"`
...
type HTTPAseGetResponseMeta struct {
	ConfidenceInfo HTTPAseGetResponseMetaConfidenceInfo `json:"confidenceInfo" api:"required,nullable"`
	DateRange      []HTTPAseGetResponseMetaDateRange    `json:"dateRange" api:"required"`
	// Timestamp of the last dataset update.
	LastUpdated time.Time `json:"lastUpdated" api:"required" format:"date-time"`
	// Normalization method applied to the results. Refer to
	// [Normalization methods](https://developers.cloudflare.com/radar/concepts/normalization/).
	Normalization HTTPAseGetResponseMetaNormalization `json:"normalization" api:"required"`
	// Measurement units for the results.
	Units []HTTPAseGetResponseMetaUnit `json:"units" api:"required"`
...
type HTTPAseGetResponseMetaConfidenceInfo struct {
	Annotations []HTTPAseGetResponseMetaConfidenceInfoAnnotation `json:"annotations" api:"required"`
...
type HTTPAseGetResponseMetaConfidenceInfoAnnotation struct {
	...
	DataSource  HTTPAseGetResponseMetaConfidenceInfoAnnotationsDataSource `json:"dataSource" api:"required"`
	Description string                                                    `json:"description" api:"required"`
	EndDate     time.Time                                                 `json:"endDate" api:"required" format:"date-time"`
	// Event type for annotations.
	EventType HTTPAseGetResponseMetaConfidenceInfoAnnotationsEventType `json:"eventType" api:"required"`
...
func (r HTTPAseGetResponseMetaConfidenceInfoAnnotationsEventType) IsKnown() bool {
	switch r {
	case HTTPAseGetResponseMetaConfidenceInfoAnnotationsEventTypeGeneral, HTTPAseGetResponseMetaConfidenceInfoAnnotationsEventTypeOutage, HTTPAseGetResponseMetaConfidenceInfoAnnotationsEventTypePartialProjection, HTTPAseGetResponseMetaConfidenceInfoAnnotationsEventTypePipeline, HTTPAseGetResponseMetaConfidenceInfoAnnotationsEventTypeTrafficAnomaly:
		return true
	}
	return false
}
...
type HTTPAseGetResponseEnvelope struct {
	Result  HTTPAseGetResponse             `json:"result" api:"required"`
