...
type LeakedCredentialSummaryBotClassResponse struct {
	...
	Meta     LeakedCredentialSummaryBotClassResponseMeta     `json:"meta" api:"required"`
	Summary0 LeakedCredentialSummaryBotClassResponseSummary0 `json:"summary_0" api:"required"`
...
type LeakedCredentialSummaryBotClassResponseMeta struct {
	ConfidenceInfo LeakedCredentialSummaryBotClassResponseMetaConfidenceInfo `json:"confidenceInfo" api:"required"`
	DateRange      []LeakedCredentialSummaryBotClassResponseMetaDateRange    `json:"dateRange" api:"required"`
	// Timestamp of the last dataset update.
	LastUpdated time.Time `json:"lastUpdated" api:"required" format:"date-time"`
	// Normalization method applied to the results. Refer to
	// [Normalization methods](https://developers.cloudflare.com/radar/concepts/normalization/).
	Normalization LeakedCredentialSummaryBotClassResponseMetaNormalization `json:"normalization" api:"required"`
	// Measurement units for the results.
	Units []LeakedCredentialSummaryBotClassResponseMetaUnit `json:"units" api:"required"`
...
type LeakedCredentialSummaryBotClassResponseMetaConfidenceInfo struct {
	Annotations []LeakedCredentialSummaryBotClassResponseMetaConfidenceInfoAnnotation `json:"annotations" api:"required"`
...
type LeakedCredentialSummaryBotClassResponseMetaConfidenceInfoAnnotation struct {
	...
	DataSource  LeakedCredentialSummaryBotClassResponseMetaConfidenceInfoAnnotationsDataSource `json:"dataSource" api:"required"`
	Description string                                                                         `json:"description" api:"required"`
	EndDate     time.Time                                                                      `json:"endDate" api:"required" format:"date-time"`
	// Event type for annotations.
	EventType LeakedCredentialSummaryBotClassResponseMetaConfidenceInfoAnnotationsEventType `json:"eventType" api:"required"`
...
type LeakedCredentialSummaryCompromisedResponse struct {
	// Metadata for the results.
	Meta     LeakedCredentialSummaryCompromisedResponseMeta     `json:"meta" api:"required"`
	Summary0 LeakedCredentialSummaryCompromisedResponseSummary0 `json:"summary_0" api:"required"`
...
type LeakedCredentialSummaryCompromisedResponseMeta struct {
	ConfidenceInfo LeakedCredentialSummaryCompromisedResponseMetaConfidenceInfo `json:"confidenceInfo" api:"required"`
	DateRange      []LeakedCredentialSummaryCompromisedResponseMetaDateRange    `json:"dateRange" api:"required"`
	// Timestamp of the last dataset update.
	LastUpdated time.Time `json:"lastUpdated" api:"required" format:"date-time"`
	// Normalization method applied to the results. Refer to
	// [Normalization methods](https://developers.cloudflare.com/radar/concepts/normalization/).
	Normalization LeakedCredentialSummaryCompromisedResponseMetaNormalization `json:"normalization" api:"required"`
	// Measurement units for the results.
	Units []LeakedCredentialSummaryCompromisedResponseMetaUnit `json:"units" api:"required"`
...
type LeakedCredentialSummaryCompromisedResponseMetaConfidenceInfo struct {
	Annotations []LeakedCredentialSummaryCompromisedResponseMetaConfidenceInfoAnnotation `json:"annotations" api:"required"`
	// Provides an indication of how much confidence Cloudflare has in the data.
	Level int64                                                            `json:"level" api:"required"`
...
type LeakedCredentialSummaryCompromisedResponseMetaConfidenceInfoAnnotation struct {
	// Data source for annotations.
	DataSource  LeakedCredentialSummaryCompromisedResponseMetaConfidenceInfoAnnotationsDataSource `json:"dataSource" api:"required"`
	Description string                                                                            `json:"description" api:"required"`
	EndDate     time.Time                                                                         `json:"endDate" api:"required" format:"date-time"`
	// Event type for annotations.
	EventType LeakedCredentialSummaryCompromisedResponseMetaConfidenceInfoAnnotationsEventType `json:"eventType" api:"required"`
	// Whether event is a single point in time or a time range.
	IsInstantaneous bool                                                                       `json:"isInstantaneous" api:"required"`
	LinkedURL       string                                                                     `json:"linkedUrl" api:"required" format:"uri"`
	StartDate       time.Time                                                                  `json:"startDate" api:"required" format:"date-time"`
...
type LeakedCredentialSummaryBotClassResponseEnvelope struct {
	Result  LeakedCredentialSummaryBotClassResponse             `json:"result" api:"required"`
...
type LeakedCredentialSummaryCompromisedResponseEnvelope struct {
	Result  LeakedCredentialSummaryCompromisedResponse             `json:"result" api:"required"`
	Success bool                                                   `json:"success" api:"required"`
