...
type HTTPLocationHTTPProtocolGetResponse struct {
	...
	Meta HTTPLocationHTTPProtocolGetResponseMeta   `json:"meta" api:"required"`
	Top0 []HTTPLocationHTTPProtocolGetResponseTop0 `json:"top_0" api:"required"`
...
type HTTPLocationHTTPProtocolGetResponseMeta struct {
	ConfidenceInfo HTTPLocationHTTPProtocolGetResponseMetaConfidenceInfo `json:"confidenceInfo" api:"required,nullable"`
	DateRange      []HTTPLocationHTTPProtocolGetResponseMetaDateRange    `json:"dateRange" api:"required"`
	// Timestamp of the last dataset update.
	LastUpdated time.Time `json:"lastUpdated" api:"required" format:"date-time"`
	// Normalization method applied to the results. Refer to
	// [Normalization methods](https://developers.cloudflare.com/radar/concepts/normalization/).
	Normalization HTTPLocationHTTPProtocolGetResponseMetaNormalization `json:"normalization" api:"required"`
	// Measurement units for the results.
	Units []HTTPLocationHTTPProtocolGetResponseMetaUnit `json:"units" api:"required"`
...
type HTTPLocationHTTPProtocolGetResponseMetaConfidenceInfo struct {
	Annotations []HTTPLocationHTTPProtocolGetResponseMetaConfidenceInfoAnnotation `json:"annotations" api:"required"`
...
type HTTPLocationHTTPProtocolGetResponseMetaConfidenceInfoAnnotation struct {
	...
	DataSource  HTTPLocationHTTPProtocolGetResponseMetaConfidenceInfoAnnotationsDataSource `json:"dataSource" api:"required"`
	Description string                                                                     `json:"description" api:"required"`
	EndDate     time.Time                                                                  `json:"endDate" api:"required" format:"date-time"`
	// Event type for annotations.
	EventType HTTPLocationHTTPProtocolGetResponseMetaConfidenceInfoAnnotationsEventType `json:"eventType" api:"required"`
...
type HTTPLocationHTTPProtocolGetResponseEnvelope struct {
	Result  HTTPLocationHTTPProtocolGetResponse             `json:"result" api:"required"`
