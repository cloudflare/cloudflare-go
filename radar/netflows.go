...
func (r NetFlowsSummaryResponseMetaConfidenceInfoAnnotationsEventType) IsKnown() bool {
	switch r {
	case NetFlowsSummaryResponseMetaConfidenceInfoAnnotationsEventTypeGeneral, NetFlowsSummaryResponseMetaConfidenceInfoAnnotationsEventTypeOutage, NetFlowsSummaryResponseMetaConfidenceInfoAnnotationsEventTypePartialProjection, NetFlowsSummaryResponseMetaConfidenceInfoAnnotationsEventTypePipeline, NetFlowsSummaryResponseMetaConfidenceInfoAnnotationsEventTypeTrafficAnomaly:
		return true
	}
	return false
}
