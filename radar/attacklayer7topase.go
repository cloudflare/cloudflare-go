...
type AttackLayer7TopAseOriginResponse struct {
	...
	Meta AttackLayer7TopAseOriginResponseMeta   `json:"meta" api:"required"`
	Top0 []AttackLayer7TopAseOriginResponseTop0 `json:"top_0" api:"required"`
...
type AttackLayer7TopAseOriginResponseMeta struct {
	ConfidenceInfo AttackLayer7TopAseOriginResponseMetaConfidenceInfo `json:"confidenceInfo" api:"required,nullable"`
	DateRange      []AttackLayer7TopAseOriginResponseMetaDateRange    `json:"dateRange" api:"required"`
	// Timestamp of the last dataset update.
	LastUpdated time.Time `json:"lastUpdated" api:"required" format:"date-time"`
	// Normalization method applied to the results. Refer to
	// [Normalization methods](https://developers.cloudflare.com/radar/concepts/normalization/).
	Normalization AttackLayer7TopAseOriginResponseMetaNormalization `json:"normalization" api:"required"`
	// Measurement units for the results.
	Units []AttackLayer7TopAseOriginResponseMetaUnit `json:"units" api:"required"`
...
type AttackLayer7TopAseOriginResponseMetaConfidenceInfo struct {
	Annotations []AttackLayer7TopAseOriginResponseMetaConfidenceInfoAnnotation `json:"annotations" api:"required"`
...
type AttackLayer7TopAseOriginResponseMetaConfidenceInfoAnnotation struct {
	...
	DataSource  AttackLayer7TopAseOriginResponseMetaConfidenceInfoAnnotationsDataSource `json:"dataSource" api:"required"`
	Description string                                                                  `json:"description" api:"required"`
	EndDate     time.Time                                                               `json:"endDate" api:"required" format:"date-time"`
	// Event type for annotations.
	EventType AttackLayer7TopAseOriginResponseMetaConfidenceInfoAnnotationsEventType `json:"eventType" api:"required"`
...
type AttackLayer7TopAseOriginResponseEnvelope struct {
	Result  AttackLayer7TopAseOriginResponse             `json:"result" api:"required"`
