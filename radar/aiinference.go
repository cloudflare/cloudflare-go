...
type AIInferenceSummaryV2Response struct {
	...
	Meta     AIInferenceSummaryV2ResponseMeta `json:"meta" api:"required"`
...
type AIInferenceSummaryV2ResponseMeta struct {
	ConfidenceInfo AIInferenceSummaryV2ResponseMetaConfidenceInfo `json:"confidenceInfo" api:"required"`
	DateRange      []AIInferenceSummaryV2ResponseMetaDateRange    `json:"dateRange" api:"required"`
	// Timestamp of the last dataset update.
	LastUpdated time.Time `json:"lastUpdated" api:"required" format:"date-time"`
	// Normalization method applied to the results. Refer to
	// [Normalization methods](https://developers.cloudflare.com/radar/concepts/normalization/).
	Normalization AIInferenceSummaryV2ResponseMetaNormalization `json:"normalization" api:"required"`
	// Measurement units for the results.
	Units []AIInferenceSummaryV2ResponseMetaUnit `json:"units" api:"required"`
...
type AIInferenceSummaryV2ResponseMetaConfidenceInfo struct {
	Annotations []AIInferenceSummaryV2ResponseMetaConfidenceInfoAnnotation `json:"annotations" api:"required"`
...
type AIInferenceSummaryV2ResponseMetaConfidenceInfoAnnotation struct {
	...
	DataSource  AIInferenceSummaryV2ResponseMetaConfidenceInfoAnnotationsDataSource `json:"dataSource" api:"required"`
	Description string                                                              `json:"description" api:"required"`
	EndDate     time.Time                                                           `json:"endDate" api:"required" format:"date-time"`
	// Event type for annotations.
	EventType AIInferenceSummaryV2ResponseMetaConfidenceInfoAnnotationsEventType `json:"eventType" api:"required"`
...
func (r AIInferenceSummaryV2ResponseMetaConfidenceInfoAnnotationsEventType) IsKnown() bool {
	switch r {
	case AIInferenceSummaryV2ResponseMetaConfidenceInfoAnnotationsEventTypeGeneral, AIInferenceSummaryV2ResponseMetaConfidenceInfoAnnotationsEventTypeOutage, AIInferenceSummaryV2ResponseMetaConfidenceInfoAnnotationsEventTypePartialProjection, AIInferenceSummaryV2ResponseMetaConfidenceInfoAnnotationsEventTypePipeline, AIInferenceSummaryV2ResponseMetaConfidenceInfoAnnotationsEventTypeTrafficAnomaly:
		return true
	}
	return false
}
...
type AIInferenceTimeseriesGroupsV2Response struct {
	// Metadata for the results.
	Meta   AIInferenceTimeseriesGroupsV2ResponseMeta   `json:"meta" api:"required"`
	Serie0 AIInferenceTimeseriesGroupsV2ResponseSerie0 `json:"serie_0" api:"required"`
...
type AIInferenceTimeseriesGroupsV2ResponseMeta struct {
	...
	AggInterval    AIInferenceTimeseriesGroupsV2ResponseMetaAggInterval    `json:"aggInterval" api:"required"`
	ConfidenceInfo AIInferenceTimeseriesGroupsV2ResponseMetaConfidenceInfo `json:"confidenceInfo" api:"required"`
	DateRange      []AIInferenceTimeseriesGroupsV2ResponseMetaDateRange    `json:"dateRange" api:"required"`
	// Timestamp of the last dataset update.
	LastUpdated time.Time `json:"lastUpdated" api:"required" format:"date-time"`
	// Normalization method applied to the results. Refer to
	// [Normalization methods](https://developers.cloudflare.com/radar/concepts/normalization/).
	Normalization AIInferenceTimeseriesGroupsV2ResponseMetaNormalization `json:"normalization" api:"required"`
	// Measurement units for the results.
	Units []AIInferenceTimeseriesGroupsV2ResponseMetaUnit `json:"units" api:"required"`
...
type AIInferenceTimeseriesGroupsV2ResponseMetaConfidenceInfo struct {
	Annotations []AIInferenceTimeseriesGroupsV2ResponseMetaConfidenceInfoAnnotation `json:"annotations" api:"required"`
	// Provides an indication of how much confidence Cloudflare has in the data.
	Level int64                                                       `json:"level" api:"required"`
...
type AIInferenceTimeseriesGroupsV2ResponseMetaConfidenceInfoAnnotation struct {
	// Data source for annotations.
	DataSource  AIInferenceTimeseriesGroupsV2ResponseMetaConfidenceInfoAnnotationsDataSource `json:"dataSource" api:"required"`
	Description string                                                                       `json:"description" api:"required"`
	EndDate     time.Time                                                                    `json:"endDate" api:"required" format:"date-time"`
	// Event type for annotations.
	EventType AIInferenceTimeseriesGroupsV2ResponseMetaConfidenceInfoAnnotationsEventType `json:"eventType" api:"required"`
	// Whether event is a single point in time or a time range.
	IsInstantaneous bool                                                                  `json:"isInstantaneous" api:"required"`
	LinkedURL       string                                                                `json:"linkedUrl" api:"required" format:"uri"`
	StartDate       time.Time                                                             `json:"startDate" api:"required" format:"date-time"`
...
type AIInferenceSummaryV2ResponseEnvelope struct {
	Result  AIInferenceSummaryV2Response             `json:"result" api:"required"`
...
type AIInferenceTimeseriesGroupsV2ResponseEnvelope struct {
	Result  AIInferenceTimeseriesGroupsV2Response             `json:"result" api:"required"`
	Success bool                                              `json:"success" api:"required"`
