...
type EmailSecuritySummaryV2Response struct {
	...
	Meta     EmailSecuritySummaryV2ResponseMeta `json:"meta" api:"required"`
...
type EmailSecuritySummaryV2ResponseMeta struct {
	ConfidenceInfo EmailSecuritySummaryV2ResponseMetaConfidenceInfo `json:"confidenceInfo" api:"required"`
	DateRange      []EmailSecuritySummaryV2ResponseMetaDateRange    `json:"dateRange" api:"required"`
	// Timestamp of the last dataset update.
	LastUpdated time.Time `json:"lastUpdated" api:"required" format:"date-time"`
	// Normalization method applied to the results. Refer to
	// [Normalization methods](https://developers.cloudflare.com/radar/concepts/normalization/).
	Normalization EmailSecuritySummaryV2ResponseMetaNormalization `json:"normalization" api:"required"`
	// Measurement units for the results.
	Units []EmailSecuritySummaryV2ResponseMetaUnit `json:"units" api:"required"`
...
type EmailSecuritySummaryV2ResponseMetaConfidenceInfo struct {
	Annotations []EmailSecuritySummaryV2ResponseMetaConfidenceInfoAnnotation `json:"annotations" api:"required"`
...
type EmailSecuritySummaryV2ResponseMetaConfidenceInfoAnnotation struct {
	...
	DataSource  EmailSecuritySummaryV2ResponseMetaConfidenceInfoAnnotationsDataSource `json:"dataSource" api:"required"`
	Description string                                                                `json:"description" api:"required"`
	EndDate     time.Time                                                             `json:"endDate" api:"required" format:"date-time"`
	// Event type for annotations.
	EventType EmailSecuritySummaryV2ResponseMetaConfidenceInfoAnnotationsEventType `json:"eventType" api:"required"`
...
type EmailSecurityTimeseriesGroupsV2Response struct {
	// Metadata for the results.
	Meta   EmailSecurityTimeseriesGroupsV2ResponseMeta   `json:"meta" api:"required"`
	Serie0 EmailSecurityTimeseriesGroupsV2ResponseSerie0 `json:"serie_0" api:"required"`
...
type EmailSecurityTimeseriesGroupsV2ResponseMeta struct {
	...
	AggInterval    EmailSecurityTimeseriesGroupsV2ResponseMetaAggInterval    `json:"aggInterval" api:"required"`
	ConfidenceInfo EmailSecurityTimeseriesGroupsV2ResponseMetaConfidenceInfo `json:"confidenceInfo" api:"required"`
	DateRange      []EmailSecurityTimeseriesGroupsV2ResponseMetaDateRange    `json:"dateRange" api:"required"`
	// Timestamp of the last dataset update.
	LastUpdated time.Time `json:"lastUpdated" api:"required" format:"date-time"`
	// Normalization method applied to the results. Refer to
	// [Normalization methods](https://developers.cloudflare.com/radar/concepts/normalization/).
	Normalization EmailSecurityTimeseriesGroupsV2ResponseMetaNormalization `json:"normalization" api:"required"`
	// Measurement units for the results.
	Units []EmailSecurityTimeseriesGroupsV2ResponseMetaUnit `json:"units" api:"required"`
...
type EmailSecurityTimeseriesGroupsV2ResponseMetaConfidenceInfo struct {
	Annotations []EmailSecurityTimeseriesGroupsV2ResponseMetaConfidenceInfoAnnotation `json:"annotations" api:"required"`
	// Provides an indication of how much confidence Cloudflare has in the data.
	Level int64                                                         `json:"level" api:"required"`
...
type EmailSecurityTimeseriesGroupsV2ResponseMetaConfidenceInfoAnnotation struct {
	// Data source for annotations.
	DataSource  EmailSecurityTimeseriesGroupsV2ResponseMetaConfidenceInfoAnnotationsDataSource `json:"dataSource" api:"required"`
	Description string                                                                         `json:"description" api:"required"`
	EndDate     time.Time                                                                      `json:"endDate" api:"required" format:"date-time"`
	// Event type for annotations.
	EventType EmailSecurityTimeseriesGroupsV2ResponseMetaConfidenceInfoAnnotationsEventType `json:"eventType" api:"required"`
	// Whether event is a single point in time or a time range.
	IsInstantaneous bool                                                                    `json:"isInstantaneous" api:"required"`
	LinkedURL       string                                                                  `json:"linkedUrl" api:"required" format:"uri"`
	StartDate       time.Time                                                               `json:"startDate" api:"required" format:"date-time"`
...
type EmailSecuritySummaryV2ResponseEnvelope struct {
	Result  EmailSecuritySummaryV2Response             `json:"result" api:"required"`
...
type EmailSecurityTimeseriesGroupsV2ResponseEnvelope struct {
	Result  EmailSecurityTimeseriesGroupsV2Response             `json:"result" api:"required"`
	Success bool                                                `json:"success" api:"required"`
