...
type NetflowTopAsesResponse struct {
	...
	Meta NetflowTopAsesResponseMeta   `json:"meta" api:"required"`
	Top0 []NetflowTopAsesResponseTop0 `json:"top_0" api:"required"`
...
type NetflowTopAsesResponseMeta struct {
	ConfidenceInfo NetflowTopAsesResponseMetaConfidenceInfo `json:"confidenceInfo" api:"required,nullable"`
	DateRange      []NetflowTopAsesResponseMetaDateRange    `json:"dateRange" api:"required"`
	// Timestamp of the last dataset update.
	LastUpdated time.Time `json:"lastUpdated" api:"required" format:"date-time"`
	// Normalization method applied to the results. Refer to
	// [Normalization methods](https://developers.cloudflare.com/radar/concepts/normalization/).
	Normalization NetflowTopAsesResponseMetaNormalization `json:"normalization" api:"required"`
	// Measurement units for the results.
	Units []NetflowTopAsesResponseMetaUnit `json:"units" api:"required"`
...
type NetflowTopAsesResponseMetaConfidenceInfo struct {
	Annotations []NetflowTopAsesResponseMetaConfidenceInfoAnnotation `json:"annotations" api:"required"`
...
type NetflowTopAsesResponseMetaConfidenceInfoAnnotation struct {
	...
	DataSource  NetflowTopAsesResponseMetaConfidenceInfoAnnotationsDataSource `json:"dataSource" api:"required"`
	Description string                                                        `json:"description" api:"required"`
	EndDate     time.Time                                                     `json:"endDate" api:"required" format:"date-time"`
	// Event type for annotations.
	EventType NetflowTopAsesResponseMetaConfidenceInfoAnnotationsEventType `json:"eventType" api:"required"`
...
type NetflowTopLocationsResponse struct {
	// Metadata for the results.
	Meta NetflowTopLocationsResponseMeta   `json:"meta" api:"required"`
	Top0 []NetflowTopLocationsResponseTop0 `json:"top_0" api:"required"`
...
type NetflowTopLocationsResponseMeta struct {
	ConfidenceInfo NetflowTopLocationsResponseMetaConfidenceInfo `json:"confidenceInfo" api:"required,nullable"`
	DateRange      []NetflowTopLocationsResponseMetaDateRange    `json:"dateRange" api:"required"`
	// Timestamp of the last dataset update.
	LastUpdated time.Time `json:"lastUpdated" api:"required" format:"date-time"`
	// Normalization method applied to the results. Refer to
	// [Normalization methods](https://developers.cloudflare.com/radar/concepts/normalization/).
	Normalization NetflowTopLocationsResponseMetaNormalization `json:"normalization" api:"required"`
	// Measurement units for the results.
	Units []NetflowTopLocationsResponseMetaUnit `json:"units" api:"required"`
...
type NetflowTopLocationsResponseMetaConfidenceInfo struct {
	Annotations []NetflowTopLocationsResponseMetaConfidenceInfoAnnotation `json:"annotations" api:"required"`
	// Provides an indication of how much confidence Cloudflare has in the data.
	Level int64                                             `json:"level" api:"required"`
...
type NetflowTopLocationsResponseMetaConfidenceInfoAnnotation struct {
	// Data source for annotations.
	DataSource  NetflowTopLocationsResponseMetaConfidenceInfoAnnotationsDataSource `json:"dataSource" api:"required"`
	Description string                                                             `json:"description" api:"required"`
	EndDate     time.Time                                                          `json:"endDate" api:"required" format:"date-time"`
	// Event type for annotations.
	EventType NetflowTopLocationsResponseMetaConfidenceInfoAnnotationsEventType `json:"eventType" api:"required"`
	// Whether event is a single point in time or a time range.
	IsInstantaneous bool                                                        `json:"isInstantaneous" api:"required"`
	LinkedURL       string                                                      `json:"linkedUrl" api:"required" format:"uri"`
	StartDate       time.Time                                                   `json:"startDate" api:"required" format:"date-time"`
...
type NetflowTopAsesResponseEnvelope struct {
	Result  NetflowTopAsesResponse             `json:"result" api:"required"`
...
type NetflowTopLocationsResponseEnvelope struct {
	Result  NetflowTopLocationsResponse             `json:"result" api:"required"`
	Success bool                                    `json:"success" api:"required"`
