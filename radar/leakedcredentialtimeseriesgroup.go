...
type LeakedCredentialTimeseriesGroupBotClassResponse struct {
	...
	Meta   LeakedCredentialTimeseriesGroupBotClassResponseMeta   `json:"meta" api:"required"`
	Serie0 LeakedCredentialTimeseriesGroupBotClassResponseSerie0 `json:"serie_0" api:"required"`
...
type LeakedCredentialTimeseriesGroupBotClassResponseMeta struct {
	...
	AggInterval    LeakedCredentialTimeseriesGroupBotClassResponseMetaAggInterval    `json:"aggInterval" api:"required"`
	ConfidenceInfo LeakedCredentialTimeseriesGroupBotClassResponseMetaConfidenceInfo `json:"confidenceInfo" api:"required"`
	DateRange      []LeakedCredentialTimeseriesGroupBotClassResponseMetaDateRange    `json:"dateRange" api:"required"`
	// Timestamp of the last dataset update.
	LastUpdated time.Time `json:"lastUpdated" api:"required" format:"date-time"`
	// Normalization method applied to the results. Refer to
	// [Normalization methods](https://developers.cloudflare.com/radar/concepts/normalization/).
	Normalization LeakedCredentialTimeseriesGroupBotClassResponseMetaNormalization `json:"normalization" api:"required"`
	// Measurement units for the results.
	Units []LeakedCredentialTimeseriesGroupBotClassResponseMetaUnit `json:"units" api:"required"`
...
type LeakedCredentialTimeseriesGroupBotClassResponseMetaConfidenceInfo struct {
	Annotations []LeakedCredentialTimeseriesGroupBotClassResponseMetaConfidenceInfoAnnotation `json:"annotations" api:"required"`
...
type LeakedCredentialTimeseriesGroupBotClassResponseMetaConfidenceInfoAnnotation struct {
	...
	DataSource  LeakedCredentialTimeseriesGroupBotClassResponseMetaConfidenceInfoAnnotationsDataSource `json:"dataSource" api:"required"`
	Description string                                                                                 `json:"description" api:"required"`
	EndDate     time.Time                                                                              `json:"endDate" api:"required" format:"date-time"`
	// Event type for annotations.
	EventType LeakedCredentialTimeseriesGroupBotClassResponseMetaConfidenceInfoAnnotationsEventType `json:"eventType" api:"required"`
...
type LeakedCredentialTimeseriesGroupCompromisedResponse struct {
	// Metadata for the results.
	Meta   LeakedCredentialTimeseriesGroupCompromisedResponseMeta   `json:"meta" api:"required"`
	Serie0 LeakedCredentialTimeseriesGroupCompromisedResponseSerie0 `json:"serie_0" api:"required"`
...
type LeakedCredentialTimeseriesGroupCompromisedResponseMeta struct {
	...
	// Refer to
	// [Aggregation intervals](https://developers.cloudflare.com/radar/concepts/aggregation-intervals/).
	AggInterval    LeakedCredentialTimeseriesGroupCompromisedResponseMetaAggInterval    `json:"aggInterval" api:"required"`
	ConfidenceInfo LeakedCredentialTimeseriesGroupCompromisedResponseMetaConfidenceInfo `json:"confidenceInfo" api:"required"`
	DateRange      []LeakedCredentialTimeseriesGroupCompromisedResponseMetaDateRange    `json:"dateRange" api:"required"`
	// Timestamp of the last dataset update.
	LastUpdated time.Time `json:"lastUpdated" api:"required" format:"date-time"`
	// Normalization method applied to the results. Refer to
	// [Normalization methods](https://developers.cloudflare.com/radar/concepts/normalization/).
	Normalization LeakedCredentialTimeseriesGroupCompromisedResponseMetaNormalization `json:"normalization" api:"required"`
	// Measurement units for the results.
	Units []LeakedCredentialTimeseriesGroupCompromisedResponseMetaUnit `json:"units" api:"required"`
...
type LeakedCredentialTimeseriesGroupCompromisedResponseMetaConfidenceInfo struct {
	Annotations []LeakedCredentialTimeseriesGroupCompromisedResponseMetaConfidenceInfoAnnotation `json:"annotations" api:"required"`
	// Provides an indication of how much confidence Cloudflare has in the data.
	Level int64                                                                    `json:"level" api:"required"`
...
type LeakedCredentialTimeseriesGroupCompromisedResponseMetaConfidenceInfoAnnotation struct {
	// Data source for annotations.
	DataSource  LeakedCredentialTimeseriesGroupCompromisedResponseMetaConfidenceInfoAnnotationsDataSource `json:"dataSource" api:"required"`
	Description string                                                                                    `json:"description" api:"required"`
	EndDate     time.Time                                                                                 `json:"endDate" api:"required" format:"date-time"`
	// Event type for annotations.
	EventType LeakedCredentialTimeseriesGroupCompromisedResponseMetaConfidenceInfoAnnotationsEventType `json:"eventType" api:"required"`
	// Whether event is a single point in time or a time range.
	IsInstantaneous bool                                                                               `json:"isInstantaneous" api:"required"`
	LinkedURL       string                                                                             `json:"linkedUrl" api:"required" format:"uri"`
	StartDate       time.Time                                                                          `json:"startDate" api:"required" format:"date-time"`
...
type LeakedCredentialTimeseriesGroupBotClassResponseEnvelope struct {
	Result  LeakedCredentialTimeseriesGroupBotClassResponse             `json:"result" api:"required"`
...
type LeakedCredentialTimeseriesGroupCompromisedResponseEnvelope struct {
	Result  LeakedCredentialTimeseriesGroupCompromisedResponse             `json:"result" api:"required"`
	Success bool                                                           `json:"success" api:"required"`
