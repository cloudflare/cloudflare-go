...
func TestAITimeseriesGroupSummaryWithOptionalParams(t *testing.T) {
	...
	_, err := client.Radar.AI.TimeseriesGroups.Summary(
		...
		radar.AITimeseriesGroupSummaryParams{
			...
			ResponseStatusCategory: cloudflare.F([]radar.AITimeseriesGroupSummaryParamsResponseStatusCategory{radar.AITimeseriesGroupSummaryParamsResponseStatusCategoryInformational}),
...
func TestAITimeseriesGroupTimeseriesWithOptionalParams(t *testing.T) {
	...
	_, err := client.Radar.AI.TimeseriesGroups.Timeseries(context.TODO(), radar.AITimeseriesGroupTimeseriesParams{
		...
		Name:                   cloudflare.F([]string{"main_series"}),
		ResponseStatus:         cloudflare.F([]string{"string"}),
		ResponseStatusCategory: cloudflare.F([]radar.AITimeseriesGroupTimeseriesParamsResponseStatusCategory{radar.AITimeseriesGroupTimeseriesParamsResponseStatusCategoryInformational}),
		UserAgent:              cloudflare.F([]string{"string"}),
		Vertical:               cloudflare.F([]string{"string"}),
	})
	if err != nil {
...
func TestAITimeseriesGroupTimeseriesGroupsWithOptionalParams(t *testing.T) {
	...
	_, err := client.Radar.AI.TimeseriesGroups.TimeseriesGroups(
		...
		radar.AITimeseriesGroupTimeseriesGroupsParams{
			...
			ResponseStatus:         cloudflare.F([]string{"string"}),
			ResponseStatusCategory: cloudflare.F([]radar.AITimeseriesGroupTimeseriesGroupsParamsResponseStatusCategory{radar.AITimeseriesGroupTimeseriesGroupsParamsResponseStatusCategoryInformational}),
			UserAgent:              cloudflare.F([]string{"string"}),
			Vertical:               cloudflare.F([]string{"string"}),
		},
	)
