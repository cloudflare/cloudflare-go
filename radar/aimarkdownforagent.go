...
func (r AIMarkdownForAgentTimeseriesResponseMetaConfidenceInfoAnnotationsEventType) IsKnown() bool {
	switch r {
	case AIMarkdownForAgentTimeseriesResponseMetaConfidenceInfoAnnotationsEventTypeGeneral, AIMarkdownForAgentTimeseriesResponseMetaConfidenceInfoAnnotationsEventTypeOutage, AIMarkdownForAgentTimeseriesResponseMetaConfidenceInfoAnnotationsEventTypePartialProjection, AIMarkdownForAgentTimeseriesResponseMetaConfidenceInfoAnnotationsEventTypePipeline, AIMarkdownForAgentTimeseriesResponseMetaConfidenceInfoAnnotationsEventTypeTrafficAnomaly:
		return true
	}
	return false
}
