...
func (r VerifiedBotTopCategoriesResponseMetaConfidenceInfoAnnotationsEventType) IsKnown() bool {
	switch r {
	case VerifiedBotTopCategoriesResponseMetaConfidenceInfoAnnotationsEventTypeGeneral, VerifiedBotTopCategoriesResponseMetaConfidenceInfoAnnotationsEventTypeOutage, VerifiedBotTopCategoriesResponseMetaConfidenceInfoAnnotationsEventTypePartialProjection, VerifiedBotTopCategoriesResponseMetaConfidenceInfoAnnotationsEventTypePipeline, VerifiedBotTopCategoriesResponseMetaConfidenceInfoAnnotationsEventTypeTrafficAnomaly:
		return true
	}
	return false
}
