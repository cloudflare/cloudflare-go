...
type SuperSlurperConnectivityPrecheckSourceParamsBodyR2SlurperGcsSourceSchema struct {
	Bucket     param.Field[string]                                                                         `json:"bucket" api:"required"`
	Secret     param.Field[SuperSlurperConnectivityPrecheckSourceParamsBodyR2SlurperGcsSourceSchemaSecret] `json:"secret" api:"required"`
	Vendor     param.Field[SuperSlurperConnectivityPrecheckSourceParamsBodyR2SlurperGcsSourceSchemaVendor] `json:"vendor" api:"required"`
	Keys       param.Field[[]string]                                                                       `json:"keys"`
	PathPrefix param.Field[string]                                                                         `json:"pathPrefix"`
}
...
type SuperSlurperConnectivityPrecheckSourceParamsBodyR2SlurperR2SourceSchema struct {
	Bucket       param.Field[string]                                                                              `json:"bucket" api:"required"`
	Secret       param.Field[SuperSlurperConnectivityPrecheckSourceParamsBodyR2SlurperR2SourceSchemaSecret]       `json:"secret" api:"required"`
...
const (
	...
	SuperSlurperConnectivityPrecheckSourceParamsBodyR2SlurperR2SourceSchemaJurisdictionUs      SuperSlurperConnectivityPrecheckSourceParamsBodyR2SlurperR2SourceSchemaJurisdiction = "us"
...
func (r SuperSlurperConnectivityPrecheckSourceParamsBodyR2SlurperR2SourceSchemaJurisdiction) IsKnown() bool {
	switch r {
	case SuperSlurperConnectivityPrecheckSourceParamsBodyR2SlurperR2SourceSchemaJurisdictionDefault, SuperSlurperConnectivityPrecheckSourceParamsBodyR2SlurperR2SourceSchemaJurisdictionEu, SuperSlurperConnectivityPrecheckSourceParamsBodyR2SlurperR2SourceSchemaJurisdictionUs, SuperSlurperConnectivityPrecheckSourceParamsBodyR2SlurperR2SourceSchemaJurisdictionFedramp:
		return true
	}
	return false
}
...
const (
	...
	SuperSlurperConnectivityPrecheckSourceParamsBodyJurisdictionUs      SuperSlurperConnectivityPrecheckSourceParamsBodyJurisdiction = "us"
...
func (r SuperSlurperConnectivityPrecheckSourceParamsBodyJurisdiction) IsKnown() bool {
	switch r {
	case SuperSlurperConnectivityPrecheckSourceParamsBodyJurisdictionDefault, SuperSlurperConnectivityPrecheckSourceParamsBodyJurisdictionEu, SuperSlurperConnectivityPrecheckSourceParamsBodyJurisdictionUs, SuperSlurperConnectivityPrecheckSourceParamsBodyJurisdictionFedramp:
		return true
	}
	return false
}
...
const (
	...
	SuperSlurperConnectivityPrecheckTargetParamsJurisdictionUs      SuperSlurperConnectivityPrecheckTargetParamsJurisdiction = "us"
...
func (r SuperSlurperConnectivityPrecheckTargetParamsJurisdiction) IsKnown() bool {
	switch r {
	case SuperSlurperConnectivityPrecheckTargetParamsJurisdictionDefault, SuperSlurperConnectivityPrecheckTargetParamsJurisdictionEu, SuperSlurperConnectivityPrecheckTargetParamsJurisdictionUs, SuperSlurperConnectivityPrecheckTargetParamsJurisdictionFedramp:
		return true
	}
	return false
}
