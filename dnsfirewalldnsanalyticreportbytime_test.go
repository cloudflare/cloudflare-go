...
func TestDNSFirewallDNSAnalyticReportBytimeListWithOptionalParams(t *testing.T) {
	...
	_, err := client.DNSFirewall.DNSAnalytics.Reports.Bytimes.List(
		...
		"023e105f4ecef8ad9ca31a8372d0c353",
		cloudflare.DNSFirewallDNSAnalyticReportBytimeListParams{
			...
			TimeDelta:  cloudflare.F(cloudflare.DNSFirewallDNSAnalyticReportBytimeListParamsTimeDeltaHour),
