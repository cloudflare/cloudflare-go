...
func TestAppNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Spectrum.Apps.New(
		...
		spectrum.AppNewParams{
			...
			OriginPort:       cloudflare.F[spectrum.AppNewParamsOriginPortUnion](shared.UnionInt(int64(22))),
			Protocol:         cloudflare.F("tcp/22"),
			ArgoSmartRouting: cloudflare.F(true),
			EdgeIPs: cloudflare.F[spectrum.AppNewParamsEdgeIPsUnion](spectrum.AppNewParamsEdgeIPsObject{
				Connectivity: cloudflare.F(spectrum.AppNewParamsEdgeIPsObjectConnectivityAll),
				Type:         cloudflare.F(spectrum.AppNewParamsEdgeIPsObjectTypeDynamic),
			}),
...
func TestAppUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := client.Spectrum.Apps.Update(
		...
		spectrum.AppUpdateParams{
			...
			OriginPort:       cloudflare.F[spectrum.AppUpdateParamsOriginPortUnion](shared.UnionInt(int64(22))),
			Protocol:         cloudflare.F("tcp/22"),
			ArgoSmartRouting: cloudflare.F(true),
			EdgeIPs: cloudflare.F[spectrum.AppUpdateParamsEdgeIPsUnion](spectrum.AppUpdateParamsEdgeIPsObject{
				Connectivity: cloudflare.F(spectrum.AppUpdateParamsEdgeIPsObjectConnectivityAll),
				Type:         cloudflare.F(spectrum.AppUpdateParamsEdgeIPsObjectTypeDynamic),
			}),
			IPFirewall:    cloudflare.F(true),
