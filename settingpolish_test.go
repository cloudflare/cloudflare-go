...
func TestSettingPolishEditWithOptionalParams(t *testing.T) {
	...
	_, err := client.Settings.Polish.Edit(context.TODO(), cloudflare.SettingPolishEditParams{
...
func TestSettingPolishGet(t *testing.T) {
	...
	_, err := client.Settings.Polish.Get(context.TODO(), cloudflare.SettingPolishGetParams{
		ZoneID: cloudflare.F("023e105f4ecef8ad9ca31a8372d0c353"),
	})
	if err != nil {
		var apierr *cloudflare.Error
