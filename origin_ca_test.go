...
func TestOriginCA_CreateOriginCertificate(t *testing.T) {
  ...
  "result": {
	...
	createdCertificate, err := client.CreateOriginCertificate(context.TODO(), testCertificate)
...
func TestOriginCA_OriginCertificates(t *testing.T) {
  ...
  "result_info": {
	...
	certs, err := client.OriginCertificates(context.TODO(), OriginCACertificateListOptions{ZoneID: testZoneID})
...
func TestOriginCA_OriginCertificate(t *testing.T) {
  ...
  "result": {
	...
	cert, err := client.OriginCertificate(context.TODO(), testCertificate.ID)
...
func TestOriginCA_RevokeCertificate(t *testing.T) {
  ...
  "result": {
	...
	cert, err := client.RevokeOriginCertificate(context.TODO(), testCertificate.ID)
