...
func TestRadarEmailSecurityThreatCategoryListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Radar.Emails.Security.ThreatCategory.List(context.TODO(), cloudflare.RadarEmailSecurityThreatCategoryListParams{
		AggInterval: cloudflare.F(cloudflare.RadarEmailSecurityThreatCategoryListParamsAggInterval1h),
		Arc:         cloudflare.F([]cloudflare.RadarEmailSecurityThreatCategoryListParamsArc{cloudflare.RadarEmailSecurityThreatCategoryListParamsArcPass, cloudflare.RadarEmailSecurityThreatCategoryListParamsArcNone, cloudflare.RadarEmailSecurityThreatCategoryListParamsArcFail}),
