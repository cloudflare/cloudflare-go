...
func TestZoneSettingProxyReadTimeoutUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := client.Zones.Settings.ProxyReadTimeouts.Update(
		...
		cloudflare.ZoneSettingProxyReadTimeoutUpdateParams{
			Value: cloudflare.F(cloudflare.ZoneSettingProxyReadTimeoutUpdateParamsValue{
				ID:    cloudflare.F(cloudflare.ZoneSettingProxyReadTimeoutUpdateParamsValueIDProxyReadTimeout),
