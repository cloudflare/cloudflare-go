...
func TestReprioritizeSSL(t *testing.T) {
	...
	handler := func(w http.ResponseWriter, r *http.Request) {
		...
		defer r.Body.Close()
		if assert.NoError(t, err) {
			assert.Equal(t, `{"certificates":[{"ID":"5a7805061c76ada191ed06f989cc3dac","priority":2},{"ID":"9a7806061c88ada191ed06f989cc3dac","priority":1}]}`, string(b))
		}
