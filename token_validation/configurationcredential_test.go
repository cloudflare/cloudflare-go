...
func TestConfigurationCredentialEdit(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.TokenValidation.Configuration.Credentials.Edit(
		context.TODO(),
		"4a7ee8d3-dd63-4ceb-9d5f-c27831854ce7",
		token_validation.ConfigurationCredentialEditParams{
			ZoneID: cloudflare.F("023e105f4ecef8ad9ca31a8372d0c353"),
			Keys: cloudflare.F([]token_validation.ConfigurationCredentialEditParamsKeyUnion{token_validation.ConfigurationCredentialEditParamsKeysAPIShieldCredentialsJWTKeyRSA{
				Alg: cloudflare.F(token_validation.ConfigurationCredentialEditParamsKeysAPIShieldCredentialsJWTKeyRSAAlgRs256),
				E:   cloudflare.F("e"),
				Kid: cloudflare.F("kid"),
				Kty: cloudflare.F(token_validation.ConfigurationCredentialEditParamsKeysAPIShieldCredentialsJWTKeyRSAKtyRSA),
				N:   cloudflare.F("n"),
			}}),
		},
	)
