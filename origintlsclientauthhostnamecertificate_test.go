...
func TestOriginTLSClientAuthHostnameCertificateNew(t *testing.T) {
	...
	_, err := client.OriginTLSClientAuth.Hostnames.Certificates.New(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		cloudflare.OriginTLSClientAuthHostnameCertificateNewParams{
...
func TestOriginTLSClientAuthHostnameCertificateList(t *testing.T) {
	...
	_, err := client.OriginTLSClientAuth.Hostnames.Certificates.List(context.TODO(), "023e105f4ecef8ad9ca31a8372d0c353")
	if err != nil {
		var apierr *cloudflare.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
