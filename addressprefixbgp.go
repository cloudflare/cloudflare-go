...
// AddressPrefixBGPService contains methods and other services that help with
// interacting with the cloudflare API. Note, unlike clients, this service does not
// read variables from the environment automatically. You should not instantiate
// this service directly, and instead use the [NewAddressPrefixBGPService] method
// instead.
...
// NewAddressPrefixBGPService generates a new service that applies the given
