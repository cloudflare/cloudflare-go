...
func TestCustomCsrNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.CustomCsrs.New(context.TODO(), custom_csrs.CustomCsrNewParams{
		...
		Description:        cloudflare.F("CSR for example.com wildcard"),
		KeyType:            cloudflare.F(custom_csrs.CustomCsrNewParamsKeyTypeRsa2048),
		Name:               cloudflare.F("My Custom CSR"),
		OrganizationalUnit: cloudflare.F("Engineering"),
	})
	if err != nil {
...
func TestCustomCsrListWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
...
func TestCustomCsrDeleteWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.CustomCsrs.Delete(
		context.TODO(),
...
func TestCustomCsrGetWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
