...
func (r *EventService) New(ctx context.Context, zoneIdentifier string, waitingRoomID interface{}, body EventNewParams, opts ...option.RequestOption) (res *EventNewResponse, err error) {
...
func (r *EventService) Update(ctx context.Context, zoneIdentifier string, waitingRoomID interface{}, eventID interface{}, body EventUpdateParams, opts ...option.RequestOption) (res *EventUpdateResponse, err error) {
	opts = append(r.Options[:], opts...)
...
func (r *EventService) List(ctx context.Context, zoneIdentifier string, waitingRoomID interface{}, opts ...option.RequestOption) (res *[]EventListResponse, err error) {
	opts = append(r.Options[:], opts...)
...
func (r *EventService) Edit(ctx context.Context, zoneIdentifier string, waitingRoomID interface{}, eventID interface{}, body EventEditParams, opts ...option.RequestOption) (res *EventEditResponse, err error) {
	opts = append(r.Options[:], opts...)
...
func (r *EventService) Get(ctx context.Context, zoneIdentifier string, waitingRoomID interface{}, eventID interface{}, opts ...option.RequestOption) (res *EventGetResponse, err error) {
	opts = append(r.Options[:], opts...)
...
type EventListResponseEnvelope struct {
	...
	Result   []EventListResponse                 `json:"result,required,nullable"`
