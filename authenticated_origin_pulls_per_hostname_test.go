...
func TestUploadPerHostnameAuthenticatedOriginPullsCertificate(t *testing.T) {
	...
	actual, err := client.UploadPerHostnameAuthenticatedOriginPullsCertificate(context.TODO(), "023e105f4ecef8ad9ca31a8372d0c353", clientCert)
...
func TestGetPerHostnameAuthenticatedOriginPullsCertificate(t *testing.T) {
	...
	actual, err := client.GetPerHostnameAuthenticatedOriginPullsCertificate(context.TODO(), "023e105f4ecef8ad9ca31a8372d0c353", "2458ce5a-0c35-4c7f-82c7-8e9487d3ff60")
	if assert.NoError(t, err) {
		assert.Equal(t, want, actual)
	}
}
func TestDeletePerHostnameAuthenticatedOriginPullsCertificate(t *testing.T) {
	...
	actual, err := client.DeletePerHostnameAuthenticatedOriginPullsCertificate(context.TODO(), "023e105f4ecef8ad9ca31a8372d0c353", "2458ce5a-0c35-4c7f-82c7-8e9487d3ff60")
	if assert.NoError(t, err) {
		assert.Equal(t, want, actual)
	}
}
...
func TestEditPerHostnameAuthenticatedOriginPullsConfig(t *testing.T) {
	...
	actual, err := client.EditPerHostnameAuthenticatedOriginPullsConfig(context.TODO(), "023e105f4ecef8ad9ca31a8372d0c353", config)
	if assert.NoError(t, err) {
		assert.Equal(t, want, actual)
	}
}
...
func TestGetPerHostnameAuthenticatedOriginPullsConfig(t *testing.T) {
	...
	actual, err := client.GetPerHostnameAuthenticatedOriginPullsConfig(context.TODO(), "023e105f4ecef8ad9ca31a8372d0c353", "app.example.com")
	if assert.NoError(t, err) {
		assert.Equal(t, want, actual)
	}
}
