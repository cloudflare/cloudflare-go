...
type RadarEmailSecurityTimeseriesGroupService struct {
	...
	Arcs    *RadarEmailSecurityTimeseriesGroupArcService
	DKIMs   *RadarEmailSecurityTimeseriesGroupDKIMService
}
...
func NewRadarEmailSecurityTimeseriesGroupService(opts ...option.RequestOption) (r *RadarEmailSecurityTimeseriesGroupService) {
	...
	r.Options = opts
	r.Arcs = NewRadarEmailSecurityTimeseriesGroupArcService(opts...)
	r.DKIMs = NewRadarEmailSecurityTimeseriesGroupDKIMService(opts...)
	return
}
