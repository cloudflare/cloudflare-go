...
func TestDNSRecordNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.DNSRecords.New(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		cloudflare.DNSRecordNewParamsDNSRecordsARecord{
			Content: cloudflare.F("198.51.100.4"),
			Name:    cloudflare.F("example.com"),
			Type:    cloudflare.F(cloudflare.DNSRecordNewParamsDNSRecordsARecordTypeA),
			...
			TTL:     cloudflare.F[cloudflare.DNSRecordNewParamsDNSRecordsARecordTTL](shared.UnionFloat(3600.000000)),
		},
	)
	if err != nil {
...
func TestDNSRecordListWithOptionalParams(t *testing.T) {
	...
	_, err := client.DNSRecords.List(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		cloudflare.DNSRecordListParams{
...
func TestDNSRecordExport(t *testing.T) {
	...
	_, err := client.DNSRecords.Export(context.TODO(), "023e105f4ecef8ad9ca31a8372d0c353")
	if err != nil {
		var apierr *cloudflare.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestDNSRecordImportWithOptionalParams(t *testing.T) {
	...
	_, err := client.DNSRecords.Import(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		cloudflare.DNSRecordImportParams{
...
func TestDNSRecordReplaceWithOptionalParams(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.DNSRecords.Replace(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		"023e105f4ecef8ad9ca31a8372d0c353",
		cloudflare.DNSRecordReplaceParamsDNSRecordsARecord{
			Content: cloudflare.F("198.51.100.4"),
			Name:    cloudflare.F("example.com"),
			Type:    cloudflare.F(cloudflare.DNSRecordReplaceParamsDNSRecordsARecordTypeA),
			Comment: cloudflare.F("Domain verification record"),
			Proxied: cloudflare.F(false),
			Tags:    cloudflare.F([]string{"owner:dns-team", "owner:dns-team", "owner:dns-team"}),
			TTL:     cloudflare.F[cloudflare.DNSRecordReplaceParamsDNSRecordsARecordTTL](shared.UnionFloat(3600.000000)),
		},
	)
	if err != nil {
		var apierr *cloudflare.Error
...
func TestDNSRecordScan(t *testing.T) {
	...
	_, err := client.DNSRecords.Scan(context.TODO(), "023e105f4ecef8ad9ca31a8372d0c353")
	if err != nil {
		var apierr *cloudflare.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
