...
func ExampleAPI_DNSRecords_all() {
	...
	recs, err := api.DNSRecords(context.TODO(), zoneID, cloudflare.DNSRecord{})
	if err != nil {
		log.Fatal(err)
	}
...
func ExampleAPI_DNSRecords_filterByContent() {
	...
	recs, err := api.DNSRecords(context.TODO(), zoneID, localhost)
	if err != nil {
		log.Fatal(err)
	}
...
func ExampleAPI_DNSRecords_filterByName() {
	...
	recs, err := api.DNSRecords(context.TODO(), zoneID, foo)
	if err != nil {
		log.Fatal(err)
	}
...
func ExampleAPI_DNSRecords_filterByType() {
	...
	recs, err := api.DNSRecords(context.TODO(), zoneID, aaaa)
	if err != nil {
		log.Fatal(err)
	}
