...
type ProjectNewResponse struct {
	...
	CanonicalDeployment ProjectNewResponseCanonicalDeployment `json:"canonical_deployment" api:"required,nullable"`
	// When the project was created.
	CreatedOn time.Time `json:"created_on" api:"required" format:"date-time"`
	// Configs for deployments in a project.
	DeploymentConfigs ProjectNewResponseDeploymentConfigs `json:"deployment_configs" api:"required"`
	...
	LatestDeployment ProjectNewResponseLatestDeployment `json:"latest_deployment" api:"required,nullable"`
	// Name of the project.
...
type ProjectNewResponseCanonicalDeployment struct {
	...
	// Configs for the project build process.
	BuildConfig ProjectNewResponseCanonicalDeploymentBuildConfig `json:"build_config" api:"required"`
	// When the deployment was created.
	CreatedOn time.Time `json:"created_on" api:"required" format:"date-time"`
	// Info about what caused the deployment.
	DeploymentTrigger ProjectNewResponseCanonicalDeploymentDeploymentTrigger `json:"deployment_trigger" api:"required"`
	// Environment variables used for builds and Pages Functions.
	EnvVars map[string]ProjectNewResponseCanonicalDeploymentEnvVar `json:"env_vars" api:"required,nullable"`
	// Type of deploy.
	Environment ProjectNewResponseCanonicalDeploymentEnvironment `json:"environment" api:"required"`
	...
	// Configs for the project source control.
	Source ProjectNewResponseCanonicalDeploymentSource `json:"source" api:"required"`
	// List of past stages.
...
type ProjectNewResponseCanonicalDeploymentDeploymentTrigger struct {
	...
	Metadata ProjectNewResponseCanonicalDeploymentDeploymentTriggerMetadata `json:"metadata" api:"required"`
	// What caused the deployment.
	Type ProjectNewResponseCanonicalDeploymentDeploymentTriggerType `json:"type" api:"required"`
...
type ProjectNewResponseCanonicalDeploymentEnvVar struct {
	Type ProjectNewResponseCanonicalDeploymentEnvVarsType `json:"type" api:"required"`
...
type ProjectNewResponseCanonicalDeploymentEnvVarsPagesPlainTextEnvVar struct {
	Type ProjectNewResponseCanonicalDeploymentEnvVarsPagesPlainTextEnvVarType `json:"type" api:"required"`
	// Environment variable value.
	Value string                                                               `json:"value" api:"required"`
...
type ProjectNewResponseCanonicalDeploymentEnvVarsPagesSecretTextEnvVar struct {
	Type ProjectNewResponseCanonicalDeploymentEnvVarsPagesSecretTextEnvVarType `json:"type" api:"required"`
	// Secret value.
	Value string                                                                `json:"value" api:"required"`
...
type ProjectNewResponseCanonicalDeploymentSource struct {
	Config ProjectNewResponseCanonicalDeploymentSourceConfig `json:"config" api:"required"`
	// The source control management provider.
	Type ProjectNewResponseCanonicalDeploymentSourceType `json:"type" api:"required"`
...
type ProjectNewResponseCanonicalDeploymentSourceConfig struct {
	...
	PreviewDeploymentSetting ProjectNewResponseCanonicalDeploymentSourceConfigPreviewDeploymentSetting `json:"preview_deployment_setting" api:"required"`
...
type ProjectNewResponseDeploymentConfigs struct {
	...
	Preview ProjectNewResponseDeploymentConfigsPreview `json:"preview" api:"required"`
	// Configs for production deploys.
	Production ProjectNewResponseDeploymentConfigsProduction `json:"production" api:"required"`
...
type ProjectNewResponseDeploymentConfigsPreview struct {
	...
	// Environment variables used for builds and Pages Functions.
	EnvVars map[string]ProjectNewResponseDeploymentConfigsPreviewEnvVar `json:"env_vars" api:"required,nullable"`
	...
	UsageModel ProjectNewResponseDeploymentConfigsPreviewUsageModel `json:"usage_model" api:"required"`
...
type ProjectNewResponseDeploymentConfigsPreviewEnvVar struct {
	Type ProjectNewResponseDeploymentConfigsPreviewEnvVarsType `json:"type" api:"required"`
	// Environment variable value.
	Value string                                               `json:"value" api:"required"`
...
type ProjectNewResponseDeploymentConfigsPreviewEnvVarsPagesPlainTextEnvVar struct {
	Type ProjectNewResponseDeploymentConfigsPreviewEnvVarsPagesPlainTextEnvVarType `json:"type" api:"required"`
	// Environment variable value.
	Value string                                                                    `json:"value" api:"required"`
...
type ProjectNewResponseDeploymentConfigsPreviewEnvVarsPagesSecretTextEnvVar struct {
	Type ProjectNewResponseDeploymentConfigsPreviewEnvVarsPagesSecretTextEnvVarType `json:"type" api:"required"`
	// Secret value.
	Value string                                                                     `json:"value" api:"required"`
...
type ProjectNewResponseDeploymentConfigsProduction struct {
	...
	CompatibilityFlags []string `json:"compatibility_flags" api:"required"`
	// Environment variables used for builds and Pages Functions.
	EnvVars map[string]ProjectNewResponseDeploymentConfigsProductionEnvVar `json:"env_vars" api:"required,nullable"`
	// Whether to fail open when the deployment config cannot be applied.
	FailOpen bool `json:"fail_open" api:"required"`
	// The usage model for Pages Functions.
	//
	// Deprecated: All new projects now use the Standard usage model.
	UsageModel ProjectNewResponseDeploymentConfigsProductionUsageModel `json:"usage_model" api:"required"`
	// Constellation bindings used for Pages Functions.
...
type ProjectNewResponseDeploymentConfigsProductionEnvVar struct {
	Type ProjectNewResponseDeploymentConfigsProductionEnvVarsType `json:"type" api:"required"`
	// Environment variable value.
	Value string                                                  `json:"value" api:"required"`
...
type ProjectNewResponseDeploymentConfigsProductionEnvVarsPagesPlainTextEnvVar struct {
	Type ProjectNewResponseDeploymentConfigsProductionEnvVarsPagesPlainTextEnvVarType `json:"type" api:"required"`
	// Environment variable value.
	Value string                                                                       `json:"value" api:"required"`
...
type ProjectNewResponseDeploymentConfigsProductionEnvVarsPagesSecretTextEnvVar struct {
	Type ProjectNewResponseDeploymentConfigsProductionEnvVarsPagesSecretTextEnvVarType `json:"type" api:"required"`
	// Secret value.
	Value string                                                                        `json:"value" api:"required"`
...
type ProjectNewResponseLatestDeployment struct {
	...
	Aliases []string `json:"aliases" api:"required,nullable"`
	// Configs for the project build process.
	BuildConfig ProjectNewResponseLatestDeploymentBuildConfig `json:"build_config" api:"required"`
	// When the deployment was created.
	CreatedOn time.Time `json:"created_on" api:"required" format:"date-time"`
	// Info about what caused the deployment.
	DeploymentTrigger ProjectNewResponseLatestDeploymentDeploymentTrigger `json:"deployment_trigger" api:"required"`
	// Environment variables used for builds and Pages Functions.
	EnvVars map[string]ProjectNewResponseLatestDeploymentEnvVar `json:"env_vars" api:"required,nullable"`
	// Type of deploy.
	Environment ProjectNewResponseLatestDeploymentEnvironment `json:"environment" api:"required"`
	// If the deployment has been skipped.
	IsSkipped bool `json:"is_skipped" api:"required"`
	// The status of the deployment.
	LatestStage Stage `json:"latest_stage" api:"required"`
	...
	ShortID string `json:"short_id" api:"required"`
	// Configs for the project source control.
	Source ProjectNewResponseLatestDeploymentSource `json:"source" api:"required"`
	// List of past stages.
	Stages []Stage `json:"stages" api:"required"`
	// The live URL to view this deployment.
	URL string `json:"url" api:"required"`
...
type ProjectNewResponseLatestDeploymentDeploymentTrigger struct {
	// Additional info about the trigger.
	Metadata ProjectNewResponseLatestDeploymentDeploymentTriggerMetadata `json:"metadata" api:"required"`
	// What caused the deployment.
	Type ProjectNewResponseLatestDeploymentDeploymentTriggerType `json:"type" api:"required"`
...
type ProjectNewResponseLatestDeploymentEnvVar struct {
	Type ProjectNewResponseLatestDeploymentEnvVarsType `json:"type" api:"required"`
	// Environment variable value.
	Value string                                       `json:"value" api:"required"`
...
type ProjectNewResponseLatestDeploymentEnvVarsPagesPlainTextEnvVar struct {
	Type ProjectNewResponseLatestDeploymentEnvVarsPagesPlainTextEnvVarType `json:"type" api:"required"`
	// Environment variable value.
	Value string                                                            `json:"value" api:"required"`
...
type ProjectNewResponseLatestDeploymentEnvVarsPagesSecretTextEnvVar struct {
	Type ProjectNewResponseLatestDeploymentEnvVarsPagesSecretTextEnvVarType `json:"type" api:"required"`
	// Secret value.
	Value string                                                             `json:"value" api:"required"`
...
type ProjectNewResponseLatestDeploymentSource struct {
	Config ProjectNewResponseLatestDeploymentSourceConfig `json:"config" api:"required"`
	// The source control management provider.
	Type ProjectNewResponseLatestDeploymentSourceType `json:"type" api:"required"`
...
type ProjectNewResponseLatestDeploymentSourceConfig struct {
	...
	PreviewBranchIncludes []string `json:"preview_branch_includes" api:"required"`
	// Controls whether commits to preview branches trigger a preview deployment.
	PreviewDeploymentSetting ProjectNewResponseLatestDeploymentSourceConfigPreviewDeploymentSetting `json:"preview_deployment_setting" api:"required"`
	// The production branch of the repository.
	ProductionBranch string `json:"production_branch" api:"required"`
	// Whether to trigger a production deployment on commits to the production branch.
	ProductionDeploymentsEnabled bool `json:"production_deployments_enabled" api:"required"`
...
type ProjectNewResponseSource struct {
	Config ProjectNewResponseSourceConfig `json:"config" api:"required"`
	// The source control management provider.
	Type ProjectNewResponseSourceType `json:"type" api:"required"`
...
type ProjectNewResponseSourceConfig struct {
	...
	PreviewBranchIncludes []string `json:"preview_branch_includes" api:"required"`
	// Controls whether commits to preview branches trigger a preview deployment.
	PreviewDeploymentSetting ProjectNewResponseSourceConfigPreviewDeploymentSetting `json:"preview_deployment_setting" api:"required"`
	// The production branch of the repository.
	ProductionBranch string `json:"production_branch" api:"required"`
	// Whether to trigger a production deployment on commits to the production branch.
	ProductionDeploymentsEnabled bool `json:"production_deployments_enabled" api:"required"`
...
type ProjectListResponse struct {
	...
	ID string `json:"id" api:"required"`
	// Most recent production deployment of the project.
	CanonicalDeployment ProjectListResponseCanonicalDeployment `json:"canonical_deployment" api:"required,nullable"`
	// When the project was created.
	CreatedOn time.Time `json:"created_on" api:"required" format:"date-time"`
	// Configs for deployments in a project.
	DeploymentConfigs ProjectListResponseDeploymentConfigs `json:"deployment_configs" api:"required"`
	// Framework the project is using.
	Framework string `json:"framework" api:"required"`
	// Version of the framework the project is using.
	FrameworkVersion string `json:"framework_version" api:"required"`
	// Most recent deployment of the project.
	LatestDeployment ProjectListResponseLatestDeployment `json:"latest_deployment" api:"required,nullable"`
	// Name of the project.
	Name string `json:"name" api:"required"`
	// Name of the preview script.
	PreviewScriptName string `json:"preview_script_name" api:"required"`
...
type ProjectListResponseCanonicalDeployment struct {
	...
	Aliases []string `json:"aliases" api:"required,nullable"`
	// Configs for the project build process.
	BuildConfig ProjectListResponseCanonicalDeploymentBuildConfig `json:"build_config" api:"required"`
	// When the deployment was created.
	CreatedOn time.Time `json:"created_on" api:"required" format:"date-time"`
	// Info about what caused the deployment.
	DeploymentTrigger ProjectListResponseCanonicalDeploymentDeploymentTrigger `json:"deployment_trigger" api:"required"`
	// Environment variables used for builds and Pages Functions.
	EnvVars map[string]ProjectListResponseCanonicalDeploymentEnvVar `json:"env_vars" api:"required,nullable"`
	// Type of deploy.
	Environment ProjectListResponseCanonicalDeploymentEnvironment `json:"environment" api:"required"`
	// If the deployment has been skipped.
	IsSkipped bool `json:"is_skipped" api:"required"`
	// The status of the deployment.
	LatestStage Stage `json:"latest_stage" api:"required"`
	...
	ShortID string `json:"short_id" api:"required"`
	// Configs for the project source control.
	Source ProjectListResponseCanonicalDeploymentSource `json:"source" api:"required"`
	// List of past stages.
	Stages []Stage `json:"stages" api:"required"`
	// The live URL to view this deployment.
	URL string `json:"url" api:"required"`
...
type ProjectListResponseCanonicalDeploymentDeploymentTrigger struct {
	// Additional info about the trigger.
	Metadata ProjectListResponseCanonicalDeploymentDeploymentTriggerMetadata `json:"metadata" api:"required"`
	// What caused the deployment.
	Type ProjectListResponseCanonicalDeploymentDeploymentTriggerType `json:"type" api:"required"`
...
type ProjectListResponseCanonicalDeploymentEnvVar struct {
	Type ProjectListResponseCanonicalDeploymentEnvVarsType `json:"type" api:"required"`
	// Environment variable value.
	Value string                                           `json:"value" api:"required"`
...
type ProjectListResponseCanonicalDeploymentEnvVarsPagesPlainTextEnvVar struct {
	Type ProjectListResponseCanonicalDeploymentEnvVarsPagesPlainTextEnvVarType `json:"type" api:"required"`
	// Environment variable value.
	Value string                                                                `json:"value" api:"required"`
...
type ProjectListResponseCanonicalDeploymentEnvVarsPagesSecretTextEnvVar struct {
	Type ProjectListResponseCanonicalDeploymentEnvVarsPagesSecretTextEnvVarType `json:"type" api:"required"`
	// Secret value.
	Value string                                                                 `json:"value" api:"required"`
...
type ProjectListResponseCanonicalDeploymentSource struct {
	Config ProjectListResponseCanonicalDeploymentSourceConfig `json:"config" api:"required"`
	// The source control management provider.
	Type ProjectListResponseCanonicalDeploymentSourceType `json:"type" api:"required"`
...
type ProjectListResponseCanonicalDeploymentSourceConfig struct {
	...
	PreviewBranchIncludes []string `json:"preview_branch_includes" api:"required"`
	// Controls whether commits to preview branches trigger a preview deployment.
	PreviewDeploymentSetting ProjectListResponseCanonicalDeploymentSourceConfigPreviewDeploymentSetting `json:"preview_deployment_setting" api:"required"`
	// The production branch of the repository.
	ProductionBranch string `json:"production_branch" api:"required"`
	// Whether to trigger a production deployment on commits to the production branch.
	ProductionDeploymentsEnabled bool `json:"production_deployments_enabled" api:"required"`
...
type ProjectListResponseDeploymentConfigs struct {
	// Configs for preview deploys.
	Preview ProjectListResponseDeploymentConfigsPreview `json:"preview" api:"required"`
	// Configs for production deploys.
	Production ProjectListResponseDeploymentConfigsProduction `json:"production" api:"required"`
...
type ProjectListResponseDeploymentConfigsPreview struct {
	...
	CompatibilityFlags []string `json:"compatibility_flags" api:"required"`
	// Environment variables used for builds and Pages Functions.
	EnvVars map[string]ProjectListResponseDeploymentConfigsPreviewEnvVar `json:"env_vars" api:"required,nullable"`
	// Whether to fail open when the deployment config cannot be applied.
	FailOpen bool `json:"fail_open" api:"required"`
	// The usage model for Pages Functions.
	//
	// Deprecated: All new projects now use the Standard usage model.
	UsageModel ProjectListResponseDeploymentConfigsPreviewUsageModel `json:"usage_model" api:"required"`
	// Constellation bindings used for Pages Functions.
...
type ProjectListResponseDeploymentConfigsPreviewEnvVar struct {
	Type ProjectListResponseDeploymentConfigsPreviewEnvVarsType `json:"type" api:"required"`
	// Environment variable value.
	Value string                                                `json:"value" api:"required"`
...
type ProjectListResponseDeploymentConfigsPreviewEnvVarsPagesPlainTextEnvVar struct {
	Type ProjectListResponseDeploymentConfigsPreviewEnvVarsPagesPlainTextEnvVarType `json:"type" api:"required"`
	// Environment variable value.
	Value string                                                                     `json:"value" api:"required"`
...
type ProjectListResponseDeploymentConfigsPreviewEnvVarsPagesSecretTextEnvVar struct {
	Type ProjectListResponseDeploymentConfigsPreviewEnvVarsPagesSecretTextEnvVarType `json:"type" api:"required"`
	// Secret value.
	Value string                                                                      `json:"value" api:"required"`
...
type ProjectListResponseDeploymentConfigsProduction struct {
	...
	CompatibilityFlags []string `json:"compatibility_flags" api:"required"`
	// Environment variables used for builds and Pages Functions.
	EnvVars map[string]ProjectListResponseDeploymentConfigsProductionEnvVar `json:"env_vars" api:"required,nullable"`
	// Whether to fail open when the deployment config cannot be applied.
	FailOpen bool `json:"fail_open" api:"required"`
	// The usage model for Pages Functions.
	//
	// Deprecated: All new projects now use the Standard usage model.
	UsageModel ProjectListResponseDeploymentConfigsProductionUsageModel `json:"usage_model" api:"required"`
	// Constellation bindings used for Pages Functions.
...
type ProjectListResponseDeploymentConfigsProductionEnvVar struct {
	Type ProjectListResponseDeploymentConfigsProductionEnvVarsType `json:"type" api:"required"`
	// Environment variable value.
	Value string                                                   `json:"value" api:"required"`
...
type ProjectListResponseDeploymentConfigsProductionEnvVarsPagesPlainTextEnvVar struct {
	Type ProjectListResponseDeploymentConfigsProductionEnvVarsPagesPlainTextEnvVarType `json:"type" api:"required"`
	// Environment variable value.
	Value string                                                                        `json:"value" api:"required"`
...
type ProjectListResponseDeploymentConfigsProductionEnvVarsPagesSecretTextEnvVar struct {
	Type ProjectListResponseDeploymentConfigsProductionEnvVarsPagesSecretTextEnvVarType `json:"type" api:"required"`
	// Secret value.
	Value string                                                                         `json:"value" api:"required"`
...
type ProjectListResponseLatestDeployment struct {
	...
	Aliases []string `json:"aliases" api:"required,nullable"`
	// Configs for the project build process.
	BuildConfig ProjectListResponseLatestDeploymentBuildConfig `json:"build_config" api:"required"`
	// When the deployment was created.
	CreatedOn time.Time `json:"created_on" api:"required" format:"date-time"`
	// Info about what caused the deployment.
	DeploymentTrigger ProjectListResponseLatestDeploymentDeploymentTrigger `json:"deployment_trigger" api:"required"`
	// Environment variables used for builds and Pages Functions.
	EnvVars map[string]ProjectListResponseLatestDeploymentEnvVar `json:"env_vars" api:"required,nullable"`
	// Type of deploy.
	Environment ProjectListResponseLatestDeploymentEnvironment `json:"environment" api:"required"`
	// If the deployment has been skipped.
	IsSkipped bool `json:"is_skipped" api:"required"`
	// The status of the deployment.
	LatestStage Stage `json:"latest_stage" api:"required"`
	...
	ShortID string `json:"short_id" api:"required"`
	// Configs for the project source control.
	Source ProjectListResponseLatestDeploymentSource `json:"source" api:"required"`
	// List of past stages.
	Stages []Stage `json:"stages" api:"required"`
	// The live URL to view this deployment.
	URL string `json:"url" api:"required"`
...
type ProjectListResponseLatestDeploymentDeploymentTrigger struct {
	// Additional info about the trigger.
	Metadata ProjectListResponseLatestDeploymentDeploymentTriggerMetadata `json:"metadata" api:"required"`
	// What caused the deployment.
	Type ProjectListResponseLatestDeploymentDeploymentTriggerType `json:"type" api:"required"`
...
type ProjectListResponseLatestDeploymentEnvVar struct {
	Type ProjectListResponseLatestDeploymentEnvVarsType `json:"type" api:"required"`
	// Environment variable value.
	Value string                                        `json:"value" api:"required"`
...
type ProjectListResponseLatestDeploymentEnvVarsPagesPlainTextEnvVar struct {
	Type ProjectListResponseLatestDeploymentEnvVarsPagesPlainTextEnvVarType `json:"type" api:"required"`
	// Environment variable value.
	Value string                                                             `json:"value" api:"required"`
...
type ProjectListResponseLatestDeploymentEnvVarsPagesSecretTextEnvVar struct {
	Type ProjectListResponseLatestDeploymentEnvVarsPagesSecretTextEnvVarType `json:"type" api:"required"`
	// Secret value.
	Value string                                                              `json:"value" api:"required"`
...
type ProjectListResponseLatestDeploymentSource struct {
	Config ProjectListResponseLatestDeploymentSourceConfig `json:"config" api:"required"`
	// The source control management provider.
	Type ProjectListResponseLatestDeploymentSourceType `json:"type" api:"required"`
...
type ProjectListResponseLatestDeploymentSourceConfig struct {
	...
	PreviewBranchIncludes []string `json:"preview_branch_includes" api:"required"`
	// Controls whether commits to preview branches trigger a preview deployment.
	PreviewDeploymentSetting ProjectListResponseLatestDeploymentSourceConfigPreviewDeploymentSetting `json:"preview_deployment_setting" api:"required"`
	// The production branch of the repository.
	ProductionBranch string `json:"production_branch" api:"required"`
	// Whether to trigger a production deployment on commits to the production branch.
	ProductionDeploymentsEnabled bool `json:"production_deployments_enabled" api:"required"`
...
type ProjectListResponseSource struct {
	Config ProjectListResponseSourceConfig `json:"config" api:"required"`
	// The source control management provider.
	Type ProjectListResponseSourceType `json:"type" api:"required"`
...
type ProjectListResponseSourceConfig struct {
	...
	PreviewBranchIncludes []string `json:"preview_branch_includes" api:"required"`
	// Controls whether commits to preview branches trigger a preview deployment.
	PreviewDeploymentSetting ProjectListResponseSourceConfigPreviewDeploymentSetting `json:"preview_deployment_setting" api:"required"`
	// The production branch of the repository.
	ProductionBranch string `json:"production_branch" api:"required"`
	// Whether to trigger a production deployment on commits to the production branch.
	ProductionDeploymentsEnabled bool `json:"production_deployments_enabled" api:"required"`
...
type ProjectEditResponse struct {
	...
	ID string `json:"id" api:"required"`
	// Most recent production deployment of the project.
	CanonicalDeployment ProjectEditResponseCanonicalDeployment `json:"canonical_deployment" api:"required,nullable"`
	// When the project was created.
	CreatedOn time.Time `json:"created_on" api:"required" format:"date-time"`
	// Configs for deployments in a project.
	DeploymentConfigs ProjectEditResponseDeploymentConfigs `json:"deployment_configs" api:"required"`
	// Framework the project is using.
	Framework string `json:"framework" api:"required"`
	// Version of the framework the project is using.
	FrameworkVersion string `json:"framework_version" api:"required"`
	// Most recent deployment of the project.
	LatestDeployment ProjectEditResponseLatestDeployment `json:"latest_deployment" api:"required,nullable"`
	// Name of the project.
	Name string `json:"name" api:"required"`
	// Name of the preview script.
	PreviewScriptName string `json:"preview_script_name" api:"required"`
...
type ProjectEditResponseCanonicalDeployment struct {
	...
	Aliases []string `json:"aliases" api:"required,nullable"`
	// Configs for the project build process.
	BuildConfig ProjectEditResponseCanonicalDeploymentBuildConfig `json:"build_config" api:"required"`
	// When the deployment was created.
	CreatedOn time.Time `json:"created_on" api:"required" format:"date-time"`
	// Info about what caused the deployment.
	DeploymentTrigger ProjectEditResponseCanonicalDeploymentDeploymentTrigger `json:"deployment_trigger" api:"required"`
	// Environment variables used for builds and Pages Functions.
	EnvVars map[string]ProjectEditResponseCanonicalDeploymentEnvVar `json:"env_vars" api:"required,nullable"`
	// Type of deploy.
	Environment ProjectEditResponseCanonicalDeploymentEnvironment `json:"environment" api:"required"`
	// If the deployment has been skipped.
	IsSkipped bool `json:"is_skipped" api:"required"`
	// The status of the deployment.
	LatestStage Stage `json:"latest_stage" api:"required"`
	...
	ShortID string `json:"short_id" api:"required"`
	// Configs for the project source control.
	Source ProjectEditResponseCanonicalDeploymentSource `json:"source" api:"required"`
	// List of past stages.
	Stages []Stage `json:"stages" api:"required"`
	// The live URL to view this deployment.
	URL string `json:"url" api:"required"`
...
type ProjectEditResponseCanonicalDeploymentDeploymentTrigger struct {
	// Additional info about the trigger.
	Metadata ProjectEditResponseCanonicalDeploymentDeploymentTriggerMetadata `json:"metadata" api:"required"`
	// What caused the deployment.
	Type ProjectEditResponseCanonicalDeploymentDeploymentTriggerType `json:"type" api:"required"`
...
type ProjectEditResponseCanonicalDeploymentEnvVar struct {
	Type ProjectEditResponseCanonicalDeploymentEnvVarsType `json:"type" api:"required"`
	// Environment variable value.
	Value string                                           `json:"value" api:"required"`
...
type ProjectEditResponseCanonicalDeploymentEnvVarsPagesPlainTextEnvVar struct {
	Type ProjectEditResponseCanonicalDeploymentEnvVarsPagesPlainTextEnvVarType `json:"type" api:"required"`
	// Environment variable value.
	Value string                                                                `json:"value" api:"required"`
...
type ProjectEditResponseCanonicalDeploymentEnvVarsPagesSecretTextEnvVar struct {
	Type ProjectEditResponseCanonicalDeploymentEnvVarsPagesSecretTextEnvVarType `json:"type" api:"required"`
	// Secret value.
	Value string                                                                 `json:"value" api:"required"`
...
type ProjectEditResponseCanonicalDeploymentSource struct {
	Config ProjectEditResponseCanonicalDeploymentSourceConfig `json:"config" api:"required"`
	// The source control management provider.
	Type ProjectEditResponseCanonicalDeploymentSourceType `json:"type" api:"required"`
...
type ProjectEditResponseCanonicalDeploymentSourceConfig struct {
	...
	PreviewBranchIncludes []string `json:"preview_branch_includes" api:"required"`
	// Controls whether commits to preview branches trigger a preview deployment.
	PreviewDeploymentSetting ProjectEditResponseCanonicalDeploymentSourceConfigPreviewDeploymentSetting `json:"preview_deployment_setting" api:"required"`
	// The production branch of the repository.
	ProductionBranch string `json:"production_branch" api:"required"`
	// Whether to trigger a production deployment on commits to the production branch.
	ProductionDeploymentsEnabled bool `json:"production_deployments_enabled" api:"required"`
...
type ProjectEditResponseDeploymentConfigs struct {
	// Configs for preview deploys.
	Preview ProjectEditResponseDeploymentConfigsPreview `json:"preview" api:"required"`
	// Configs for production deploys.
	Production ProjectEditResponseDeploymentConfigsProduction `json:"production" api:"required"`
...
type ProjectEditResponseDeploymentConfigsPreview struct {
	...
	CompatibilityFlags []string `json:"compatibility_flags" api:"required"`
	// Environment variables used for builds and Pages Functions.
	EnvVars map[string]ProjectEditResponseDeploymentConfigsPreviewEnvVar `json:"env_vars" api:"required,nullable"`
	// Whether to fail open when the deployment config cannot be applied.
	FailOpen bool `json:"fail_open" api:"required"`
	// The usage model for Pages Functions.
	//
	// Deprecated: All new projects now use the Standard usage model.
	UsageModel ProjectEditResponseDeploymentConfigsPreviewUsageModel `json:"usage_model" api:"required"`
	// Constellation bindings used for Pages Functions.
...
type ProjectEditResponseDeploymentConfigsPreviewEnvVar struct {
	Type ProjectEditResponseDeploymentConfigsPreviewEnvVarsType `json:"type" api:"required"`
	// Environment variable value.
	Value string                                                `json:"value" api:"required"`
...
type ProjectEditResponseDeploymentConfigsPreviewEnvVarsPagesPlainTextEnvVar struct {
	Type ProjectEditResponseDeploymentConfigsPreviewEnvVarsPagesPlainTextEnvVarType `json:"type" api:"required"`
	// Environment variable value.
	Value string                                                                     `json:"value" api:"required"`
...
type ProjectEditResponseDeploymentConfigsPreviewEnvVarsPagesSecretTextEnvVar struct {
	Type ProjectEditResponseDeploymentConfigsPreviewEnvVarsPagesSecretTextEnvVarType `json:"type" api:"required"`
	// Secret value.
	Value string                                                                      `json:"value" api:"required"`
...
type ProjectEditResponseDeploymentConfigsProduction struct {
	...
	CompatibilityFlags []string `json:"compatibility_flags" api:"required"`
	// Environment variables used for builds and Pages Functions.
	EnvVars map[string]ProjectEditResponseDeploymentConfigsProductionEnvVar `json:"env_vars" api:"required,nullable"`
	// Whether to fail open when the deployment config cannot be applied.
	FailOpen bool `json:"fail_open" api:"required"`
	// The usage model for Pages Functions.
	//
	// Deprecated: All new projects now use the Standard usage model.
	UsageModel ProjectEditResponseDeploymentConfigsProductionUsageModel `json:"usage_model" api:"required"`
	// Constellation bindings used for Pages Functions.
...
type ProjectEditResponseDeploymentConfigsProductionEnvVar struct {
	Type ProjectEditResponseDeploymentConfigsProductionEnvVarsType `json:"type" api:"required"`
	// Environment variable value.
	Value string                                                   `json:"value" api:"required"`
...
type ProjectEditResponseDeploymentConfigsProductionEnvVarsPagesPlainTextEnvVar struct {
	Type ProjectEditResponseDeploymentConfigsProductionEnvVarsPagesPlainTextEnvVarType `json:"type" api:"required"`
	// Environment variable value.
	Value string                                                                        `json:"value" api:"required"`
...
type ProjectEditResponseDeploymentConfigsProductionEnvVarsPagesSecretTextEnvVar struct {
	Type ProjectEditResponseDeploymentConfigsProductionEnvVarsPagesSecretTextEnvVarType `json:"type" api:"required"`
	// Secret value.
	Value string                                                                         `json:"value" api:"required"`
...
type ProjectEditResponseLatestDeployment struct {
	...
	Aliases []string `json:"aliases" api:"required,nullable"`
	// Configs for the project build process.
	BuildConfig ProjectEditResponseLatestDeploymentBuildConfig `json:"build_config" api:"required"`
	// When the deployment was created.
	CreatedOn time.Time `json:"created_on" api:"required" format:"date-time"`
	// Info about what caused the deployment.
	DeploymentTrigger ProjectEditResponseLatestDeploymentDeploymentTrigger `json:"deployment_trigger" api:"required"`
	// Environment variables used for builds and Pages Functions.
	EnvVars map[string]ProjectEditResponseLatestDeploymentEnvVar `json:"env_vars" api:"required,nullable"`
	// Type of deploy.
	Environment ProjectEditResponseLatestDeploymentEnvironment `json:"environment" api:"required"`
	// If the deployment has been skipped.
	IsSkipped bool `json:"is_skipped" api:"required"`
	// The status of the deployment.
	LatestStage Stage `json:"latest_stage" api:"required"`
	...
	ShortID string `json:"short_id" api:"required"`
	// Configs for the project source control.
	Source ProjectEditResponseLatestDeploymentSource `json:"source" api:"required"`
	// List of past stages.
	Stages []Stage `json:"stages" api:"required"`
	// The live URL to view this deployment.
	URL string `json:"url" api:"required"`
...
type ProjectEditResponseLatestDeploymentDeploymentTrigger struct {
	// Additional info about the trigger.
	Metadata ProjectEditResponseLatestDeploymentDeploymentTriggerMetadata `json:"metadata" api:"required"`
	// What caused the deployment.
	Type ProjectEditResponseLatestDeploymentDeploymentTriggerType `json:"type" api:"required"`
...
type ProjectEditResponseLatestDeploymentEnvVar struct {
	Type ProjectEditResponseLatestDeploymentEnvVarsType `json:"type" api:"required"`
	// Environment variable value.
	Value string                                        `json:"value" api:"required"`
...
type ProjectEditResponseLatestDeploymentEnvVarsPagesPlainTextEnvVar struct {
	Type ProjectEditResponseLatestDeploymentEnvVarsPagesPlainTextEnvVarType `json:"type" api:"required"`
	// Environment variable value.
	Value string                                                             `json:"value" api:"required"`
...
type ProjectEditResponseLatestDeploymentEnvVarsPagesSecretTextEnvVar struct {
	Type ProjectEditResponseLatestDeploymentEnvVarsPagesSecretTextEnvVarType `json:"type" api:"required"`
	// Secret value.
	Value string                                                              `json:"value" api:"required"`
...
type ProjectEditResponseLatestDeploymentSource struct {
	Config ProjectEditResponseLatestDeploymentSourceConfig `json:"config" api:"required"`
	// The source control management provider.
	Type ProjectEditResponseLatestDeploymentSourceType `json:"type" api:"required"`
...
type ProjectEditResponseLatestDeploymentSourceConfig struct {
	...
	PreviewBranchIncludes []string `json:"preview_branch_includes" api:"required"`
	// Controls whether commits to preview branches trigger a preview deployment.
	PreviewDeploymentSetting ProjectEditResponseLatestDeploymentSourceConfigPreviewDeploymentSetting `json:"preview_deployment_setting" api:"required"`
	// The production branch of the repository.
	ProductionBranch string `json:"production_branch" api:"required"`
	// Whether to trigger a production deployment on commits to the production branch.
	ProductionDeploymentsEnabled bool `json:"production_deployments_enabled" api:"required"`
...
type ProjectEditResponseSource struct {
	Config ProjectEditResponseSourceConfig `json:"config" api:"required"`
	// The source control management provider.
	Type ProjectEditResponseSourceType `json:"type" api:"required"`
...
type ProjectEditResponseSourceConfig struct {
	...
	PreviewBranchIncludes []string `json:"preview_branch_includes" api:"required"`
	// Controls whether commits to preview branches trigger a preview deployment.
	PreviewDeploymentSetting ProjectEditResponseSourceConfigPreviewDeploymentSetting `json:"preview_deployment_setting" api:"required"`
	// The production branch of the repository.
	ProductionBranch string `json:"production_branch" api:"required"`
	// Whether to trigger a production deployment on commits to the production branch.
	ProductionDeploymentsEnabled bool `json:"production_deployments_enabled" api:"required"`
...
type ProjectGetResponse struct {
	...
	ID string `json:"id" api:"required"`
	// Most recent production deployment of the project.
	CanonicalDeployment ProjectGetResponseCanonicalDeployment `json:"canonical_deployment" api:"required,nullable"`
	// When the project was created.
	CreatedOn time.Time `json:"created_on" api:"required" format:"date-time"`
	// Configs for deployments in a project.
	DeploymentConfigs ProjectGetResponseDeploymentConfigs `json:"deployment_configs" api:"required"`
	// Framework the project is using.
	Framework string `json:"framework" api:"required"`
	// Version of the framework the project is using.
	FrameworkVersion string `json:"framework_version" api:"required"`
	// Most recent deployment of the project.
	LatestDeployment ProjectGetResponseLatestDeployment `json:"latest_deployment" api:"required,nullable"`
	// Name of the project.
	Name string `json:"name" api:"required"`
	// Name of the preview script.
	PreviewScriptName string `json:"preview_script_name" api:"required"`
...
type ProjectGetResponseCanonicalDeployment struct {
	...
	Aliases []string `json:"aliases" api:"required,nullable"`
	// Configs for the project build process.
	BuildConfig ProjectGetResponseCanonicalDeploymentBuildConfig `json:"build_config" api:"required"`
	// When the deployment was created.
	CreatedOn time.Time `json:"created_on" api:"required" format:"date-time"`
	// Info about what caused the deployment.
	DeploymentTrigger ProjectGetResponseCanonicalDeploymentDeploymentTrigger `json:"deployment_trigger" api:"required"`
	// Environment variables used for builds and Pages Functions.
	EnvVars map[string]ProjectGetResponseCanonicalDeploymentEnvVar `json:"env_vars" api:"required,nullable"`
	// Type of deploy.
	Environment ProjectGetResponseCanonicalDeploymentEnvironment `json:"environment" api:"required"`
	// If the deployment has been skipped.
	IsSkipped bool `json:"is_skipped" api:"required"`
	// The status of the deployment.
	LatestStage Stage `json:"latest_stage" api:"required"`
	...
	ShortID string `json:"short_id" api:"required"`
	// Configs for the project source control.
	Source ProjectGetResponseCanonicalDeploymentSource `json:"source" api:"required"`
	// List of past stages.
	Stages []Stage `json:"stages" api:"required"`
	// The live URL to view this deployment.
	URL string `json:"url" api:"required"`
...
type ProjectGetResponseCanonicalDeploymentDeploymentTrigger struct {
	// Additional info about the trigger.
	Metadata ProjectGetResponseCanonicalDeploymentDeploymentTriggerMetadata `json:"metadata" api:"required"`
	// What caused the deployment.
	Type ProjectGetResponseCanonicalDeploymentDeploymentTriggerType `json:"type" api:"required"`
...
type ProjectGetResponseCanonicalDeploymentEnvVar struct {
	Type ProjectGetResponseCanonicalDeploymentEnvVarsType `json:"type" api:"required"`
	// Environment variable value.
	Value string                                          `json:"value" api:"required"`
...
type ProjectGetResponseCanonicalDeploymentEnvVarsPagesPlainTextEnvVar struct {
	Type ProjectGetResponseCanonicalDeploymentEnvVarsPagesPlainTextEnvVarType `json:"type" api:"required"`
	// Environment variable value.
	Value string                                                               `json:"value" api:"required"`
...
type ProjectGetResponseCanonicalDeploymentEnvVarsPagesSecretTextEnvVar struct {
	Type ProjectGetResponseCanonicalDeploymentEnvVarsPagesSecretTextEnvVarType `json:"type" api:"required"`
	// Secret value.
	Value string                                                                `json:"value" api:"required"`
...
type ProjectGetResponseCanonicalDeploymentSource struct {
	Config ProjectGetResponseCanonicalDeploymentSourceConfig `json:"config" api:"required"`
	// The source control management provider.
	Type ProjectGetResponseCanonicalDeploymentSourceType `json:"type" api:"required"`
...
type ProjectGetResponseCanonicalDeploymentSourceConfig struct {
	...
	PreviewBranchIncludes []string `json:"preview_branch_includes" api:"required"`
	// Controls whether commits to preview branches trigger a preview deployment.
	PreviewDeploymentSetting ProjectGetResponseCanonicalDeploymentSourceConfigPreviewDeploymentSetting `json:"preview_deployment_setting" api:"required"`
	// The production branch of the repository.
	ProductionBranch string `json:"production_branch" api:"required"`
	// Whether to trigger a production deployment on commits to the production branch.
	ProductionDeploymentsEnabled bool `json:"production_deployments_enabled" api:"required"`
...
type ProjectGetResponseDeploymentConfigs struct {
	// Configs for preview deploys.
	Preview ProjectGetResponseDeploymentConfigsPreview `json:"preview" api:"required"`
	// Configs for production deploys.
	Production ProjectGetResponseDeploymentConfigsProduction `json:"production" api:"required"`
...
type ProjectGetResponseDeploymentConfigsPreview struct {
	...
	CompatibilityFlags []string `json:"compatibility_flags" api:"required"`
	// Environment variables used for builds and Pages Functions.
	EnvVars map[string]ProjectGetResponseDeploymentConfigsPreviewEnvVar `json:"env_vars" api:"required,nullable"`
	// Whether to fail open when the deployment config cannot be applied.
	FailOpen bool `json:"fail_open" api:"required"`
	// The usage model for Pages Functions.
	//
	// Deprecated: All new projects now use the Standard usage model.
	UsageModel ProjectGetResponseDeploymentConfigsPreviewUsageModel `json:"usage_model" api:"required"`
	// Constellation bindings used for Pages Functions.
...
type ProjectGetResponseDeploymentConfigsPreviewEnvVar struct {
	Type ProjectGetResponseDeploymentConfigsPreviewEnvVarsType `json:"type" api:"required"`
	// Environment variable value.
	Value string                                               `json:"value" api:"required"`
...
type ProjectGetResponseDeploymentConfigsPreviewEnvVarsPagesPlainTextEnvVar struct {
	Type ProjectGetResponseDeploymentConfigsPreviewEnvVarsPagesPlainTextEnvVarType `json:"type" api:"required"`
	// Environment variable value.
	Value string                                                                    `json:"value" api:"required"`
...
type ProjectGetResponseDeploymentConfigsPreviewEnvVarsPagesSecretTextEnvVar struct {
	Type ProjectGetResponseDeploymentConfigsPreviewEnvVarsPagesSecretTextEnvVarType `json:"type" api:"required"`
	// Secret value.
	Value string                                                                     `json:"value" api:"required"`
...
type ProjectGetResponseDeploymentConfigsProduction struct {
	...
	CompatibilityFlags []string `json:"compatibility_flags" api:"required"`
	// Environment variables used for builds and Pages Functions.
	EnvVars map[string]ProjectGetResponseDeploymentConfigsProductionEnvVar `json:"env_vars" api:"required,nullable"`
	// Whether to fail open when the deployment config cannot be applied.
	FailOpen bool `json:"fail_open" api:"required"`
	// The usage model for Pages Functions.
	//
	// Deprecated: All new projects now use the Standard usage model.
	UsageModel ProjectGetResponseDeploymentConfigsProductionUsageModel `json:"usage_model" api:"required"`
	// Constellation bindings used for Pages Functions.
...
type ProjectGetResponseDeploymentConfigsProductionEnvVar struct {
	Type ProjectGetResponseDeploymentConfigsProductionEnvVarsType `json:"type" api:"required"`
	// Environment variable value.
	Value string                                                  `json:"value" api:"required"`
...
type ProjectGetResponseDeploymentConfigsProductionEnvVarsPagesPlainTextEnvVar struct {
	Type ProjectGetResponseDeploymentConfigsProductionEnvVarsPagesPlainTextEnvVarType `json:"type" api:"required"`
	// Environment variable value.
	Value string                                                                       `json:"value" api:"required"`
...
type ProjectGetResponseDeploymentConfigsProductionEnvVarsPagesSecretTextEnvVar struct {
	Type ProjectGetResponseDeploymentConfigsProductionEnvVarsPagesSecretTextEnvVarType `json:"type" api:"required"`
	// Secret value.
	Value string                                                                        `json:"value" api:"required"`
...
type ProjectGetResponseLatestDeployment struct {
	...
	Aliases []string `json:"aliases" api:"required,nullable"`
	// Configs for the project build process.
	BuildConfig ProjectGetResponseLatestDeploymentBuildConfig `json:"build_config" api:"required"`
	// When the deployment was created.
	CreatedOn time.Time `json:"created_on" api:"required" format:"date-time"`
	// Info about what caused the deployment.
	DeploymentTrigger ProjectGetResponseLatestDeploymentDeploymentTrigger `json:"deployment_trigger" api:"required"`
	// Environment variables used for builds and Pages Functions.
	EnvVars map[string]ProjectGetResponseLatestDeploymentEnvVar `json:"env_vars" api:"required,nullable"`
	// Type of deploy.
	Environment ProjectGetResponseLatestDeploymentEnvironment `json:"environment" api:"required"`
	// If the deployment has been skipped.
	IsSkipped bool `json:"is_skipped" api:"required"`
	// The status of the deployment.
	LatestStage Stage `json:"latest_stage" api:"required"`
	...
	ShortID string `json:"short_id" api:"required"`
	// Configs for the project source control.
	Source ProjectGetResponseLatestDeploymentSource `json:"source" api:"required"`
	// List of past stages.
	Stages []Stage `json:"stages" api:"required"`
	// The live URL to view this deployment.
	URL string `json:"url" api:"required"`
...
type ProjectGetResponseLatestDeploymentDeploymentTrigger struct {
	// Additional info about the trigger.
	Metadata ProjectGetResponseLatestDeploymentDeploymentTriggerMetadata `json:"metadata" api:"required"`
	// What caused the deployment.
	Type ProjectGetResponseLatestDeploymentDeploymentTriggerType `json:"type" api:"required"`
...
type ProjectGetResponseLatestDeploymentEnvVar struct {
	Type ProjectGetResponseLatestDeploymentEnvVarsType `json:"type" api:"required"`
	// Environment variable value.
	Value string                                       `json:"value" api:"required"`
...
type ProjectGetResponseLatestDeploymentEnvVarsPagesPlainTextEnvVar struct {
	Type ProjectGetResponseLatestDeploymentEnvVarsPagesPlainTextEnvVarType `json:"type" api:"required"`
	// Environment variable value.
	Value string                                                            `json:"value" api:"required"`
...
type ProjectGetResponseLatestDeploymentEnvVarsPagesSecretTextEnvVar struct {
	Type ProjectGetResponseLatestDeploymentEnvVarsPagesSecretTextEnvVarType `json:"type" api:"required"`
	// Secret value.
	Value string                                                             `json:"value" api:"required"`
...
type ProjectGetResponseLatestDeploymentSource struct {
	Config ProjectGetResponseLatestDeploymentSourceConfig `json:"config" api:"required"`
	// The source control management provider.
	Type ProjectGetResponseLatestDeploymentSourceType `json:"type" api:"required"`
...
type ProjectGetResponseLatestDeploymentSourceConfig struct {
	...
	PreviewBranchIncludes []string `json:"preview_branch_includes" api:"required"`
	// Controls whether commits to preview branches trigger a preview deployment.
	PreviewDeploymentSetting ProjectGetResponseLatestDeploymentSourceConfigPreviewDeploymentSetting `json:"preview_deployment_setting" api:"required"`
	// The production branch of the repository.
	ProductionBranch string `json:"production_branch" api:"required"`
	// Whether to trigger a production deployment on commits to the production branch.
	ProductionDeploymentsEnabled bool `json:"production_deployments_enabled" api:"required"`
...
type ProjectGetResponseSource struct {
	Config ProjectGetResponseSourceConfig `json:"config" api:"required"`
	// The source control management provider.
	Type ProjectGetResponseSourceType `json:"type" api:"required"`
...
type ProjectGetResponseSourceConfig struct {
	...
	PreviewBranchIncludes []string `json:"preview_branch_includes" api:"required"`
	// Controls whether commits to preview branches trigger a preview deployment.
	PreviewDeploymentSetting ProjectGetResponseSourceConfigPreviewDeploymentSetting `json:"preview_deployment_setting" api:"required"`
	// The production branch of the repository.
	ProductionBranch string `json:"production_branch" api:"required"`
	// Whether to trigger a production deployment on commits to the production branch.
	ProductionDeploymentsEnabled bool `json:"production_deployments_enabled" api:"required"`
...
type ProjectNewResponseEnvelope struct {
	...
	Result   ProjectNewResponse                   `json:"result" api:"required"`
...
type ProjectEditResponseEnvelope struct {
	...
	Result   ProjectEditResponse                   `json:"result" api:"required"`
	// Whether the API call was successful.
...
type ProjectGetResponseEnvelope struct {
	...
	Result   ProjectGetResponse                   `json:"result" api:"required"`
	// Whether the API call was successful.
