...
type ProjectDeploymentNewResponse struct {
	...
	BuildConfig ProjectDeploymentNewResponseBuildConfig `json:"build_config" api:"required"`
	// When the deployment was created.
	CreatedOn time.Time `json:"created_on" api:"required" format:"date-time"`
	// Info about what caused the deployment.
	DeploymentTrigger ProjectDeploymentNewResponseDeploymentTrigger `json:"deployment_trigger" api:"required"`
	// Environment variables used for builds and Pages Functions.
	EnvVars map[string]ProjectDeploymentNewResponseEnvVar `json:"env_vars" api:"required,nullable"`
	// Type of deploy.
	Environment ProjectDeploymentNewResponseEnvironment `json:"environment" api:"required"`
	...
	Source ProjectDeploymentNewResponseSource `json:"source" api:"required"`
	// List of past stages.
...
type ProjectDeploymentNewResponseDeploymentTrigger struct {
	...
	Metadata ProjectDeploymentNewResponseDeploymentTriggerMetadata `json:"metadata" api:"required"`
	// What caused the deployment.
	Type ProjectDeploymentNewResponseDeploymentTriggerType `json:"type" api:"required"`
...
type ProjectDeploymentNewResponseEnvVar struct {
	Type ProjectDeploymentNewResponseEnvVarsType `json:"type" api:"required"`
...
type ProjectDeploymentNewResponseEnvVarsPagesPlainTextEnvVar struct {
	Type ProjectDeploymentNewResponseEnvVarsPagesPlainTextEnvVarType `json:"type" api:"required"`
	// Environment variable value.
	Value string                                                      `json:"value" api:"required"`
...
type ProjectDeploymentNewResponseEnvVarsPagesSecretTextEnvVar struct {
	Type ProjectDeploymentNewResponseEnvVarsPagesSecretTextEnvVarType `json:"type" api:"required"`
	// Secret value.
	Value string                                                       `json:"value" api:"required"`
...
type ProjectDeploymentNewResponseSource struct {
	Config ProjectDeploymentNewResponseSourceConfig `json:"config" api:"required"`
	// The source control management provider.
	Type ProjectDeploymentNewResponseSourceType `json:"type" api:"required"`
...
type ProjectDeploymentNewResponseSourceConfig struct {
	...
	PreviewDeploymentSetting ProjectDeploymentNewResponseSourceConfigPreviewDeploymentSetting `json:"preview_deployment_setting" api:"required"`
...
type ProjectDeploymentListResponse struct {
	...
	Aliases []string `json:"aliases" api:"required,nullable"`
	// Configs for the project build process.
	BuildConfig ProjectDeploymentListResponseBuildConfig `json:"build_config" api:"required"`
	// When the deployment was created.
	CreatedOn time.Time `json:"created_on" api:"required" format:"date-time"`
	// Info about what caused the deployment.
	DeploymentTrigger ProjectDeploymentListResponseDeploymentTrigger `json:"deployment_trigger" api:"required"`
	// Environment variables used for builds and Pages Functions.
	EnvVars map[string]ProjectDeploymentListResponseEnvVar `json:"env_vars" api:"required,nullable"`
	// Type of deploy.
	Environment ProjectDeploymentListResponseEnvironment `json:"environment" api:"required"`
	// If the deployment has been skipped.
	IsSkipped bool `json:"is_skipped" api:"required"`
	// The status of the deployment.
	LatestStage Stage `json:"latest_stage" api:"required"`
	...
	ShortID string `json:"short_id" api:"required"`
	// Configs for the project source control.
	Source ProjectDeploymentListResponseSource `json:"source" api:"required"`
	// List of past stages.
	Stages []Stage `json:"stages" api:"required"`
	// The live URL to view this deployment.
	URL string `json:"url" api:"required"`
...
type ProjectDeploymentListResponseDeploymentTrigger struct {
	// Additional info about the trigger.
	Metadata ProjectDeploymentListResponseDeploymentTriggerMetadata `json:"metadata" api:"required"`
	// What caused the deployment.
	Type ProjectDeploymentListResponseDeploymentTriggerType `json:"type" api:"required"`
...
type ProjectDeploymentListResponseEnvVar struct {
	Type ProjectDeploymentListResponseEnvVarsType `json:"type" api:"required"`
	// Environment variable value.
	Value string                                  `json:"value" api:"required"`
...
type ProjectDeploymentListResponseEnvVarsPagesPlainTextEnvVar struct {
	Type ProjectDeploymentListResponseEnvVarsPagesPlainTextEnvVarType `json:"type" api:"required"`
	// Environment variable value.
	Value string                                                       `json:"value" api:"required"`
...
type ProjectDeploymentListResponseEnvVarsPagesSecretTextEnvVar struct {
	Type ProjectDeploymentListResponseEnvVarsPagesSecretTextEnvVarType `json:"type" api:"required"`
	// Secret value.
	Value string                                                        `json:"value" api:"required"`
...
type ProjectDeploymentListResponseSource struct {
	Config ProjectDeploymentListResponseSourceConfig `json:"config" api:"required"`
	// The source control management provider.
	Type ProjectDeploymentListResponseSourceType `json:"type" api:"required"`
...
type ProjectDeploymentListResponseSourceConfig struct {
	...
	PreviewBranchIncludes []string `json:"preview_branch_includes" api:"required"`
	// Controls whether commits to preview branches trigger a preview deployment.
	PreviewDeploymentSetting ProjectDeploymentListResponseSourceConfigPreviewDeploymentSetting `json:"preview_deployment_setting" api:"required"`
	// The production branch of the repository.
	ProductionBranch string `json:"production_branch" api:"required"`
	// Whether to trigger a production deployment on commits to the production branch.
	ProductionDeploymentsEnabled bool `json:"production_deployments_enabled" api:"required"`
...
type ProjectDeploymentGetResponse struct {
	...
	Aliases []string `json:"aliases" api:"required,nullable"`
	// Configs for the project build process.
	BuildConfig ProjectDeploymentGetResponseBuildConfig `json:"build_config" api:"required"`
	// When the deployment was created.
	CreatedOn time.Time `json:"created_on" api:"required" format:"date-time"`
	// Info about what caused the deployment.
	DeploymentTrigger ProjectDeploymentGetResponseDeploymentTrigger `json:"deployment_trigger" api:"required"`
	// Environment variables used for builds and Pages Functions.
	EnvVars map[string]ProjectDeploymentGetResponseEnvVar `json:"env_vars" api:"required,nullable"`
	// Type of deploy.
	Environment ProjectDeploymentGetResponseEnvironment `json:"environment" api:"required"`
	// If the deployment has been skipped.
	IsSkipped bool `json:"is_skipped" api:"required"`
	// The status of the deployment.
	LatestStage Stage `json:"latest_stage" api:"required"`
	...
	ShortID string `json:"short_id" api:"required"`
	// Configs for the project source control.
	Source ProjectDeploymentGetResponseSource `json:"source" api:"required"`
	// List of past stages.
	Stages []Stage `json:"stages" api:"required"`
	// The live URL to view this deployment.
	URL string `json:"url" api:"required"`
...
type ProjectDeploymentGetResponseDeploymentTrigger struct {
	// Additional info about the trigger.
	Metadata ProjectDeploymentGetResponseDeploymentTriggerMetadata `json:"metadata" api:"required"`
	// What caused the deployment.
	Type ProjectDeploymentGetResponseDeploymentTriggerType `json:"type" api:"required"`
...
type ProjectDeploymentGetResponseEnvVar struct {
	Type ProjectDeploymentGetResponseEnvVarsType `json:"type" api:"required"`
	// Environment variable value.
	Value string                                 `json:"value" api:"required"`
...
type ProjectDeploymentGetResponseEnvVarsPagesPlainTextEnvVar struct {
	Type ProjectDeploymentGetResponseEnvVarsPagesPlainTextEnvVarType `json:"type" api:"required"`
	// Environment variable value.
	Value string                                                      `json:"value" api:"required"`
...
type ProjectDeploymentGetResponseEnvVarsPagesSecretTextEnvVar struct {
	Type ProjectDeploymentGetResponseEnvVarsPagesSecretTextEnvVarType `json:"type" api:"required"`
	// Secret value.
	Value string                                                       `json:"value" api:"required"`
...
type ProjectDeploymentGetResponseSource struct {
	Config ProjectDeploymentGetResponseSourceConfig `json:"config" api:"required"`
	// The source control management provider.
	Type ProjectDeploymentGetResponseSourceType `json:"type" api:"required"`
...
type ProjectDeploymentGetResponseSourceConfig struct {
	...
	PreviewBranchIncludes []string `json:"preview_branch_includes" api:"required"`
	// Controls whether commits to preview branches trigger a preview deployment.
	PreviewDeploymentSetting ProjectDeploymentGetResponseSourceConfigPreviewDeploymentSetting `json:"preview_deployment_setting" api:"required"`
	// The production branch of the repository.
	ProductionBranch string `json:"production_branch" api:"required"`
	// Whether to trigger a production deployment on commits to the production branch.
	ProductionDeploymentsEnabled bool `json:"production_deployments_enabled" api:"required"`
...
type ProjectDeploymentRetryResponse struct {
	...
	Aliases []string `json:"aliases" api:"required,nullable"`
	// Configs for the project build process.
	BuildConfig ProjectDeploymentRetryResponseBuildConfig `json:"build_config" api:"required"`
	// When the deployment was created.
	CreatedOn time.Time `json:"created_on" api:"required" format:"date-time"`
	// Info about what caused the deployment.
	DeploymentTrigger ProjectDeploymentRetryResponseDeploymentTrigger `json:"deployment_trigger" api:"required"`
	// Environment variables used for builds and Pages Functions.
	EnvVars map[string]ProjectDeploymentRetryResponseEnvVar `json:"env_vars" api:"required,nullable"`
	// Type of deploy.
	Environment ProjectDeploymentRetryResponseEnvironment `json:"environment" api:"required"`
	// If the deployment has been skipped.
	IsSkipped bool `json:"is_skipped" api:"required"`
	// The status of the deployment.
	LatestStage Stage `json:"latest_stage" api:"required"`
	...
	ShortID string `json:"short_id" api:"required"`
	// Configs for the project source control.
	Source ProjectDeploymentRetryResponseSource `json:"source" api:"required"`
	// List of past stages.
	Stages []Stage `json:"stages" api:"required"`
	// The live URL to view this deployment.
	URL string `json:"url" api:"required"`
...
type ProjectDeploymentRetryResponseDeploymentTrigger struct {
	// Additional info about the trigger.
	Metadata ProjectDeploymentRetryResponseDeploymentTriggerMetadata `json:"metadata" api:"required"`
	// What caused the deployment.
	Type ProjectDeploymentRetryResponseDeploymentTriggerType `json:"type" api:"required"`
...
type ProjectDeploymentRetryResponseEnvVar struct {
	Type ProjectDeploymentRetryResponseEnvVarsType `json:"type" api:"required"`
	// Environment variable value.
	Value string                                   `json:"value" api:"required"`
...
type ProjectDeploymentRetryResponseEnvVarsPagesPlainTextEnvVar struct {
	Type ProjectDeploymentRetryResponseEnvVarsPagesPlainTextEnvVarType `json:"type" api:"required"`
	// Environment variable value.
	Value string                                                        `json:"value" api:"required"`
...
type ProjectDeploymentRetryResponseEnvVarsPagesSecretTextEnvVar struct {
	Type ProjectDeploymentRetryResponseEnvVarsPagesSecretTextEnvVarType `json:"type" api:"required"`
	// Secret value.
	Value string                                                         `json:"value" api:"required"`
...
type ProjectDeploymentRetryResponseSource struct {
	Config ProjectDeploymentRetryResponseSourceConfig `json:"config" api:"required"`
	// The source control management provider.
	Type ProjectDeploymentRetryResponseSourceType `json:"type" api:"required"`
...
type ProjectDeploymentRetryResponseSourceConfig struct {
	...
	PreviewBranchIncludes []string `json:"preview_branch_includes" api:"required"`
	// Controls whether commits to preview branches trigger a preview deployment.
	PreviewDeploymentSetting ProjectDeploymentRetryResponseSourceConfigPreviewDeploymentSetting `json:"preview_deployment_setting" api:"required"`
	// The production branch of the repository.
	ProductionBranch string `json:"production_branch" api:"required"`
	// Whether to trigger a production deployment on commits to the production branch.
	ProductionDeploymentsEnabled bool `json:"production_deployments_enabled" api:"required"`
...
type ProjectDeploymentRollbackResponse struct {
	...
	Aliases []string `json:"aliases" api:"required,nullable"`
	// Configs for the project build process.
	BuildConfig ProjectDeploymentRollbackResponseBuildConfig `json:"build_config" api:"required"`
	// When the deployment was created.
	CreatedOn time.Time `json:"created_on" api:"required" format:"date-time"`
	// Info about what caused the deployment.
	DeploymentTrigger ProjectDeploymentRollbackResponseDeploymentTrigger `json:"deployment_trigger" api:"required"`
	// Environment variables used for builds and Pages Functions.
	EnvVars map[string]ProjectDeploymentRollbackResponseEnvVar `json:"env_vars" api:"required,nullable"`
	// Type of deploy.
	Environment ProjectDeploymentRollbackResponseEnvironment `json:"environment" api:"required"`
	// If the deployment has been skipped.
	IsSkipped bool `json:"is_skipped" api:"required"`
	// The status of the deployment.
	LatestStage Stage `json:"latest_stage" api:"required"`
	...
	ShortID string `json:"short_id" api:"required"`
	// Configs for the project source control.
	Source ProjectDeploymentRollbackResponseSource `json:"source" api:"required"`
	// List of past stages.
	Stages []Stage `json:"stages" api:"required"`
	// The live URL to view this deployment.
	URL string `json:"url" api:"required"`
...
type ProjectDeploymentRollbackResponseDeploymentTrigger struct {
	// Additional info about the trigger.
	Metadata ProjectDeploymentRollbackResponseDeploymentTriggerMetadata `json:"metadata" api:"required"`
	// What caused the deployment.
	Type ProjectDeploymentRollbackResponseDeploymentTriggerType `json:"type" api:"required"`
...
type ProjectDeploymentRollbackResponseEnvVar struct {
	Type ProjectDeploymentRollbackResponseEnvVarsType `json:"type" api:"required"`
	// Environment variable value.
	Value string                                      `json:"value" api:"required"`
...
type ProjectDeploymentRollbackResponseEnvVarsPagesPlainTextEnvVar struct {
	Type ProjectDeploymentRollbackResponseEnvVarsPagesPlainTextEnvVarType `json:"type" api:"required"`
	// Environment variable value.
	Value string                                                           `json:"value" api:"required"`
...
type ProjectDeploymentRollbackResponseEnvVarsPagesSecretTextEnvVar struct {
	Type ProjectDeploymentRollbackResponseEnvVarsPagesSecretTextEnvVarType `json:"type" api:"required"`
	// Secret value.
	Value string                                                            `json:"value" api:"required"`
...
type ProjectDeploymentRollbackResponseSource struct {
	Config ProjectDeploymentRollbackResponseSourceConfig `json:"config" api:"required"`
	// The source control management provider.
	Type ProjectDeploymentRollbackResponseSourceType `json:"type" api:"required"`
...
type ProjectDeploymentRollbackResponseSourceConfig struct {
	...
	PreviewBranchIncludes []string `json:"preview_branch_includes" api:"required"`
	// Controls whether commits to preview branches trigger a preview deployment.
	PreviewDeploymentSetting ProjectDeploymentRollbackResponseSourceConfigPreviewDeploymentSetting `json:"preview_deployment_setting" api:"required"`
	// The production branch of the repository.
	ProductionBranch string `json:"production_branch" api:"required"`
	// Whether to trigger a production deployment on commits to the production branch.
	ProductionDeploymentsEnabled bool `json:"production_deployments_enabled" api:"required"`
...
type ProjectDeploymentNewResponseEnvelope struct {
	...
	Result   ProjectDeploymentNewResponse                   `json:"result" api:"required"`
...
type ProjectDeploymentGetResponseEnvelope struct {
	...
	Result   ProjectDeploymentGetResponse                   `json:"result" api:"required"`
	// Whether the API call was successful.
...
type ProjectDeploymentRetryResponseEnvelope struct {
	...
	Result   ProjectDeploymentRetryResponse                   `json:"result" api:"required"`
	// Whether the API call was successful.
...
type ProjectDeploymentRollbackResponseEnvelope struct {
	...
	Result   ProjectDeploymentRollbackResponse                   `json:"result" api:"required"`
	// Whether the API call was successful.
