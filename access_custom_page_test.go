...
func TestAccessCustomPages(t *testing.T) {
	...
	actual, err := client.AccessCustomPages(context.Background(), testAccountID, PaginationOptions{})
...
func TestAccessCustomPage(t *testing.T) {
	...
	actual, err := client.AccessCustomPage(context.Background(), testAccountID, "480f4f69-1a28-4fdd-9240-1ed29f0ac1dc")
...
func TestCreateAccessCustomPage(t *testing.T) {
	...
	mux.HandleFunc("/accounts/"+testAccountID+"/access/custom_pages", handler)
	actual, err := client.CreateAccessCustomPage(context.Background(), testAccountID, AccessCustomPage{
		Name:       "Forbidden",
		Type:       Forbidden,
		CustomHTML: "<html><body><h1>Forbidden</h1></body></html>",
	})
...
func TestUpdateAccessCustomPage(t *testing.T) {
	...
	mux.HandleFunc("/accounts/"+testAccountID+"/access/custom_pages/480f4f69-1a28-4fdd-9240-1ed29f0ac1dc", handler)
	actual, err := client.UpdateAccessCustomPage(context.Background(), testAccountID, "480f4f69-1a28-4fdd-9240-1ed29f0ac1dc", customPage)
...
func TestDeleteAccessCustomPage(t *testing.T) {
	...
	mux.HandleFunc("/accounts/"+testAccountID+"/access/custom_pages/480f4f69-1a28-4fdd-9240-1ed29f0ac1dc", handler)
	err := client.DeleteAccessCustomPage(context.Background(), testAccountID, "480f4f69-1a28-4fdd-9240-1ed29f0ac1dc")
