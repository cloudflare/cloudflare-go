...
func TestAccountMemberReplace(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.AccountMembers.Replace(
		context.TODO(),
		map[string]interface{}{},
		"4536bcfad5faccb111b47003c79917fa",
		cloudflare.AccountMemberReplaceParams{
			Roles: cloudflare.F([]cloudflare.AccountMemberReplaceParamsRole{{
