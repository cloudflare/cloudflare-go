...
func TestSubscriptionActionAppendWithOptionalParams(t *testing.T) {
	...
	_, err := client.Accounts.Subscriptions.Actions.Append(
		context.TODO(),
		"506e3185e9c882d175a2d0cb0093d9f2",
		accounts.SubscriptionActionAppendParams{
