...
func TestSubscriptionBulkNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Accounts.Subscriptions.Bulk.New(context.TODO(), accounts.SubscriptionBulkNewParams{
		AccountID:     cloudflare.F("023e105f4ecef8ad9ca31a8372d0c353"),
		IdempKey:      cloudflare.F("idemp_key"),
		CouponCode:    cloudflare.F("coupon_code"),
		PaymentHoldID: cloudflare.F(int64(0)),
		Subscriptions: cloudflare.F([]shared.SubscriptionParam{{
		...
		UserIsOnSession: cloudflare.F(true),
	})
	if err != nil {
