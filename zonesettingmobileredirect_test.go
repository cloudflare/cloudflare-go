...
func TestZoneSettingMobileRedirectUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := client.Zones.Settings.MobileRedirects.Update(
		...
		cloudflare.ZoneSettingMobileRedirectUpdateParams{
			Value: cloudflare.F(cloudflare.ZoneSettingMobileRedirectUpdateParamsValue{
				MobileSubdomain: cloudflare.F("m"),
				Status:          cloudflare.F(cloudflare.ZoneSettingMobileRedirectUpdateParamsValueStatusOn),
