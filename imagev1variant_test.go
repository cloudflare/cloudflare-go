...
func TestImageV1VariantUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := client.Images.V1s.Variants.Update(
		...
		cloudflare.ImageV1VariantUpdateParams{
			Options: cloudflare.F(cloudflare.ImageV1VariantUpdateParamsOptions{
				...
				Metadata: cloudflare.F(cloudflare.ImageV1VariantUpdateParamsOptionsMetadataNone),
...
func TestImageV1VariantCloudflareImagesVariantsNewAVariantWithOptionalParams(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Images.V1s.Variants.CloudflareImagesVariantsNewAVariant(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		cloudflare.ImageV1VariantCloudflareImagesVariantsNewAVariantParams{
			...
			Options: cloudflare.F(cloudflare.ImageV1VariantCloudflareImagesVariantsNewAVariantParamsOptions{
				...
				Height:   cloudflare.F(768.000000),
				Metadata: cloudflare.F(cloudflare.ImageV1VariantCloudflareImagesVariantsNewAVariantParamsOptionsMetadataNone),
				Width:    cloudflare.F(1366.000000),
			}),
			NeverRequireSignedURLs: cloudflare.F(true),
		},
...
func TestImageV1VariantCloudflareImagesVariantsListVariants(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Images.V1s.Variants.CloudflareImagesVariantsListVariants(context.TODO(), "023e105f4ecef8ad9ca31a8372d0c353")
	if err != nil {
		var apierr *cloudflare.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
