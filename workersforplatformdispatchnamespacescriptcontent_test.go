...
func TestWorkersForPlatformDispatchNamespaceScriptContentReplaceWithOptionalParams(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	...
	_, err := client.WorkersForPlatforms.Dispatch.Namespaces.Scripts.Content.Replace(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		"my-dispatch-namespace",
		"this-is_my_script-01",
		cloudflare.WorkersForPlatformDispatchNamespaceScriptContentReplaceParams{
			...
			Metadata: cloudflare.F(cloudflare.WorkersForPlatformDispatchNamespaceScriptContentReplaceParamsMetadata{
