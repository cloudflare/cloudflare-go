...
func (r *WorkerAIService) Run(ctx context.Context, accountID string, modelName string, body WorkerAIRunParams, opts ...option.RequestOption) (res *WorkerAIRunResponse, err error) {
