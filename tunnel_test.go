...
func TestTunnelArgoTunnelNewAnArgoTunnel(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Tunnels.ArgoTunnelNewAnArgoTunnel(
		context.TODO(),
		"699d98642c564d2e855e9661899b7252",
		cloudflare.TunnelArgoTunnelNewAnArgoTunnelParams{
...
func TestTunnelArgoTunnelListArgoTunnelsWithOptionalParams(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Tunnels.ArgoTunnelListArgoTunnels(
		context.TODO(),
		"699d98642c564d2e855e9661899b7252",
		cloudflare.TunnelArgoTunnelListArgoTunnelsParams{
