...
type LogpushValidateService struct {
	...
	Destinations *LogpushValidateDestinationService
	Origins      *LogpushValidateOriginService
}
...
func NewLogpushValidateService(opts ...option.RequestOption) (r *LogpushValidateService) {
	...
	r.Options = opts
	r.Destinations = NewLogpushValidateDestinationService(opts...)
	r.Origins = NewLogpushValidateOriginService(opts...)
	return
}
