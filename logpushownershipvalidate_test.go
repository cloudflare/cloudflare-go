...
func TestLogpushOwnershipValidatePostAccountsAccountIdentifierLogpushOwnershipValidate(t *testing.T) {
	...
	_, err := client.Logpush.Ownerships.Validates.PostAccountsAccountIdentifierLogpushOwnershipValidate(
		context.TODO(),
		"string",
