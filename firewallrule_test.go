...
func TestFirewallRuleNew(t *testing.T) {
	...
	_, err := client.Firewalls.Rules.New(
		context.TODO(),
...
func TestFirewallRuleListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Firewalls.Rules.List(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
...
func TestFirewallRuleReplace(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Firewalls.Rules.Replace(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		"372e67954025e0ba6aaa6d586b9e0b60",
		cloudflare.FirewallRuleReplaceParams{
			Body: cloudflare.F[any](map[string]interface{}{}),
		},
	)
	if err != nil {
