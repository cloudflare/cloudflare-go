...
func TestPageShieldConnectionGet(t *testing.T) {
	...
	_, err := client.PageShields.Connections.Get(
		context.TODO(),
...
func TestPageShieldConnectionPageShieldListPageShieldConnectionsWithOptionalParams(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.PageShields.Connections.PageShieldListPageShieldConnections(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		cloudflare.PageShieldConnectionPageShieldListPageShieldConnectionsParams{
			Direction:           cloudflare.F(cloudflare.PageShieldConnectionPageShieldListPageShieldConnectionsParamsDirectionAsc),
