...
func TestStreamLiveInputOutputNewWithOptionalParams(t *testing.T) {
...
func TestStreamLiveInputOutputList(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
...
func TestStreamLiveInputOutputDelete(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
...
func TestStreamLiveInputOutputReplace(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Stream.LiveInputs.Outputs.Replace(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		"66be4bf738797e01e1fca35a7bdecdcd",
		"baea4d9c515887b80289d5c33cf01145",
		cloudflare.StreamLiveInputOutputReplaceParams{
			Enabled: cloudflare.F(true),
		},
	)
	if err != nil {
