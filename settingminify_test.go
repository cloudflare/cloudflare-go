...
func TestSettingMinifyEditWithOptionalParams(t *testing.T) {
	...
	_, err := client.Settings.Minify.Edit(context.TODO(), cloudflare.SettingMinifyEditParams{
...
func TestSettingMinifyGet(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Settings.Minify.Get(context.TODO(), cloudflare.SettingMinifyGetParams{
		ZoneID: cloudflare.F("023e105f4ecef8ad9ca31a8372d0c353"),
	})
	if err != nil {
		var apierr *cloudflare.Error
