...
// Creates a new event
func (r *ThreatEventService) New(ctx context.Context, accountID float64, body ThreatEventNewParams, opts ...option.RequestOption) (res *ThreatEventNewResponse, err error) {
...
// Updates an event
func (r *ThreatEventService) Update(ctx context.Context, accountID float64, eventID string, body ThreatEventUpdateParams, opts ...option.RequestOption) (res *ThreatEventUpdateResponse, err error) {
	opts = append(r.Options[:], opts...)
	if eventID == "" {
...
// Deletes an event
func (r *ThreatEventService) Delete(ctx context.Context, accountID float64, eventID string, opts ...option.RequestOption) (res *ThreatEventDeleteResponse, err error) {
	opts = append(r.Options[:], opts...)
	if eventID == "" {
		err = errors.New("missing required eventId parameter")
		return
...
// Creates a new event
func (r *ThreatEventService) BulkNew(ctx context.Context, accountID float64, body ThreatEventBulkNewParams, opts ...option.RequestOption) (res *[]ThreatEventBulkNewResponse, err error) {
	opts = append(r.Options[:], opts...)
...
// Reads an event
func (r *ThreatEventService) Get(ctx context.Context, accountID float64, eventID string, opts ...option.RequestOption) (res *ThreatEventGetResponse, err error) {
	opts = append(r.Options[:], opts...)
	if eventID == "" {
		err = errors.New("missing required eventId parameter")
		return
...
type ThreatEventUpdateResponse struct {
	ID              float64                       `json:"id,required"`
	AccountID       float64                       `json:"accountId,required"`
	Attacker        string                        `json:"attacker,required"`
	AttackerCountry string                        `json:"attackerCountry,required"`
	...
	Insight         string                        `json:"insight"`
	ReleasabilityID string                        `json:"releasabilityId"`
	JSON            threatEventUpdateResponseJSON `json:"-"`
}

// threatEventUpdateResponseJSON contains the JSON metadata for the struct
// [ThreatEventUpdateResponse]
type threatEventUpdateResponseJSON struct {
	ID              apijson.Field
	AccountID       apijson.Field
	Attacker        apijson.Field
	AttackerCountry apijson.Field
...
func (r *ThreatEventUpdateResponse) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r threatEventUpdateResponseJSON) RawJSON() string {
	return r.raw
}
...
type ThreatEventUpdateParams struct {
...
func (r ThreatEventUpdateParams) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}
