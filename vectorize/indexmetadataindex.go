...
func (r *IndexMetadataIndexService) List(ctx context.Context, indexName string, body IndexMetadataIndexListParams, opts ...option.RequestOption) (res *IndexMetadataIndexListResponse, err error) {
	...
	path := fmt.Sprintf("accounts/%s/vectorize/v2/indexes/%s/metadata_index/list", body.AccountID, indexName)
