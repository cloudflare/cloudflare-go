...
func TestHostnameCertificateNew(t *testing.T) {
	...
	_, err := client.OriginTLSClientAuth.HostnameCertificates.New(context.TODO(), origin_tls_client_auth.HostnameCertificateNewParams{
...
func TestHostnameCertificateList(t *testing.T) {
	...
	_, err := client.OriginTLSClientAuth.HostnameCertificates.List(context.TODO(), origin_tls_client_auth.HostnameCertificateListParams{
		ZoneID: cloudflare.F("023e105f4ecef8ad9ca31a8372d0c353"),
	})
	if err != nil {
		var apierr *cloudflare.Error
