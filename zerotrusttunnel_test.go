...
func TestZeroTrustTunnelNew(t *testing.T) {
...
func TestZeroTrustTunnelListWithOptionalParams(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
...
func TestZeroTrustTunnelDelete(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.ZeroTrust.Tunnels.Delete(
		...
		cloudflare.ZeroTrustTunnelDeleteParams{
			AccountID: cloudflare.F("699d98642c564d2e855e9661899b7252"),
...
func TestZeroTrustTunnelEditWithOptionalParams(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.ZeroTrust.Tunnels.Edit(
		context.TODO(),
		"f70ff985-a4ef-4643-bbbc-4a0ed4fc8415",
		cloudflare.ZeroTrustTunnelEditParams{
			AccountID:    cloudflare.F("699d98642c564d2e855e9661899b7252"),
			Name:         cloudflare.F("blog"),
...
func TestZeroTrustTunnelGet(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.ZeroTrust.Tunnels.Get(
		context.TODO(),
		"f70ff985-a4ef-4643-bbbc-4a0ed4fc8415",
		cloudflare.ZeroTrustTunnelGetParams{
			AccountID: cloudflare.F("699d98642c564d2e855e9661899b7252"),
		},
	)
	if err != nil {
