...
func (r *AddressPrefixDelegationService) IPAddressManagementPrefixDelegationListPrefixDelegations(ctx context.Context, accountID string, prefixID string, opts ...option.RequestOption) (res *[]AddressPrefixDelegationIPAddressManagementPrefixDelegationListPrefixDelegationsResponse, err error) {
	opts = append(r.Options[:], opts...)
