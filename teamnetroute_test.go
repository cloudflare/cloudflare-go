...
func TestTeamnetRouteNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Teamnet.Routes.New(context.TODO(), cloudflare.TeamnetRouteNewParams{
...
func TestTeamnetRouteDelete(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Teamnet.Routes.Delete(
		context.TODO(),
		"f70ff985-a4ef-4643-bbbc-4a0ed4fc8415",
		cloudflare.TeamnetRouteDeleteParams{
			AccountID: cloudflare.F("699d98642c564d2e855e9661899b7252"),
		},
	)
	if err != nil {
...
func TestTeamnetRouteEditWithOptionalParams(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Teamnet.Routes.Edit(
		context.TODO(),
		"f70ff985-a4ef-4643-bbbc-4a0ed4fc8415",
		cloudflare.TeamnetRouteEditParams{
			AccountID:        cloudflare.F("699d98642c564d2e855e9661899b7252"),
			Comment:          cloudflare.F("Example comment for this route."),
			Network:          cloudflare.F("172.16.0.0/16"),
			TunType:          cloudflare.F(cloudflare.TeamnetRouteEditParamsTunTypeCfdTunnel),
			TunnelID:         cloudflare.F[any](map[string]interface{}{}),
			VirtualNetworkID: cloudflare.F[any](map[string]interface{}{}),
		},
	)
