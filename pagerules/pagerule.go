...
type PageRuleAction struct {
	...
	Value PageRuleActionsValue `json:"value"`
...
func (r PageRuleActionsID) IsKnown() bool {
	switch r {
	case PageRuleActionsIDForwardingURL:
		return true
	}
	return false
}

type PageRuleActionsValue struct {
	// The status code to use for the URL redirect. 301 is a permanent redirect. 302 is
	// a temporary redirect.
	StatusCode PageRuleActionsValueStatusCode `json:"status_code"`
	// The URL to redirect the request to. Notes: ${num} refers to the position of '\*'
	// in the constraint value.
	URL  string                   `json:"url"`
	JSON pageRuleActionsValueJSON `json:"-"`
}

// pageRuleActionsValueJSON contains the JSON metadata for the struct
// [PageRuleActionsValue]
type pageRuleActionsValueJSON struct {
...
func (r *PageRuleActionsValue) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r pageRuleActionsValueJSON) RawJSON() string {
	return r.raw
}

// The status code to use for the URL redirect. 301 is a permanent redirect. 302 is
// a temporary redirect.
type PageRuleActionsValueStatusCode int64

const (
	PageRuleActionsValueStatusCode301 PageRuleActionsValueStatusCode = 301
	PageRuleActionsValueStatusCode302 PageRuleActionsValueStatusCode = 302
)

func (r PageRuleActionsValueStatusCode) IsKnown() bool {
	switch r {
	case PageRuleActionsValueStatusCode301, PageRuleActionsValueStatusCode302:
		return true
	}
	return false
}
