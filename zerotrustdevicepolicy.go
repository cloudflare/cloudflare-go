...
// criteria.
func (r *ZeroTrustDevicePolicyService) New(ctx context.Context, params ZeroTrustDevicePolicyNewParams, opts ...option.RequestOption) (res *TeamsDevicesDeviceSettingsPolicy, err error) {
...
func (r *ZeroTrustDevicePolicyService) List(ctx context.Context, query ZeroTrustDevicePolicyListParams, opts ...option.RequestOption) (res *[]TeamsDevicesDeviceSettingsPolicy, err error) {
	opts = append(r.Options[:], opts...)
...
// for an account.
func (r *ZeroTrustDevicePolicyService) Delete(ctx context.Context, policyID string, body ZeroTrustDevicePolicyDeleteParams, opts ...option.RequestOption) (res *[]TeamsDevicesDeviceSettingsPolicy, err error) {
	opts = append(r.Options[:], opts...)
...
func (r *ZeroTrustDevicePolicyService) Edit(ctx context.Context, policyID string, params ZeroTrustDevicePolicyEditParams, opts ...option.RequestOption) (res *TeamsDevicesDeviceSettingsPolicy, err error) {
	opts = append(r.Options[:], opts...)
...
func (r *ZeroTrustDevicePolicyService) Get(ctx context.Context, policyID string, query ZeroTrustDevicePolicyGetParams, opts ...option.RequestOption) (res *TeamsDevicesDeviceSettingsPolicy, err error) {
	opts = append(r.Options[:], opts...)
