...
// this service directly, and instead use the [NewWorkersForPlatformService] method
// instead.
type WorkersForPlatformService struct {
	Options  []option.RequestOption
	Dispatch *WorkersForPlatformDispatchService
}
...
func NewWorkersForPlatformService(opts ...option.RequestOption) (r *WorkersForPlatformService) {
	...
	r.Options = opts
	r.Dispatch = NewWorkersForPlatformDispatchService(opts...)
	return
}
