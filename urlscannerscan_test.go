...
func TestURLScannerScanNewWithOptionalParams(t *testing.T) {
...
func TestURLScannerScanGet(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
...
func TestURLScannerScanHar(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
...
func TestURLScannerScanScreenshotWithOptionalParams(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	...
	resp, err := client.URLScanner.Scans.Screenshot(
		...
		"string",
		"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
		cloudflare.URLScannerScanScreenshotParams{
			Resolution: cloudflare.F(cloudflare.URLScannerScanScreenshotParamsResolutionDesktop),
		},
	)
	if err != nil {
		var apierr *cloudflare.Error
