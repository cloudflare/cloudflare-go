...
func TestGatewayRuleReplaceWithOptionalParams(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Gateways.Rules.Replace(
		context.TODO(),
		"699d98642c564d2e855e9661899b7252",
		"f174e90a-fafe-4643-bbbc-4a0ed4fc8415",
		cloudflare.GatewayRuleReplaceParams{
			Action:        cloudflare.F(cloudflare.GatewayRuleReplaceParamsActionAllow),
			Name:          cloudflare.F("block bad websites"),
			Description:   cloudflare.F("Block bad websites based on their host name."),
			DevicePosture: cloudflare.F("any(device_posture.checks.passed[*] in {\"1308749e-fcfb-4ebc-b051-fe022b632644\"})"),
			Enabled:       cloudflare.F(true),
			Filters:       cloudflare.F([]cloudflare.GatewayRuleReplaceParamsFilter{cloudflare.GatewayRuleReplaceParamsFilterHTTP}),
			Identity:      cloudflare.F("any(identity.groups.name[*] in {\"finance\"})"),
			Precedence:    cloudflare.F(int64(0)),
			RuleSettings: cloudflare.F(cloudflare.GatewayRuleReplaceParamsRuleSettings{
				AddHeaders: cloudflare.F[any](map[string]interface{}{
					"My-Next-Header": map[string]interface{}{
						"0": "foo",
						"1": "bar",
				...
				AllowChildBypass: cloudflare.F(false),
				AuditSSH: cloudflare.F(cloudflare.GatewayRuleReplaceParamsRuleSettingsAuditSSH{
					CommandLogging: cloudflare.F(false),
				}),
				BisoAdminControls: cloudflare.F(cloudflare.GatewayRuleReplaceParamsRuleSettingsBisoAdminControls{
					Dcp: cloudflare.F(false),
					Dd:  cloudflare.F(false),
					Dk:  cloudflare.F(false),
					Dp:  cloudflare.F(false),
				...
				BlockReason:      cloudflare.F("This website is a security risk"),
				BypassParentRule: cloudflare.F(false),
				CheckSession: cloudflare.F(cloudflare.GatewayRuleReplaceParamsRuleSettingsCheckSession{
					Duration: cloudflare.F("300s"),
					Enforce:  cloudflare.F(true),
				}),
				DNSResolvers: cloudflare.F(cloudflare.GatewayRuleReplaceParamsRuleSettingsDNSResolvers{
					IPV4: cloudflare.F([]cloudflare.GatewayRuleReplaceParamsRuleSettingsDNSResolversIPV4{{
						IP:                         cloudflare.F("2001:DB8::/64"),
						Port:                       cloudflare.F(int64(5053)),
						RouteThroughPrivateNetwork: cloudflare.F(true),
						VnetID:                     cloudflare.F("f174e90a-fafe-4643-bbbc-4a0ed4fc8415"),
					...
					IPV6: cloudflare.F([]cloudflare.GatewayRuleReplaceParamsRuleSettingsDNSResolversIPV6{{
						IP:                         cloudflare.F("2001:DB8::/64"),
						Port:                       cloudflare.F(int64(5053)),
						RouteThroughPrivateNetwork: cloudflare.F(true),
						VnetID:                     cloudflare.F("f174e90a-fafe-4643-bbbc-4a0ed4fc8415"),
				...
				Egress: cloudflare.F(cloudflare.GatewayRuleReplaceParamsRuleSettingsEgress{
					IPV4:         cloudflare.F("192.0.2.2"),
					IPV4Fallback: cloudflare.F("192.0.2.3"),
					IPV6:         cloudflare.F("2001:DB8::/64"),
				}),
				...
				IPCategories:                    cloudflare.F(true),
				IPIndicatorFeeds:                cloudflare.F(true),
				L4override: cloudflare.F(cloudflare.GatewayRuleReplaceParamsRuleSettingsL4override{
					IP:   cloudflare.F("1.1.1.1"),
					Port: cloudflare.F(int64(0)),
				}),
				NotificationSettings: cloudflare.F(cloudflare.GatewayRuleReplaceParamsRuleSettingsNotificationSettings{
					Enabled:    cloudflare.F(true),
					Msg:        cloudflare.F("string"),
					SupportURL: cloudflare.F("string"),
				}),
				OverrideHost: cloudflare.F("example.com"),
				OverrideIPs:  cloudflare.F([]string{"1.1.1.1", "2.2.2.2"}),
				PayloadLog: cloudflare.F(cloudflare.GatewayRuleReplaceParamsRuleSettingsPayloadLog{
					Enabled: cloudflare.F(true),
				}),
				ResolveDNSThroughCloudflare: cloudflare.F(true),
				UntrustedCert: cloudflare.F(cloudflare.GatewayRuleReplaceParamsRuleSettingsUntrustedCert{
					Action: cloudflare.F(cloudflare.GatewayRuleReplaceParamsRuleSettingsUntrustedCertActionError),
				}),
			}),
			Schedule: cloudflare.F(cloudflare.GatewayRuleReplaceParamsSchedule{
				Fri:      cloudflare.F("08:00-12:30,13:30-17:00"),
				Mon:      cloudflare.F("08:00-12:30,13:30-17:00"),
				Sat:      cloudflare.F("08:00-12:30,13:30-17:00"),
				Sun:      cloudflare.F("08:00-12:30,13:30-17:00"),
