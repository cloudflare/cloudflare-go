...
func TestDeviceSettingUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := client.Devices.Settings.Update(context.TODO(), cloudflare.DeviceSettingUpdateParams{
...
func TestDeviceSettingList(t *testing.T) {
	...
	_, err := client.Devices.Settings.List(context.TODO(), cloudflare.DeviceSettingListParams{
		AccountID: cloudflare.F[any]("699d98642c564d2e855e9661899b7252"),
	})
	if err != nil {
		var apierr *cloudflare.Error
