...
// [workers_for_platforms.DispatchNamespaceScriptUpdateParamsMetadataBindingsWorkersBindingKindMessaging],
...
type DispatchNamespaceScriptUpdateParamsMetadataBindingsWorkersBindingKindMessaging struct {
	// A JavaScript variable name for the binding.
	Name param.Field[string] `json:"name" api:"required"`
	// The Messaging namespace to bind to.
	Namespace param.Field[string] `json:"namespace" api:"required"`
	// The kind of resource that the binding provides.
	Type param.Field[DispatchNamespaceScriptUpdateParamsMetadataBindingsWorkersBindingKindMessagingType] `json:"type" api:"required"`
}

func (r DispatchNamespaceScriptUpdateParamsMetadataBindingsWorkersBindingKindMessaging) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}

func (r DispatchNamespaceScriptUpdateParamsMetadataBindingsWorkersBindingKindMessaging) implementsDispatchNamespaceScriptUpdateParamsMetadataBindingUnion() {
}

// The kind of resource that the binding provides.
type DispatchNamespaceScriptUpdateParamsMetadataBindingsWorkersBindingKindMessagingType string

const (
	DispatchNamespaceScriptUpdateParamsMetadataBindingsWorkersBindingKindMessagingTypeMessaging DispatchNamespaceScriptUpdateParamsMetadataBindingsWorkersBindingKindMessagingType = "messaging"
)

func (r DispatchNamespaceScriptUpdateParamsMetadataBindingsWorkersBindingKindMessagingType) IsKnown() bool {
	switch r {
	case DispatchNamespaceScriptUpdateParamsMetadataBindingsWorkersBindingKindMessagingTypeMessaging:
		return true
	}
	return false
}
...
const (
	...
	DispatchNamespaceScriptUpdateParamsMetadataBindingsTypeMessaging              DispatchNamespaceScriptUpdateParamsMetadataBindingsType = "messaging"
