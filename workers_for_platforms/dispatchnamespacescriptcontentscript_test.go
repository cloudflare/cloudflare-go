...
func TestDispatchNamespaceScriptContentScriptUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := client.WorkersForPlatforms.Dispatch.Namespaces.Scripts.Content.Scripts.Update(
		...
		workers_for_platforms.DispatchNamespaceScriptContentScriptUpdateParams{
			...
			Metadata: cloudflare.F(workers_for_platforms.DispatchNamespaceScriptContentScriptUpdateParamsMetadata{
...
func TestDispatchNamespaceScriptContentScriptGet(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	...
	resp, err := client.WorkersForPlatforms.Dispatch.Namespaces.Scripts.Content.Scripts.Get(
		...
		"my-dispatch-namespace",
		"this-is_my_script-01",
		workers_for_platforms.DispatchNamespaceScriptContentScriptGetParams{
			AccountID: cloudflare.F("023e105f4ecef8ad9ca31a8372d0c353"),
		},
	)
	if err != nil {
