...
func TestMessagePeekWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Queues.Messages.Peek(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		queues.MessagePeekParams{
			AccountID: cloudflare.F("023e105f4ecef8ad9ca31a8372d0c353"),
...
func TestMessagePurge(t *testing.T) {
	...
	_, err := client.Queues.Messages.Purge(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		queues.MessagePurgeParams{
			AccountID: cloudflare.F("023e105f4ecef8ad9ca31a8372d0c353"),
			Refs: cloudflare.F([]queues.MessagePurgeParamsRef{{
				Ref: cloudflare.F("eyJhbGciOiJkaXIiLCJlbmMiOiJBMjU2Q0JDLUhTNTEyIn0..Q8p21d7dceR6vUfwftONdQ.JVqZgAS-Zk7MqmqccYtTHeeMElNHaOMigeWdb8LyMOg.T2_HV99CYzGaQuhTyW8RsgbnpTRZHRM6N7UoSaAKeK0"),
			}}),
		},
	)
	if err != nil {
