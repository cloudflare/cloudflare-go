...
func TestWeb3HostnameNewWithOptionalParams(t *testing.T) {
...
func TestWeb3HostnameList(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
...
func TestWeb3HostnameEditWithOptionalParams(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Web3.Hostnames.Edit(
		...
		"023e105f4ecef8ad9ca31a8372d0c353",
		"023e105f4ecef8ad9ca31a8372d0c353",
		cloudflare.Web3HostnameEditParams{
			Description: cloudflare.F("This is my IPFS gateway."),
			Dnslink:     cloudflare.F("/ipns/onboarding.ipfs.cloudflare.com"),
		},
	)
