...
func (r *DeviceRevokeService) New(ctx context.Context, identifier interface{}, body DeviceRevokeNewParams, opts ...option.RequestOption) (res *DeviceRevokeNewResponse, err error) {
