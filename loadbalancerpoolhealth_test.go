...
func TestLoadBalancerPoolHealthPreviewWithOptionalParams(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.LoadBalancers.Pools.Health.Preview(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		"17b5962d775c646f3f9725cbc7a53df4",
		cloudflare.LoadBalancerPoolHealthPreviewParams{
			...
			Type:      cloudflare.F(cloudflare.LoadBalancerPoolHealthPreviewParamsTypeHTTPS),
		},
	)
	if err != nil {
		var apierr *cloudflare.Error
