...
func TestStreamAudioTrackNewWithOptionalParams(t *testing.T) {
...
func TestStreamAudioTrackUpdateWithOptionalParams(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Stream.AudioTracks.Update(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		"ea95132c15732412d22c1476fa83f27a",
		"ea95132c15732412d22c1476fa83f27a",
		cloudflare.StreamAudioTrackUpdateParams{
