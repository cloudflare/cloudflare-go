...
func TestLoadBalancerPoolPreviewAccountLoadBalancerPoolsPreviewPoolWithOptionalParams(t *testing.T) {
	...
	_, err := client.LoadBalancers.Pools.Previews.AccountLoadBalancerPoolsPreviewPool(
		context.TODO(),
		...
		cloudflare.LoadBalancerPoolPreviewAccountLoadBalancerPoolsPreviewPoolParams{
			...
			Type:      cloudflare.F(cloudflare.LoadBalancerPoolPreviewAccountLoadBalancerPoolsPreviewPoolParamsTypeHTTPS),
		},
	)
	if err != nil {
