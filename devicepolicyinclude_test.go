...
func TestDevicePolicyIncludeUpdate(t *testing.T) {
	...
	_, err := client.Devices.Policies.Includes.Update(context.TODO(), cloudflare.DevicePolicyIncludeUpdateParams{
...
func TestDevicePolicyIncludeList(t *testing.T) {
	...
	_, err := client.Devices.Policies.Includes.List(context.TODO(), cloudflare.DevicePolicyIncludeListParams{
		AccountID: cloudflare.F[any]("699d98642c564d2e855e9661899b7252"),
	})
	if err != nil {
		var apierr *cloudflare.Error
...
func TestDevicePolicyIncludeGet(t *testing.T) {
	...
	_, err := client.Devices.Policies.Includes.Get(
		...
		cloudflare.DevicePolicyIncludeGetParams{
			AccountID: cloudflare.F[any]("699d98642c564d2e855e9661899b7252"),
		},
	)
	if err != nil {
