...
func (r *RecipientService) New(ctx context.Context, shareIdentifier string, params RecipientNewParams, opts ...option.RequestOption) (res *RecipientNewResponse, err error) {
...
func (r *RecipientService) List(ctx context.Context, shareIdentifier string, params RecipientListParams, opts ...option.RequestOption) (res *pagination.V4PagePaginationArray[RecipientListResponse], err error) {
...
// List share recipients by share ID.
func (r *RecipientService) ListAutoPaging(ctx context.Context, shareIdentifier string, params RecipientListParams, opts ...option.RequestOption) *pagination.V4PagePaginationArrayAutoPager[RecipientListResponse] {
...
// will be returned.
func (r *RecipientService) Delete(ctx context.Context, shareIdentifier string, recipientIdentifier string, body RecipientDeleteParams, opts ...option.RequestOption) (res *RecipientDeleteResponse, err error) {
...
func (r *RecipientService) Get(ctx context.Context, shareIdentifier string, recipientIdentifier string, query RecipientGetParams, opts ...option.RequestOption) (res *RecipientGetResponse, err error) {
