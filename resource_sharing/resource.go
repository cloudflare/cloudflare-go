...
func (r *ResourceService) New(ctx context.Context, shareIdentifier string, params ResourceNewParams, opts ...option.RequestOption) (res *ResourceNewResponse, err error) {
...
// be returned.
func (r *ResourceService) Update(ctx context.Context, shareIdentifier string, resourceIdentifier string, params ResourceUpdateParams, opts ...option.RequestOption) (res *ResourceUpdateResponse, err error) {
...
func (r *ResourceService) List(ctx context.Context, shareIdentifier string, params ResourceListParams, opts ...option.RequestOption) (res *pagination.V4PagePaginationArray[ResourceListResponse], err error) {
...
// List share resources by share ID.
func (r *ResourceService) ListAutoPaging(ctx context.Context, shareIdentifier string, params ResourceListParams, opts ...option.RequestOption) *pagination.V4PagePaginationArrayAutoPager[ResourceListResponse] {
...
// will be returned.
func (r *ResourceService) Delete(ctx context.Context, shareIdentifier string, resourceIdentifier string, body ResourceDeleteParams, opts ...option.RequestOption) (res *ResourceDeleteResponse, err error) {
...
func (r *ResourceService) Get(ctx context.Context, shareIdentifier string, resourceIdentifier string, query ResourceGetParams, opts ...option.RequestOption) (res *ResourceGetResponse, err error) {
...
func (r ResourceNewResponseResourceType) IsKnown() bool {
	switch r {
	case ResourceNewResponseResourceTypeCustomRuleset:
		return true
	}
	return false
}
...
func (r ResourceUpdateResponseResourceType) IsKnown() bool {
	switch r {
	case ResourceUpdateResponseResourceTypeCustomRuleset:
		return true
	}
	return false
}
...
func (r ResourceListResponseResourceType) IsKnown() bool {
	switch r {
	case ResourceListResponseResourceTypeCustomRuleset:
		return true
	}
	return false
}
...
func (r ResourceDeleteResponseResourceType) IsKnown() bool {
	switch r {
	case ResourceDeleteResponseResourceTypeCustomRuleset:
		return true
	}
	return false
}
...
func (r ResourceGetResponseResourceType) IsKnown() bool {
	switch r {
	case ResourceGetResponseResourceTypeCustomRuleset:
		return true
	}
	return false
}
...
func (r ResourceNewParamsResourceType) IsKnown() bool {
	switch r {
	case ResourceNewParamsResourceTypeCustomRuleset:
		return true
	}
	return false
}
...
func (r ResourceListParamsResourceType) IsKnown() bool {
	switch r {
	case ResourceListParamsResourceTypeCustomRuleset:
		return true
	}
	return false
}
