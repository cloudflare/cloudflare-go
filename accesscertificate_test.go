...
func TestAccessCertificateNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Access.Certificates.New(
		context.TODO(),
		"string",
		"023e105f4ecef8ad9ca31a8372d0c353",
		cloudflare.AccessCertificateNewParams{
...
func TestAccessCertificateList(t *testing.T) {
	...
	_, err := client.Access.Certificates.List(
		context.TODO(),
		"string",
		"023e105f4ecef8ad9ca31a8372d0c353",
	)
...
func TestAccessCertificateReplaceWithOptionalParams(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Access.Certificates.Replace(
		context.TODO(),
		"string",
		"023e105f4ecef8ad9ca31a8372d0c353",
		"f174e90a-fafe-4643-bbbc-4a0ed4fc8415",
		cloudflare.AccessCertificateReplaceParams{
			AssociatedHostnames: cloudflare.F([]string{"admin.example.com", "admin.example.com", "admin.example.com"}),
			Name:                cloudflare.F("Allow devs"),
		},
	)
