...
func TestSettingImageResizingEditWithOptionalParams(t *testing.T) {
	...
	_, err := client.Settings.ImageResizing.Edit(context.TODO(), cloudflare.SettingImageResizingEditParams{
...
func TestSettingImageResizingGet(t *testing.T) {
	...
	_, err := client.Settings.ImageResizing.Get(context.TODO(), cloudflare.SettingImageResizingGetParams{
		ZoneID: cloudflare.F("023e105f4ecef8ad9ca31a8372d0c353"),
	})
	if err != nil {
		var apierr *cloudflare.Error
