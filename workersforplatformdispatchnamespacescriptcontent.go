...
type WorkersForPlatformDispatchNamespaceScriptContentService struct {
	...
	Scripts  *WorkersForPlatformDispatchNamespaceScriptContentScriptService
	Settings *WorkersForPlatformDispatchNamespaceScriptContentSettingService
	Bindings *WorkersForPlatformDispatchNamespaceScriptContentBindingService
}
...
func NewWorkersForPlatformDispatchNamespaceScriptContentService(opts ...option.RequestOption) (r *WorkersForPlatformDispatchNamespaceScriptContentService) {
	...
	r.Options = opts
	r.Scripts = NewWorkersForPlatformDispatchNamespaceScriptContentScriptService(opts...)
	r.Settings = NewWorkersForPlatformDispatchNamespaceScriptContentSettingService(opts...)
	r.Bindings = NewWorkersForPlatformDispatchNamespaceScriptContentBindingService(opts...)
	return
}
