...
func TestSpeedNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Speed.New(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		"example.com",
		cloudflare.SpeedNewParams{
			Region: cloudflare.F(cloudflare.SpeedNewParamsRegionUsCentral1),
		},
	)
	if err != nil {
...
func TestSpeedTestsGet(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
