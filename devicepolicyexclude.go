...
func (r *DevicePolicyExcludeService) Update(ctx context.Context, identifier interface{}, body DevicePolicyExcludeUpdateParams, opts ...option.RequestOption) (res *[]DevicePolicyExcludeUpdateResponse, err error) {
