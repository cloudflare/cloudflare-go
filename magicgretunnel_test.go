...
func TestMagicGreTunnelReplaceWithOptionalParams(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Magics.GreTunnels.Replace(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		"023e105f4ecef8ad9ca31a8372d0c353",
		cloudflare.MagicGreTunnelReplaceParams{
			...
			HealthCheck: cloudflare.F(cloudflare.MagicGreTunnelReplaceParamsHealthCheck{
				Direction: cloudflare.F(cloudflare.MagicGreTunnelReplaceParamsHealthCheckDirectionBidirectional),
				Enabled:   cloudflare.F(true),
				Rate:      cloudflare.F(cloudflare.MagicGreTunnelReplaceParamsHealthCheckRateLow),
				Target:    cloudflare.F("203.0.113.1"),
				Type:      cloudflare.F(cloudflare.MagicGreTunnelReplaceParamsHealthCheckTypeRequest),
			}),
