...
func TestLoadBalancerMonitorAccountLoadBalancerMonitorsNewMonitorWithOptionalParams(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.LoadBalancers.Monitors.AccountLoadBalancerMonitorsNewMonitor(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		cloudflare.LoadBalancerMonitorAccountLoadBalancerMonitorsNewMonitorParams{
			...
			Retries:   cloudflare.F(int64(0)),
			Timeout:   cloudflare.F(int64(0)),
			Type:      cloudflare.F(cloudflare.LoadBalancerMonitorAccountLoadBalancerMonitorsNewMonitorParamsTypeHTTPs),
		},
	)
	if err != nil {
		var apierr *cloudflare.Error
...
func TestLoadBalancerMonitorAccountLoadBalancerMonitorsListMonitors(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.LoadBalancers.Monitors.AccountLoadBalancerMonitorsListMonitors(context.TODO(), "023e105f4ecef8ad9ca31a8372d0c353")
	if err != nil {
		var apierr *cloudflare.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
