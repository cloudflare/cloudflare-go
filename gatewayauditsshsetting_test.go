...
func TestGatewayAuditSSHSettingUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := client.Gateways.AuditSSHSettings.Update(context.TODO(), cloudflare.GatewayAuditSSHSettingUpdateParams{
...
func TestGatewayAuditSSHSettingGet(t *testing.T) {
	...
	_, err := client.Gateways.AuditSSHSettings.Get(context.TODO(), cloudflare.GatewayAuditSSHSettingGetParams{
		AccountID: cloudflare.F[any]("699d98642c564d2e855e9661899b7252"),
	})
	if err != nil {
		var apierr *cloudflare.Error
