...
func TestCustomCertificateNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.CustomCertificates.New(context.TODO(), custom_certificates.CustomCertificateNewParams{
		...
		CustomCsrID:  cloudflare.F("7b163417-1d2b-4c84-a38a-2fb7a0cd7752"),
		Deploy:       cloudflare.F(custom_certificates.CustomCertificateNewParamsDeployStaging),
...
func TestCustomCertificateEditWithOptionalParams(t *testing.T) {
	...
	_, err := client.CustomCertificates.Edit(
		...
		custom_certificates.CustomCertificateEditParams{
			...
			Certificate:  cloudflare.F("-----BEGIN CERTIFICATE-----\\n-----END CERTIFICATE-----\n"),
			CustomCsrID:  cloudflare.F("7b163417-1d2b-4c84-a38a-2fb7a0cd7752"),
			Deploy:       cloudflare.F(custom_certificates.CustomCertificateEditParamsDeployStaging),
			GeoRestrictions: cloudflare.F(custom_certificates.GeoRestrictionsParam{
				Label: cloudflare.F(custom_certificates.GeoRestrictionsLabelUs),
			}),
			Policy:     cloudflare.F("(country: US) or (region: EU)"),
