...
func (r *ScriptContentService) Update(ctx context.Context, scriptName string, params ScriptContentUpdateParams, opts ...option.RequestOption) (res *ScriptContentUpdateResponse, err error) {
...
type ScriptContentUpdateResponse struct {
	...
	TailConsumers []ScriptContentUpdateResponseTailConsumer `json:"tail_consumers"`
	// Specifies the usage model for the Worker (e.g. 'bundled' or 'unbound').
	UsageModel string                          `json:"usage_model"`
	JSON       scriptContentUpdateResponseJSON `json:"-"`
}

// scriptContentUpdateResponseJSON contains the JSON metadata for the struct
// [ScriptContentUpdateResponse]
type scriptContentUpdateResponseJSON struct {
	ID            apijson.Field
...
func (r *ScriptContentUpdateResponse) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r scriptContentUpdateResponseJSON) RawJSON() string {
	return r.raw
}

// A reference to a script that will consume logs from the attached Worker.
type ScriptContentUpdateResponseTailConsumer struct {
	...
	JSON      scriptContentUpdateResponseTailConsumerJSON `json:"-"`
}

// scriptContentUpdateResponseTailConsumerJSON contains the JSON metadata for the
// struct [ScriptContentUpdateResponseTailConsumer]
type scriptContentUpdateResponseTailConsumerJSON struct {
...
func (r *ScriptContentUpdateResponseTailConsumer) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r scriptContentUpdateResponseTailConsumerJSON) RawJSON() string {
	return r.raw
}
...
type ScriptContentUpdateResponseEnvelope struct {
	...
	Result   ScriptContentUpdateResponse                   `json:"result,required"`
