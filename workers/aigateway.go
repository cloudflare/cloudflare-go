...
func (r *AIGatewayService) New(ctx context.Context, accountTag string, body AIGatewayNewParams, opts ...option.RequestOption) (res *AIGatewayNewResponse, err error) {
	opts = append(r.Options[:], opts...)
	var env AIGatewayNewResponseEnvelope
	path := fmt.Sprintf("accounts/%s/ai-gateway/gateways", accountTag)
...
// Update a Gateway
func (r *AIGatewayService) Update(ctx context.Context, accountTag string, id string, body AIGatewayUpdateParams, opts ...option.RequestOption) (res *AIGatewayUpdateResponse, err error) {
	opts = append(r.Options[:], opts...)
	var env AIGatewayUpdateResponseEnvelope
	path := fmt.Sprintf("accounts/%s/ai-gateway/gateways/%s", accountTag, id)
...
// List Gateway's
func (r *AIGatewayService) List(ctx context.Context, accountTag string, query AIGatewayListParams, opts ...option.RequestOption) (res *pagination.V4PagePaginationArray[AIGatewayListResponse], err error) {
...
// List Gateway's
func (r *AIGatewayService) ListAutoPaging(ctx context.Context, accountTag string, query AIGatewayListParams, opts ...option.RequestOption) *pagination.V4PagePaginationArrayAutoPager[AIGatewayListResponse] {
	return pagination.NewV4PagePaginationArrayAutoPager(r.List(ctx, accountTag, query, opts...))
}

// Delete a Gateway
func (r *AIGatewayService) Delete(ctx context.Context, accountTag string, id string, opts ...option.RequestOption) (res *AIGatewayDeleteResponse, err error) {
	opts = append(r.Options[:], opts...)
...
// Fetch a Gateway
func (r *AIGatewayService) Get(ctx context.Context, accountTag string, id string, opts ...option.RequestOption) (res *AIGatewayGetResponse, err error) {
	opts = append(r.Options[:], opts...)
