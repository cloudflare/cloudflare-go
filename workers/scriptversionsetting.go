...
type SettingsItem struct {
	...
	TailConsumers []SettingsItemTailConsumer `json:"tail_consumers"`
...
type SettingsItemTailConsumer struct {
	...
	Namespace string                       `json:"namespace"`
	JSON      settingsItemTailConsumerJSON `json:"-"`
}

// settingsItemTailConsumerJSON contains the JSON metadata for the struct
// [SettingsItemTailConsumer]
type settingsItemTailConsumerJSON struct {
	Service     apijson.Field
	Environment apijson.Field
	Namespace   apijson.Field
	raw         string
...
func (r *SettingsItemTailConsumer) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r settingsItemTailConsumerJSON) RawJSON() string {
	return r.raw
}
...
type SettingsItemParam struct {
	...
	// List of Workers that will consume logs from the attached Worker.
	TailConsumers param.Field[[]SettingsItemTailConsumerParam] `json:"tail_consumers"`
	// Specifies the usage model for the Worker (e.g. 'bundled' or 'unbound').
...
// A reference to a script that will consume logs from the attached Worker.
type SettingsItemTailConsumerParam struct {
	// Name of Worker that is to be the consumer.
	Service param.Field[string] `json:"service,required"`
	// Optional environment if the Worker utilizes one.
	Environment param.Field[string] `json:"environment"`
...
func (r SettingsItemTailConsumerParam) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}
