...
func TestScriptVersionSettingEditWithOptionalParams(t *testing.T) {
	...
	_, err := client.Workers.Scripts.Versions.Settings.Edit(
		...
		workers.ScriptVersionSettingEditParams{
			...
			Settings: cloudflare.F(workers.SettingsParam{
				...
				CompatibilityFlags: cloudflare.F([]workers.CompatibilityFlagsParam{"formdata_parser_supports_files", "formdata_parser_supports_files", "formdata_parser_supports_files"}),
				Logpush:            cloudflare.F(false),
				Migrations: cloudflare.F[workers.SettingsMigrationsUnionParam](workers.SingleStepMigrationParam{
				...
				Tags: cloudflare.F([]workers.TagsParam{"my-tag", "my-tag", "my-tag"}),
