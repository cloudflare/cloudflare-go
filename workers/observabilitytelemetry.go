...
type ObservabilityTelemetryService struct {
	...
	Keys    *ObservabilityTelemetryKeyService
	Query   *ObservabilityTelemetryQueryService
	Values  *ObservabilityTelemetryValueService
}
...
func NewObservabilityTelemetryService(opts ...option.RequestOption) (r *ObservabilityTelemetryService) {
	...
	r.Options = opts
	r.Keys = NewObservabilityTelemetryKeyService(opts...)
	r.Query = NewObservabilityTelemetryQueryService(opts...)
	r.Values = NewObservabilityTelemetryValueService(opts...)
	return
}
