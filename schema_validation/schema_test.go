...
func TestSchemaNew(t *testing.T) {
	...
	_, err := client.SchemaValidation.Schemas.New(context.TODO(), schema_validation.SchemaNewParams{
...
func TestSchemaListWithOptionalParams(t *testing.T) {
	...
	_, err := client.SchemaValidation.Schemas.List(context.TODO(), schema_validation.SchemaListParams{
		ZoneID:            cloudflare.F("023e105f4ecef8ad9ca31a8372d0c353"),
...
func TestSchemaDelete(t *testing.T) {
	...
	_, err := client.SchemaValidation.Schemas.Delete(
		context.TODO(),
...
func TestSchemaEditWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.SchemaValidation.Schemas.Edit(
		context.TODO(),
		"f174e90a-fafe-4643-bbbc-4a0ed4fc8415",
...
func TestSchemaGetWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.SchemaValidation.Schemas.Get(
		context.TODO(),
		"f174e90a-fafe-4643-bbbc-4a0ed4fc8415",
