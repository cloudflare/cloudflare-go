...
func (r BlockRule) implementsRulesetsRequestRule() {}
...
func (r ExecuteRule) implementsRulesetsRequestRule() {}
...
func (r ExecuteRuleParam) implementsRulesetsRequestRuleUnionParam() {}
...
func (r LogRule) implementsRulesetsRequestRule() {}
...
func (r LogRuleParam) implementsRulesetsRequestRuleUnionParam() {}
...
type RequestRule struct {
	// The action to perform when the rule matches.
	Action           RequestRuleAction `json:"action"`
	...
	// The version of the rule.
	Version string          `json:"version,required"`
	JSON    requestRuleJSON `json:"-"`
	union   RequestRuleUnion
}

// requestRuleJSON contains the JSON metadata for the struct [RequestRule]
type requestRuleJSON struct {
	Action           apijson.Field
	ActionParameters apijson.Field
	Categories       apijson.Field
	Description      apijson.Field
...
func (r requestRuleJSON) RawJSON() string {
	return r.raw
}

func (r *RequestRule) UnmarshalJSON(data []byte) (err error) {
...
func (r RequestRule) AsUnion() RequestRuleUnion {
	return r.union
}

// Union satisfied by [rulesets.BlockRule], [rulesets.ExecuteRule],
// [rulesets.LogRule] or [rulesets.SkipRule].
type RequestRuleUnion interface {
	implementsRulesetsRequestRule()
}

func init() {
	apijson.RegisterUnion(
		reflect.TypeOf((*RequestRuleUnion)(nil)).Elem(),
		"action",
...
func (r SkipRule) implementsRulesetsRequestRule() {}
...
func (r SkipRuleParam) implementsRulesetsRequestRuleUnionParam() {}
