...
func (r *PhaseVersionService) List(ctx context.Context, rulesetPhase PhaseVersionListParamsRulesetPhase, query PhaseVersionListParams, opts ...option.RequestOption) (res *[]PhaseVersionListResponse, err error) {
...
type PhaseVersionListResponseEnvelope struct {
	...
	// A result.
	Result []PhaseVersionListResponse `json:"result,required"`
