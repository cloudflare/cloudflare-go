...
func (r *VersionService) List(ctx context.Context, rulesetID string, query VersionListParams, opts ...option.RequestOption) (res *[]VersionListResponse, err error) {
...
type VersionListResponseEnvelope struct {
	...
	// A result.
	Result []VersionListResponse `json:"result,required"`
