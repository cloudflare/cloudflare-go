...
func (r *AddressPrefixService) Update(ctx context.Context, accountIdentifier string, prefixIdentifier string, body AddressPrefixUpdateParams, opts ...option.RequestOption) (res *AddressPrefixUpdateResponse, err error) {
...
func (r *AddressPrefixService) Delete(ctx context.Context, accountIdentifier string, prefixIdentifier string, opts ...option.RequestOption) (res *AddressPrefixDeleteResponse, err error) {
	opts = append(r.Options[:], opts...)
...
func (r *AddressPrefixService) Get(ctx context.Context, accountIdentifier string, prefixIdentifier string, opts ...option.RequestOption) (res *AddressPrefixGetResponse, err error) {
	opts = append(r.Options[:], opts...)
...
func (r *AddressPrefixService) IPAddressManagementPrefixesAddPrefix(ctx context.Context, accountIdentifier string, body AddressPrefixIPAddressManagementPrefixesAddPrefixParams, opts ...option.RequestOption) (res *AddressPrefixIPAddressManagementPrefixesAddPrefixResponse, err error) {
	opts = append(r.Options[:], opts...)
...
func (r *AddressPrefixService) IPAddressManagementPrefixesListPrefixes(ctx context.Context, accountIdentifier string, opts ...option.RequestOption) (res *[]AddressPrefixIPAddressManagementPrefixesListPrefixesResponse, err error) {
	opts = append(r.Options[:], opts...)
