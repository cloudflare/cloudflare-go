...
func TestAssetNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.CustomPages.Assets.New(context.TODO(), custom_pages.AssetNewParams{
...
func TestAssetUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := client.CustomPages.Assets.Update(
		context.TODO(),
		"my_custom_error_page",
		custom_pages.AssetUpdateParams{
			Description: cloudflare.F("Custom 500 error page"),
			URL:         cloudflare.F("https://example.com/error.html"),
			AccountID:   cloudflare.F("account_id"),
		},
...
func TestAssetListWithOptionalParams(t *testing.T) {
	...
	_, err := client.CustomPages.Assets.List(context.TODO(), custom_pages.AssetListParams{
		AccountID: cloudflare.F("account_id"),
...
func TestAssetGetWithOptionalParams(t *testing.T) {
	...
	_, err := client.CustomPages.Assets.Get(
		context.TODO(),
		"my_custom_error_page",
		custom_pages.AssetGetParams{
			AccountID: cloudflare.F("account_id"),
		},
	)
	if err != nil {
