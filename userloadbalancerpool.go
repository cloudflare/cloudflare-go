...
func (r *UserLoadBalancerPoolService) Update(ctx context.Context, identifier string, body UserLoadBalancerPoolUpdateParams, opts ...option.RequestOption) (res *UserLoadBalancerPoolUpdateResponse, err error) {
...
func (r *UserLoadBalancerPoolService) Get(ctx context.Context, identifier string, opts ...option.RequestOption) (res *UserLoadBalancerPoolGetResponse, err error) {
	opts = append(r.Options[:], opts...)
