...
func TestWorkerScriptReplaceWithOptionalParams(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Workers.Scripts.Replace(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		"this-is_my_script-01",
		cloudflare.WorkerScriptReplaceParamsVariant0{
			...
			Metadata: cloudflare.F(cloudflare.WorkerScriptReplaceParamsVariant0Metadata{
				...
				Migrations: cloudflare.F[cloudflare.WorkerScriptReplaceParamsVariant0MetadataMigrations](cloudflare.WorkerScriptReplaceParamsVariant0MetadataMigrationsWorkersSingleStepMigrations(cloudflare.WorkerScriptReplaceParamsVariant0MetadataMigrationsWorkersSingleStepMigrations{
					NewTag:         cloudflare.F("v2"),
					OldTag:         cloudflare.F("v1"),
					DeletedClasses: cloudflare.F([]string{"string", "string", "string"}),
					NewClasses:     cloudflare.F([]string{"string", "string", "string"}),
					RenamedClasses: cloudflare.F([]cloudflare.WorkerScriptReplaceParamsVariant0MetadataMigrationsWorkersSingleStepMigrationsRenamedClass{{
					...
					TransferredClasses: cloudflare.F([]cloudflare.WorkerScriptReplaceParamsVariant0MetadataMigrationsWorkersSingleStepMigrationsTransferredClass{{
						From:       cloudflare.F("string"),
				...
				Placement: cloudflare.F(cloudflare.WorkerScriptReplaceParamsVariant0MetadataPlacement{
					Mode: cloudflare.F(cloudflare.WorkerScriptReplaceParamsVariant0MetadataPlacementModeSmart),
				}),
				Tags: cloudflare.F([]string{"string", "string", "string"}),
				TailConsumers: cloudflare.F([]cloudflare.WorkerScriptReplaceParamsVariant0MetadataTailConsumer{{
				...
				UsageModel:  cloudflare.F(cloudflare.WorkerScriptReplaceParamsVariant0MetadataUsageModelBundled),
