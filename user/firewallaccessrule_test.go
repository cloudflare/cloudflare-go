...
func TestFirewallAccessRuleNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.User.Firewall.AccessRules.New(context.TODO(), user.FirewallAccessRuleNewParams{
		Configuration: cloudflare.F[user.FirewallAccessRuleNewParamsConfigurationUnion](user.FirewallAccessRuleNewParamsConfigurationFirewallIPConfiguration{
			Target: cloudflare.F(user.FirewallAccessRuleNewParamsConfigurationFirewallIPConfigurationTargetIP),
