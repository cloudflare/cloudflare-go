...
// address in the rule.
Target firewall.AccessRuleConfigurationTarget `json:"target"`
...
// The configuration target. You must set the target to `ip` when specifying an IP
// address in the rule.
type firewall.AccessRuleConfigurationTarget string

const (
  firewall.AccessRuleConfigurationTargetIP firewall.AccessRuleConfigurationTarget = "ip"
  firewall.AccessRuleConfigurationTargetIp6 firewall.AccessRuleConfigurationTarget = "ip6"
  firewall.AccessRuleConfigurationTargetIPRange firewall.AccessRuleConfigurationTarget = "ip_range"
  firewall.AccessRuleConfigurationTargetASN firewall.AccessRuleConfigurationTarget = "asn"
  firewall.AccessRuleConfigurationTargetCountry firewall.AccessRuleConfigurationTarget = "country"
)

func (r firewall.AccessRuleConfigurationTarget) IsKnown() (bool) {
  switch r {
  case firewall.AccessRuleConfigurationTargetIP, firewall.AccessRuleConfigurationTargetIp6, firewall.AccessRuleConfigurationTargetIPRange, firewall.AccessRuleConfigurationTargetASN, firewall.AccessRuleConfigurationTargetCountry:
      return true
  }
  return false
}
